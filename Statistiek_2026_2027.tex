...
\urlstyle{same}
\hypersetup{
  pdftitle={Cursus Statistiek 2026-2027},
...
\title{Cursus Statistiek 2026-2027}
...
\markboth{Woord vooraf}{Woord vooraf}
...
In de zomer 2020 hebben we de transitie gemaakt van een online ebook
naar een volledig online course. Hierbij integreren we alle materiaal
voor de cursus en de oefeningen in het Dodona leerplatform. De cursus
kan volledig in dit platform worden doorlopen aan de hand van
leesopdrachten voor de theorie en d.m.v. oefeningen waarvan de code
automatisch kan worden beoordeeld. Dit huzarenstukje was uiteraard niet
mogelijk zonder de hulp van een bijzonder gedreven team.

Eerst en vooral wil ik het Dodona team bedanken om me herhaaldelijk aan
te sporen om ook statistiekonderwijs via Dodona te verstrekken.
Prof.~Peter Dawyndt en Dr.~Bart Mesure hebben samen met hun team een
indrukwekkend platform ontwikkeld voor het doceren van programmeertalen.

Daarnaast heeft Charlotte Van Petegem het platform ook voor statistiek
onderwijs unlocked door de ontwikkeling van een R-judge waarbij R code
automatisch kan worden beoordeeld.

De Faculteit Wetenschappen van de Universiteit van Gent heeft het me
d.m.v. een onderwijs en innovatieproject mogelijk gemaakt om in augustus
2020 een team van enthousiaste jobstudenten: Gust Bogaert, Luca Renders,
Stijn Vandenbulcke en Viktor Verstraelen aan te werven die in een maand
tijd twee modules (Introductie tot R en Data exploratie en Data
Visualisatie in R) in Dodona hebben geïmplementeerd. Dat was mede
mogelijk omdat we van prof. Rafael Irizarry de toestemming kregen om de
broncode van zijn boek Introduction to Data Science en alle youtube
videos te integreren in deze modules.

Onder impuls van mijn team jonge enthousiaste wolven hebben we het
aangedurfd om midden september 2020 ook mijn volledige cursus Statistiek
in Dodona onder te gaan brengen. In deze bevreemdende covid-19 tijden
lijkt me dit de ultieme manier om de stof zo goed mogelijk interactief
en volledig online aan te bieden. Ik kan het schitterende team van
jobstudenten en het voltallige Dodona team niet voldoende bedanken,
jullie gaven me vleugels!

Daarnaast wil ik ook mijn familie bedanken voor hun geduld en nooit
aflatende steun tijdens de ontwikkeling van deze cursus.
...
\markboth{Links}{Links}

\begin{itemize}
\item
  Een html versie van de cursus is beschikbaar op
  \url{https://statomics.github.io/sbc/} waardoor alle voorbeelden en
  code in deze cursus makkelijk in R kunnen worden gereproduceerd, wat
  handig kan zijn wanneer je zelf r-markdown scripts ontwikkelt.
\item
  Een pdf versie van de cursus is beschikbaar op
  \url{https://statomics.github.io/sbc/Statistiek_2026_2027.pdf}
\item
  Voor een introductie tot R en Data Visualisatie raden we de eerste
  twee delen aan van het ebook \url{https://rafalab.github.io/dsbook/}
  van prof. Rafael Irizarry. Deze zijn herwerkt in de interactieve
  Dodona cursus \url{https://dodona.be/en/courses/6616/}
\item
  De oefeningen vanaf hoofdstuk 5 vind je in de interactieve Dodona
  cursus \url{https://dodona.be/en/courses/6617/}
\end{itemize}
...
\href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJIk4G2AZYYKvgZLjRR-1-Iw}{Kennisclips
Hoofdstuk1}

link naar webpage/script die wordt gebruik in de kennisclips:
\href{https://statomics.github.io/sbc/rmd/01-intro.html}{script
Hoofdstuk1}
...
\item
  ...
  weefsel?
\item
  Kwaliteitscontrole: wijkt de concentratie van een chemisch product af
  van wat er op het label wordt vermeld?\\
\item
...
metingen voor een zelfde persoon zelden gelijk zijn. De aanwezigheid van
die biologische variabiliteit is bijzonder opvallend in de context van
...
onder meer de populaire column `'points of significance'\,' in Nature
Methods.
(http://blogs.nature.com/methagora/2013/08/giving\_statistics\_the\_attention\_it\_deserves.html)
...
observatie. Dit is het \emph{falsificatieprincipe} van de
...
Figuur \ref{fig-wetMet} is een schematische weergave van de
...
We komen nog even terug op het falsificatieprincipe. Doorheen deze
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{01-Inleiding_files/figure-pdf/fig-wetMet-1.pdf}

}

\caption{\label{fig-wetMet}De Wetenschappelijke Methode en de rol van
Statistiek.}
...
We leven in een tijd van big data en het is cruciaal om informatie uit
cijfers te kunnen extraheren. Statistiek is nu net de wetenschap om te
leren uit empirische gegevens.

Statistische geletterdheid is dus een noodzaak om de resultaten uit deze
analyses in wetenschappelijke tijdschriften of in de media kritisch te
kunnen interpreteren.

Hierbij is het belangrijk om inzicht te verwerven in statistische data
analyse enerzijds en om anderzijds deze analyse te interpreteren. We
moeten de analyse m.a.w. kunnen koppelen aan de context van het
onderzoek: de onderzoeksvraag, de proefopzet en de eigenschappen van de
data. Daarom gaan we alle statistische methodes in de cursus aanbrengen
aan de hand van case studies. We gaan hierbij steeds stilstaan bij
...
\item
  hoe we de resultaten uit de steekproef kunnen veralgemenen naar de
  populatie toe (statistische besluitvorming).
\item
  Om statistische geletterdheid te verwerven is het ook cruciaal om zelf
  eenvoudige statistische analyses uit te kunnen voeren zodat je data
  leert analyseren en te interpreteren. We zullen dus ook in elke case
  study stilstaan bij hoe we de data analyse uit moeten voeren in
  statistische software.
\end{enumerate}

In de cursus maken we hiervoor gebruik van het statistische software
pakket R. De cursus en de case studies werden volledig in rmarkdown
aangemaakt, dit zijn geavanceerde scripts die toelaten om
...
op een efficiënte manier te combineren. Het rmarkdown script kan dan
worden gecompileerd naar een webpagina of een pdf document. Op deze
manier kan je een data analyse op een volledig reproduceerbare manier
documenteren. De scripts van de cursus vormen een goede inspiratiebron
om zelf met rmarkdown aan de slag te gaan.

De cursus wordt volledig in online leerpaden verzorgd op het platform
Dodona. Daarbij gaan we hand-on leren statistische programmeren in 2
modules:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Module: Introduction to R, waarbij jullie interactief kennis maken met
  het statistische software pakket en programmeer taal R. Week 1 - Week
  3.
\item
  Module: Data exploration and visualisation waarbij jullie de basis
  principes zullen leren van het maken van goede grafieken die je
  inzicht zullen geven in de data die wordt gegenereerd in het
  experiment. Week 4 - 5.
\item
  Module: Statistiek, het hart van deze cursus, waarin jullie inzicht
  zullen verwerven in de drie belangrijke takken van de statistiek. Week
  1-12.
...
Hierbij staat steeds een echte dataset centraal zodat jullie de
vertaalslag leren maken van de onderzoeksvraag naar statistisch modellen
toe om dan na de data analyse de resultaten opnieuw te interpreteren in
termen van de onderzoeksvraag.

We zullen ook telkens alle code delen die nodig is om alle data analyses
en visualisaties uit te voeren die worden weergegeven in deze cursus.

In deze inleiding introduceren we drie case studies die het belang van
statistiek illustreren.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  Case study I: Het oksel microbiome. In deze case study doorlopen we
  alle belangrijke stappen van een experimentele study.
\item
  Case study II: Verschil in lichaamslengte tussen vrouwen en mannen. In
  deze studie zal je inzicht verwerven in hoe observaties, resultaten en
  conclusies van een studie onderhevig zijn aan variabiliteit.
\item
  Case study III: Salk vaccin studie voor polio. Deze studie illustreert
  het belang van een goede controle en introduceert het concept van
  confounding.
\end{enumerate}

Tijdens de eerste lezing van dit hoofdstuk is het nog niet belangrijk om
te focussen op de code. Probeer vooral inzicht te verwerven in het
theoretisch raamwerk dat wordt geïntroduceerd. Na week 4 kan het nuttig
zijn om de case studies nog eens door te nemen met het oog op hoe je de
analyses concreet uit kan voeren.

\section{Case study: oksel
microbiome}\label{case-study-oksel-microbiome}

\url{https://www.vrt.be/vrtnws/nl/2018/10/22/gezocht-mensen-met-penetrante-lijfgeur-om-probiotische-deodor/}

Zweten en vooral een zweetgeur is vervelend. Het zweten op zich is niet
de oorzaak van de geur. Het zijn de microorganismen onder de oksel die
het zweet metaboliseren die de geur veroorzaken. De samenstelling van de
gemeenschap van microorganismen onder de oksel is dus bepalend voor het
hebben van een zweetgeur. Deze gemeenschap wordt ook het oksel
microbiome genoemd.

Corynebacterium is een bacterie die zweet metaboliseert en hierbij
verzadigde vetzuren aanmaakt met een penetrante geur. Gelukkig zijn er
Staphylococcus bacteriën die het zweet ook metaboliseren maar die
hierbij geen hinderlijke verzadigde vetzuren produceren.

Het CMet Lab aan de Universiteit Gent doet onderzoek naar microbiële
gemeenschappen en stelde een therapie voor om mensen van dit probleem af
te helpen. Die bestaat uit een antibiotica behandeling van de oksel om
het microbiome af te doden, gevolgd door een transplantatie van het
microbiome van een persoon zonder zweetgeur.

Alvorens de therapie breed kan worden ingezet, dient eerst te worden
aangetoond in een experiment dat ze werkt.

\subsection{Experimenteel design
(proefopzet)}\label{experimenteel-design-proefopzet}

Een eerste tak van de statistiek focust op experimenteel design.
Idealiter zouden we de therapie evalueren door het uit te testen op de
volledige populatie van personen met een zweetgeur. Dat is echter niet
haalbaar omdat het
...
\item
  financieel en logistiek onmogelijk is om iedereen te bemonsteren, en
  omdat
\item
  de populatie waarover we uitspraken wensen te doen bestaat nog niet
  volledig: ze omvat ook toekomstige personen met een zweetgeur.
\end{enumerate}

Daarom zullen we een steekproef nemen. Hierbij zullen we een aantal
personen uit de populatie selecteren waarop we het experiment uit zullen
voeren.

Cruciaal is hierbij dat de steekproef representatief is voor de
populatie zodat we de resultaten van het experiment zullen kunnen
veralgemenen naar de populatie. We zullen de mensen daarom volledig at
random trekken uit de populatie zodat elk subject een zelfde kans heeft
om in het experiment te worden opgenomen: aselecte steekproeftrekking
(random sampling uit de populatie). Merk ook op dat het daarom heel
belangrijk is om de populatie goed te omschrijven voor de start van het
experiment: scope van de studie.

In deze studie worden twintig personen met een zweetgeur volledig at
random geselecteerd uit de populatie. We zouden nu elk subject kunnen
behandelen. Maar, dan zijn we niet zeker dat een verschil in het
microbiome te wijten is aan de behandeling.

We hebben dus een goeie controle nodig. We zouden de controle personen
niet kunnen behandelen, maar dan kan een verschil in microbiome
mogelijks ook te wijten zijn aan de antibiotica behandeling i.p.v. aan
de transplantatie. De onderzoekers opteerden daarom 10 personen een
placebo behandeling geven, enkel antibiotica behandeling en 10 personen
te behandelen met antibiotica en de transplantatie.

De proefpersonen worden volledig at random toegewezen aan de
behandelingsgroep zodat beide groepen vergelijkbaar zijn.

Vervolgens moet er stil worden gestaan bij hoe het microbiome zal worden
gemeten.

In de studie maakte men gebruik van een DGGE meting. Microorganismen
hebben een heel variabel stukje ribosomaal RNA, het 16s ribosomaal RNA
dat uniek is voor de soort. Het 16S rRNA van de verschillende
microorganismen in het staal wordt dan geamplificeerd en gescheiden op
een DGGE gel. Waarbij een bandenpatroon ontstaat volgens de lengte van
het 16s rRNA.

\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{./figures/dgge.png}
Foto van een DGGE gel van het oksel microbiome (bron:
\url{https://doi.org/10.1371/journal.pone.0070538})

Elke band in de DGGE correspondeert met een bacterie. Hoe helderder de
band hoe meer van de bacterie in het microbiome voorkomt. Band A staat
voor Staphylococcus. De ratio van de intensiteit van de band en de
totale intensiteit in het bandenpatroon kan worden gebruikt als een
proxy voor de relatieve abundantie.

\emph{Essentiële stap: Vertaal onderzoeksvraag nu naar iets wat we
kunnen quantificeren!}

We kunnen dit doen door middel van het gemiddeld verschil in relatieve
abundantie in Staphylococcus tussen de transplantatie en placebo groep.

Het experiment kan nu worden uitgevoerd.

\subsection{Data exploratie en beschrijvende
statistiek}\label{data-exploratie-en-beschrijvende-statistiek}

Data exploratie is heel belangrijk om inzicht te krijgen in de data en
is een essentiële eerste stap om te leren uit data. Het wordt vaak
ondergewaardeerd of over het hoofd gezien.

Data in deze cursus wordt verwerkt via het statistisch software pakket
R. Vooraleer we met de data exploratie van start kunnen gaan moeten we
de data eerst importeren in R.

We geven duidelijk aan welke delen van de tekst over het Code gaan en
welke over de interpretatie. Probeer initiëel te focussen op de
interpretatie. Het Code zal je immers gedurende de eerste weken
oppikken. Daarom hebben we ook gekozen om aparte clips te maken m.b.t
interpretatie en Code. Zodat de manier hoe je de data analyse dient uit
te voeren het begrip initiëel niet in de weg staan.

\subsubsection{Importeer de data}\label{importeer-de-data}

\emph{Code} Tijdens de data exploratie gaan we voor de data manipulaties
veelal gebruik maken van functies uit het \texttt{tidyverse} package.
Dat kan worden geladen door het commando \texttt{library(tidyverse)}.

Via het commando \texttt{read\_lines} kunnen we enkele regels van een
data bestand inlezen om de structuur van het data bestand te weten te
komen.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(tidyverse)}
\FunctionTok{read\_lines}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/armpit.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  Verschillende variabelen worden gemeten per persoon en zijn van elkaar
  gescheiden door een comma. Het bestand is in csv formaat: ``comma
  separated values''.
\item
  We kunnen bestanden met dit formaat inlezen R via het commando
  \texttt{read\_csv}.
\item
  We slaan de data op in R in het object met naam ap. Hiervoor gebruiken
  we de \texttt{\textless{}-} operator.
\item
  We geven de data tabel terug door het object aan te roepen door zijn
  naam te typen.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ap }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/armpit.csv"}\NormalTok{)}
\NormalTok{ap}
\end{Highlighting}
\end{Shaded}
...
proefpersonen in de rijen waarvoor we twee karakteristieken (variabelen)
hebben bijgehouden per subject: behandeling (trt) en relatieve
abundantie (rel). Deze data structuur wordt \texttt{tidy\ data} genoemd.

Weinig mensen kunnen a.d.h.v. het bekijken van de data matrix structuur
of patronen zien in de data. Daarom zullen we de data moeten verwerken
en visualiseren.

\subsubsection{Beschrijvende statistiek}\label{beschrijvende-statistiek}

In artikels en de media worden resultaten uit een steekproef vaak
gerapporteerd a.d.h.v. gemiddelde en de standaardafwijking.
...
\item
  ...
  apRelSum via \texttt{apRelSum\ \textless{}-}.
\end{itemize}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  We pipen (via \texttt{\textbar{}\textgreater{}}) het \texttt{ap}
  dataframe naar de \texttt{group\_by} functie om de data te groeperen
  per treatment trt: \texttt{group\_by(trt)}.
\item
  We pipen het resultaat naar de \texttt{summarize\_at} function om de
  ``rel'' variable samen te vatten en berekenen hierbij het gemiddelde
  en standaardafwijking. Omdat we de data eerst hebben gegroepeerd
  zullen we het gemiddelde en de standaard deviatie berekenen per groep.
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{apRelSum }\OtherTok{\textless{}{-}}\NormalTok{ ap }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(trt) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"rel"}\NormalTok{,}
...
We kunnen ook een tabel in de webpagina of het pdf bestand integreren
via het commando kable van het knitr pakket:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(apRelSum, tableType)}
\end{Highlighting}
\end{Shaded}
...
Het effect van de behandeling in de steekproef kan worden
gekwantificeerd door de gemiddelde relatieve abundantie te vergelijken
in elke steekproef. We observeren dat de gemiddelde relatieve abundantie
in de steekproef gemiddeld 22.2\% hoger is in de transplantatie dan in
de placebo groep.

We quantificeren ook de variabiliteit of de spreiding van de gegevens
rond het gemiddelde aan de hand van de standaardafwijking.

Het gemiddelde en de standaardafwijking wordt ook vaak grafisch
weergegeven in een barplot.

\emph{Code} We maken in deze cursus gebruik van het pakket
\texttt{ggplot2} om grafieken te maken.\\
Met de ggplot2 bibliotheek kunnen we gemakkelijk grafieken opbouwen in
lagen (layers). Hierdoor leest de code veel makkelijker. Een uitgebreide
introductie tot ggplot vind je in de Dodona module
\href{https://dodona.ugent.be/nl/courses/345/}{R data exploration and
visualisation}.

Bar plots worden heel veel gebruikt in artikels om resultaten weer te
geven.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  We pipen de samengevatte data naar de functie \texttt{ggplot}. Dat is
  de basis van elke ggplot. We selecteren de variabele met de
  behandeling trt als x variabele en de variabele met naam mean als
  y-variabele voor de plot. We doen dit steeds via de aesthetics
  \texttt{aes} functie. \texttt{aes(x=trt,y=mean)}
\item
  We maken een barplot door een laag toe te voegen via de
  \texttt{geom\_bar} function. De statistiek is \texttt{stat="identity"}
  omdat de hoogte van de bar gelijk is aan de waarde voor y (hier het
  gemiddelde voor de relatieve abundantie).
\item
  We voegen foutenvlaggen toe om de onzekerheid op het gemiddelde weer
  te geven. We doen dit via de \texttt{geom\_errorbar} functie en
  specifiëren het minimum en maximum van de error bar. Het
  \texttt{width} argument wordt gebruikt om de breedte van de error bar
  smaller te maken dan deze van de bar.
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{apRelSum }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{trt,}\AttributeTok{y=}\NormalTok{mean)) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-6-1.pdf}}

\emph{Interpretatie}

Is deze plot informatief? Nee!

We zien enkel een ``two-number summary'': het gemiddelde en de
standaarddeviatie. We weten niet of deze wel een goeie samenvattende
maat zijn voor de data. Bovendien wordt heel wat ruimte in de plot benut
die niet informatief is: er zijn bijvoorbeeld geen observaties met
relatieve abundanties van 0\%.

Om de data van verschillende groepen makkelijk te kunnen vergelijken in
een grafiek die meer informatief is dan de bar plot ontwikkelde Tukey de
boxplot. Dit is een ``five-number summary'' het bereik van de data
(minimum en maximum) samen met het 25, 50 (mediaan), en 75 percentiel.
Deze percentielen zijn de waarden waarvoor respectievelijk 25\%, 50\% en
75\% van de data in de steekproef kleiner zijn. Tukey raadde aan om het
bereik van de data te berekenen zonder rekening te houden met outliers
(extreme observaties). De outliers worden afzonderlijk als data punten
toegevoegd aan de plot. In het hoofdstuk 4: Data Exploratie leggen we
uit wat outliers precies zijn.

\emph{Code} We maken nu een boxplot voor de ap data
...
\item
  We selecteren de data voor de plot via
  \texttt{ggplot(aes(x=trt,y=rel))}
\item
  We voegen een laag toe voor de boxplot dmv de functie
  \texttt{geom\_boxplot()}
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ap }\SpecialCharTok{|\textgreater{}}  
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{trt,}\AttributeTok{y=}\NormalTok{rel)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-7-1.pdf}}

\emph{Interpretatie}: De boxplot geeft ons al veel meer informatie dan
de barplot. Het bereik van de data wordt weergegeven door de wiskers
(eindpunten van de verticale lijnen in het midden van de boxplot). De
box in de boxplot geeft het 25\%, 50\% en 75\% percentiel weer. (Merk op
dat er geen outliers zijn. Er worden geen individuele punten weergegeven
in de plot)

We observeren dat de boxplot voor de transplantatie groep hoger ligt dan
voor de placebo groep. Wat aangeeft dat de relatieve abundanties van
Staphylococcus vaak hoger liggen voor personen in de steekproef die zijn
toegewezen aan de transplantatie groep dan voor personen die zijn
toegewezen aan placebo groep. Dit is een indicatie dat de behandeling
werkt.

Verder weten we dat er maar 10 observaties zijn in elke groep. Dat laat
toe om de ruwe gegevens aan de plot toe te voegen zonder dat de plot te
druk wordt.
...
\tightlist
\item
  Merk op dat we het argument \texttt{outlier.shape} op NA (not
  available) zetten \texttt{outlier.shape=NA} in the
  \texttt{geom\_boxplot} functie. Dat doen we standaard als we de ruwe
  data toevoegen aan de boxplots: anders zullen outliers immers twee
  keer worden weergegeven (eerst via de boxplot laag en daarna door de
  laag met alle ruwe data toevoegen aan de plot).
\item
  We geven de ruwe data weer via de
  \texttt{geom\_point(position="jitter")} functie. We gebruiken hierbij
  het argument position=`jitter' zodat we wat random ruis toevoegen aan
  de x-cordinaat zodat de gegevens elkaar niet overlappen.
\end{itemize}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-8-1.pdf}}

Dit is een informatieve plot! Het toont de data zo ruw mogelijk weer. De
plot is toch nog goed leesbaar en toont duidelijk aan dat de relatieve
abundanties bij bijna alle proefpersonen in de transplantatie groep
hoger is dan deze voor de placebo groep.

\subsection{Statistische
Besluitvorming}\label{statistische-besluitvorming}

We zagen duidelijk een effect van de transplantatie op de relatieve
abundantie van Staphylococcus. We vragen ons nu af of het effect groot
genoeg is om te kunnen concluderen dat de behandeling werkt.

Hoe kunnen we met andere woorden de conclusies uit de steekproef
veralgemenen naar de populatie toe? \emph{inductie}. Op basis van de
steekproef kunnen we het effect, gemiddeld verschil in relatieve
abundantie tussen beide behandelingsgroepen, schatten in de populatie.
De prijs die we hiervoor betalen is onzekerheid! Omdat we niet alle
personen in de populatie hebben kunnen testen zullen we echter nooit
absoluut zeker kunnen zijn over onze conclusies.

Om de conclusies uit de steekproef te veralgemenen naar de populatie
maken we gebruik van een derde tak van de statistiek: Statistische
besluitvorming.
...
\item
  Falsificatie principe van Popper: Data kunnen enkel een hypothese of
  een theorie ontkrachten.
\item
  Met statistiek kunnen we dus niet aantonen dat de behandeling werkt.
\item
  Statistiek zal ons wel toelaten om het omgekeerde te falsifiëren: als
  we veronderstellen dat er geen effect van de behandeling, spreekt de
  data in de steekproef dit tegen?
\end{itemize}

Met statistiek kunnen we berekenen hoe waarschijnlijk het is om in een
random steekproef (nieuw experiment) een verschil in gemiddelde
relatieve abundantie te zien tussen transplantatie
(\(\bar X_\text{transplant}\)) en placebo groep
(\(\bar X_\text{placebo}\)) dat minstens 22.2\% bedraagt als de
behandeling geen effect zou hebben.

\[p=P( \vert \bar X_\text{transplant}-\bar X_\text{placebo}\vert \geq 22.2\% \vert \text{geen effect van de behandeling})\]

\begin{itemize}
\item
  Die kans wordt een p-waarde genoemd.
\item
  Als p heel klein is, dan is het heel onwaarschijnlijk om een dergelijk
  effect door toeval te observeren in een steekproef als er in
  werkelijkheid geen effect is van de behandeling.
\end{itemize}

Om de kans p te berekenen is het nodig om de data te modelleren met een
statistisch model. Hiervoor zullen we bepaalde aannames moeten doen. In
hoofdstuk 5 zien we dat we dit kunnen doen d.m.v. de \texttt{t.test}
functie.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(rel}\SpecialCharTok{\textasciitilde{}}\NormalTok{trt,}\AttributeTok{data=}\NormalTok{ap)}
\end{Highlighting}
\end{Shaded}
...
Als er in werkelijkheid geen effect is van de behandeling en als de
model aannames correct zijn dan verwachten we in minder dan 2 op 10000
random steekproeven een verschil van minstens 22.2\% in de relatieve
abundantie tussen beide behandelingsgroepen. Deze kans is heel klein.
Het is dus heel onwaarschijnlijk om dergelijk verschil in relatieve
abundantie te observeren in een random steekproef als er geen effect van
de behandeling zou zijn.

We kunnen daarom de hypothese dat er geen effect is van de behandeling
verwerpen en concluderen:

Er is een statistisch significant verschil in gemiddelde relatieve
abundantie van Staphylococcus in het okselmicrobiome van personen met
een zweetgeur die worden behandeld met de transplantatie en personen die
behandeld worden met de placebo behandeling. Gemiddeld is de relatieve
abundantie van Staphylococcus in het microbiome van personen met een
zweetgeur is 22.2\% hoger na microbiome transplantatie dan na de placebo
behandeling.

\subsubsection{Mogelijke fouten}\label{mogelijke-fouten}

Merk op dat een experiment onderhevig is aan random variabiliteit. Als
we het experiment opnieuw uit zouden voeren zullen we andere
proefpersonen in de steekproef opnemen. Bijgevolg zullen we ook andere
relatieve abundanties meten.

\begin{itemize}
\item
  Daardoor zijn ook onze conclusies onderhevig aan random variabiliteit.
\item
  Zelfs al zou er in werkelijkheid geen effect zijn van de behandeling
  dan kunnen we in een random steekproef met 10 mensen in de placebo en
  10 mensen in de behandelingsgroep toch ook een verschil in relatieve
  abundantie observeren die minstens 22.2\% is. Dat kunnen we in 1 op de
  10000 experimenten verwachten.
\end{itemize}

In dergelijke steekproef zal men ten onrechte besluiten dat er bewijs is
dat de transplantatie behandeling werkt.

\begin{itemize}
\item
  Intuïtief voelen we aan dat we dus niet met absolute zekerheid
  uitspraken kunnen doen over populatiekarakteristieken op basis van een
  eindige steekproef.
\item
  Typisch zullen we de p-waarde vergelijken met 5\% vooraleer we
  beslissen dat een behandeling werkt. We zullen de kans op het maken
  van foute conclusies dus controleren op 5\%.
\end{itemize}

In de volgende case studie zullen we bestuderen hoe de metingen, de
resultaten en de conclusies kunnen variëren van steekproef tot
steekproef.

\section{Case Study II: Verschil in lengte tussen vrouwen en
mannen}\label{case-study-ii-verschil-in-lengte-tussen-vrouwen-en-mannen}

Om resultaten van een steekproef te kunnen veralgemenen naar de
populatie toe trekken we subjecten at random uit de populatie.

Aselecte steekproeftrekking (random sampling uit de populatie) is sterk
gerelateerd met het concept van de populatie en scope van de studie. De
scope van de studie moet goed worden omschreven voor de start van het
experiment. Het is immers de populatie naar waar we de resultaten uit de
...
\begin{itemize}
\item
  alle subjecten van de populatie hebben dus evenveel kans om in de
  steekproef te worden opgenomen.
\item
  de selectie van een subject is onafhankelijk van andere subjecten in
  de steekproef.
\end{itemize}

De steekproef is dan representatief voor de populatie, maar is nog
steeds random.

Om te begrijpen dat een steekproef random is zouden we hetzelfde
experiment veel keer moeten kunnen herhalen
(\texttt{repeated\ sampling}). Dan zouden we inzicht kunnen krijgen hoe
de gegevens veranderen van steekproef tot steekproef.

Om dit te illustreren zullen we gebruik maken van de National Health And
Nutrition Examination Study (NHANES) studie. Uit die studie kunnen we
herhaaldelijk kleine steekproeven trekken om te begrijpen hoe de
gegevens en statistieken veranderen van steekproef tot steekproef. Of om
met andere woorden na te gaan wat de variabiliteit is tussen
steekproeven.
...
\begin{itemize}
\item
  Sinds 1960 worden elk jaar mensen van alle leeftijden geïnterviewd bij
  hen thuis.
\item
  Er maakt ook een gezondheidsonderzoek deel uit van de study die in een
  mobiel onderzoekscentrum wordt afgenomen.
\item
  We zullen deze grote studie gebruiken om at random personen te
  selecteren van de Amerikaanse populatie.
\item
  Dat zal inzicht geven in hoe de gegevens en resultaten van een analyse
  zullen variëren van steekproef tot steekproef.
\end{itemize}

De data van deze studie is terug te vinden in het R pakket
\texttt{NHANES}. Met de functie \texttt{head} kunnen we de eerste 6
rijen van de dataset bekijken.
...
We focussen in dit voorbeeld op het verschil in lengte tussen volwassen
vrouwen en mannen in de Amerikaanse populatie.

Onderzoeksvraag: hoe verschilt de lengte van volwassen mannen en
vrouwen.

We exploreren hiervoor eerst de lengte data in de NHANES studie. Omdat
we heel veel gegevens hebben, maken we gebruik van histogrammen om
inzicht te krijgen in de verdeling van de data.

\emph{Code} 1. We pipen de dataset naar de function \texttt{filter} om
de data te filteren volgens leeftijd. We verwijderen eveneens gegevens
waarvoor de lengte metingen ontbreken. Voor deze gevens werd de data
ingegeven met de code NA (Not Available) 2. We plotten de lengte
metingen. - We selecteren de data met het commando
\texttt{ggplot(aes(x=lengte))} - We voegen een histogram toe met het
commando \texttt{geom\_histogram()} - We maken twee vertikale panels met
het commando \texttt{facet\_grid(Gender\textasciitilde{}.)}. Een panel
per geslacht. - We veranderen het label van de x-as met de \texttt{xlab}
functie.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES}\SpecialCharTok{|\textgreater{}}  
  \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(Height)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Height))}\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_grid}\NormalTok{(Gender }\SpecialCharTok{\textasciitilde{}}\NormalTok{ .) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Lengte (cm)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-11-1.pdf}}
...
\tightlist
\item
  Zoals we verwachten ligt de verdeling van de lengte van mannen hoger
  dan deze van vrouwen.
\item
  We zien dat de data min of meer symmetrisch verdeeld zijn in elke
  groep en een klokvorm hebben.
\item
  We zullen later zien dat de lengte data approximatief normaal verdeeld
  zijn.
\item
  Dat zal ons toe laten om de data verder samen te vatten door gebruik
  te maken van twee statistieken: het gemiddelde en de standaard
  deviatie wat een maat is voor de spreiding van de gegevens rond het
  gemiddelde.
\end{itemize}
...
\tightlist
\item
  We filteren op leeftijd en verwijderen ontbrekenden gegevens (NA, Not
  Available).
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhanesSub }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(Height)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{select}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"Gender"}\NormalTok{,}\StringTok{"Height"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

We berekenen het gemiddelde en de standaard deviatie voor de lengte voor
mannen en vrouwen in de grote dataset. We groeperen de data hiervoor op
basis van het geslacht (variable Gender).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{HeightSum }\OtherTok{\textless{}{-}}\NormalTok{ nhanesSub }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"Height"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{mean =}\NormalTok{ mean,}
               \AttributeTok{sd =}\NormalTok{ sd)}
\NormalTok{              )}

\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}
\NormalTok{  HeightSum }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate\_if}\NormalTok{(is.numeric, round, }\AttributeTok{digits=}\DecValTok{1}\NormalTok{),}
\NormalTok{  tableType}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
Vrouwen zijn gemiddeld 162.1 cm HeightSum en mannen 175.9 cm. Wat onze
intuïtie bevestigt dat mannen gemiddeld groter zijn dan vrouwen.
...
\item
  We zouden dan een experiment op moeten zetten om metingen bij mannen
  en vrouwen te doen.
\item
  Veronderstel dat we budget hebben om metingen bij 5 mannen en 5
  vrouwen te doen.
\item
  We zouden dan 5 mannen en 5 vrouwen boven de 25 jaar at random
...
\NormalTok{nSamp }\OtherTok{\textless{}{-}} \DecValTok{5}
\NormalTok{fem }\OtherTok{\textless{}{-}}\NormalTok{ nhanesSub }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{mal }\OtherTok{\textless{}{-}}\NormalTok{ nhanesSub }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"male"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{sample\_n}\NormalTok{(}\AttributeTok{size=}\DecValTok{5}\NormalTok{)}

\NormalTok{samp1 }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(fem,mal)}
...
We hebben met de code dus een steekproef getrokken van 5 vrouwen en 5
mannen. We exploreren vervolgens de data in de steekproef.
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-15-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{HeightSumExp1 }\OtherTok{\textless{}{-}}\NormalTok{ samp1 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"Height"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{mean =}\NormalTok{ mean,}
                      \AttributeTok{sd =}\NormalTok{ sd)}
...
Histogram is niet zinvol als we maar zo weinig datapunten hebben. Een
boxplot is meer geschikt om distributies te vergelijken als er weinig
data zijn:

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-16-1.pdf}}

\emph{Einde Code}

Om na te gaan of het verschil in de steekproef groot genoeg is om de
bevindingen van de steekproef te kunnen veralgemenen naar de populatie
toe voeren we opnieuw een t-test uit.

Met de p-waarde wordt de kans berekend om in een nieuwe random
steekproef door toeval een effect te vinden dat in absolute waarde
minstens evengroot is als in onze geobserveerde steekproef onder de
aanname dat er in werkelijkheid geen verschil zou zijn in gemiddelde
lengte tussen vrouwen en mannen.

Als die kans heel klein is, is het weinig waarschijnlijk om onze
steekproef te observeren onder de hypothese dat de lengtes gemiddeld
niet verschillen tussen vrouwen en mannen en kunnen we deze hypothese
verwerpen.

Typisch wordt de kans op een valse positieve conclusie gecontroleerd op
5\%.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(Height}\SpecialCharTok{\textasciitilde{}}\NormalTok{Gender,}\AttributeTok{data=}\NormalTok{samp1)}
\end{Highlighting}
\end{Shaded}
...
In het experiment zijn vrouwen gemiddeld 19.16 cm kleiner dan mannen. En
als we een statistische test uitvoeren (zie hoofdstuk 5: Statistische
...
Als we het experiment herhalen selecteren we andere mensen en verkrijgen
we andere resultaten.
...
\NormalTok{samp2 }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(fem,mal)}

\NormalTok{HeightSumExp2 }\OtherTok{\textless{}{-}}\NormalTok{ samp2 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"Height"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\NormalTok{mean,}
                    \AttributeTok{sd=}\NormalTok{sd)}
...
\NormalTok{samp2 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Gender,}\AttributeTok{y =}\NormalTok{ Height)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape =} \ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position =} \StringTok{"jitter"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\NormalTok{, }\AttributeTok{y =}\NormalTok{ HeightSumExp2}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{]),}
    \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
    \AttributeTok{pch =} \DecValTok{17}\NormalTok{,}
    \AttributeTok{color=}\StringTok{"darkred"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{2}\NormalTok{, }\AttributeTok{y =}\NormalTok{ HeightSumExp2}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{2}\NormalTok{]),}
    \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
    \AttributeTok{pch =} \DecValTok{17}\NormalTok{,}
    \AttributeTok{color =} \StringTok{"darkred"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Height (cm)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-18-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(Height }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Gender, }\AttributeTok{data=}\NormalTok{samp2)}
\end{Highlighting}
\end{Shaded}
...
Vijf andere mannen en vrouwen worden getrokken uit de populatie.
Hierdoor verschillen de lengte metingen van de vorige steekproef alsook
de berekende gemiddeldes en de p-waarde van de statistische toets.

In de nieuwe steekproef zijn vrouwen gemiddeld 4.2 cm kleiner dan
mannen. En dit verschil is statistisch niet significant

\subsection{Herhaal het experiment
opnieuw}\label{herhaal-het-experiment-opnieuw}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{seed }\OtherTok{\textless{}{-}} \DecValTok{88605}
...
\NormalTok{samp3 }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(fem,mal)}

\NormalTok{HeightSumExp3 }\OtherTok{\textless{}{-}}\NormalTok{ samp3 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(Gender) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"Height"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\NormalTok{mean,}
                    \AttributeTok{sd=}\NormalTok{sd)}
...
\NormalTok{samp3 }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position =} \StringTok{"jitter"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\NormalTok{, }\AttributeTok{y =}\NormalTok{ HeightSumExp3}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{]),}
    \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
    \AttributeTok{pch =} \DecValTok{17}\NormalTok{,}
    \AttributeTok{color=}\StringTok{"darkred"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{2}\NormalTok{, }\AttributeTok{y =}\NormalTok{ HeightSumExp3}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{2}\NormalTok{]),}
    \AttributeTok{size =} \DecValTok{3}\NormalTok{,}
    \AttributeTok{pch =} \DecValTok{17}\NormalTok{,}
    \AttributeTok{color =} \StringTok{"darkred"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Height (cm)"}\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-19-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(Height }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Gender, }\AttributeTok{data=}\NormalTok{samp3)}
\end{Highlighting}
\end{Shaded}
...
Merk op dat we in deze extreme steekproef door toeval vrij grote vrouwen
en eerder kleine mannen hebben getrokken uit de populatie. Een
dergelijke steekproef zal eerder zeldzaam zijn maar kan door toeval
voorkomen.

In de onderstaande paragraaf leggen we uit hoe we deze extreme
steekproef hebben bekomen:

Een seed wordt in de cursus gebruikt om ervoor te zorgen dat we telkens
dezelfde resultaten bekomen als we de random generator opnieuw laten
lopen in R (zie het set.seed commando). Dat doen we puur om de
resultaten in de cursus gelijk te kunnen houden als we aanpassingen
hebben doorgevoerd aan de tekst en de code dus opnieuw moeten laten
lopen om de cursus te compileren. In vrijwel alle code is de seed gewoon
random gekozen.

Om de extreme steekproef weer te geven, hebben we deze keer echter geen
random seed gebruikt. Daarvoor hebben we alle seeds overlopen van 1 tot
100000. We hebben dus \ensuremath{8.8605\times 10^{4}} steekproeven
moeten trekken alvorens we een dergelijke extreme steekproef uit de
populatie hadden getrokken waaruit we ten onrechte zouden concluderen
...
\item
  Bijgevolg zijn onze conclusies ook onzeker en kunnen deze wijzigen van
  steekproef tot steekproef.
\item
  Ook steekproeven waarbij het effect tegengesteld is aan dat in de
  populatie en waarbij we besluiten dat het verschil significant is
  kunnen voorkomen.
\item
  We kunnen aantonen dat dergelijke steekproeven voor experimenten
  waarbij we de lengte tussen mannen en vrouwen vergelijken eerder
  zeldzaam zijn.
\end{itemize}

\(\rightarrow\) Met statistiek gaan we de kans op het trekken van foute
conclusies controleren.

\subsection{Controle van
beslissingsfouten}\label{controle-van-beslissingsfouten}

Deze sectie slaan we in academiejaar 2026-2027 over en we komen hierop
terug wanneer we beslissingsfouten zien in hoofdstuk 5.
...
Deze code is vrij complex. Het kan nuttig zijn om deze pas na de twee
modules Introductie tot R, en, data visualisatie opnieuw te bekijken.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{15152}\NormalTok{)}
\CommentTok{\# Aantal simulaties en steekproefgrootte per groep}
\NormalTok{nSim }\OtherTok{\textless{}{-}} \DecValTok{10000}
\NormalTok{nSamp }\OtherTok{\textless{}{-}} \DecValTok{5}

\CommentTok{\# We filteren de data vooraf zodat we dit niet telkens opnieuw hoeven te doen}
\NormalTok{fem }\OtherTok{\textless{}{-}}\NormalTok{ nhanesSub }\SpecialCharTok{|\textgreater{}}
...
\CommentTok{\# Simulatie studie}
\CommentTok{\# Om snelle functies te kunnen gebruiken nemen we eerst nSim steekproeven en berekenen we daarna alles.}

\NormalTok{femSamps }\OtherTok{\textless{}{-}}\NormalTok{ malSamps }\OtherTok{\textless{}{-}}\FunctionTok{matrix}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\AttributeTok{nrow=}\NormalTok{nSamp, }\AttributeTok{ncol=}\NormalTok{nSim)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{nSim)}
\NormalTok{\{}
\NormalTok{  femSamps[,i] }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{Height, nSamp)}
\NormalTok{  malSamps[,i] }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(mal}\SpecialCharTok{$}\NormalTok{Height, nSamp)}
\NormalTok{\}}

\NormalTok{res }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{verschil=}\FunctionTok{colMeans}\NormalTok{(femSamps) }\SpecialCharTok{{-}} \FunctionTok{colMeans}\NormalTok{(malSamps),}
\NormalTok{  Rfast}\SpecialCharTok{::}\FunctionTok{ttests}\NormalTok{(femSamps, malSamps)}
\NormalTok{  )}

\FunctionTok{sum}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{pvalue }\SpecialCharTok{\textless{}} \FloatTok{0.05} \SpecialCharTok{\&}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{verschil }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{pvalue }\SpecialCharTok{\textgreater{}=} \FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{pvalue }\SpecialCharTok{\textless{}} \FloatTok{0.05} \SpecialCharTok{\&}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{verschil}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{verschil,}\AttributeTok{y=}\SpecialCharTok{{-}}\FunctionTok{log10}\NormalTok{(pvalue),}\AttributeTok{color=}\NormalTok{pvalue }\SpecialCharTok{\textless{}} \FloatTok{0.05}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Gemiddeld Verschil (cm)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Statistische Significantie ({-}log10 p)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-20-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ verschil)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Gemiddeld Verschil (cm)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-20-2.pdf}}

Op basis van 10000 steekproeven van 5 mannen en 5 vrouwen zagen we dat
in 7234 steekproeven vrouwen gemiddeld significant kleiner zijn dan
...
\item
  ...
  significant groter zijn dan mannen is heel onwaarschijnlijk. Er
  moesten 88605 steekproeven worden getrokken om deze extreme steekproef
  te vinden.
\item
  Het feit dat we in veel steekproeven resultaten vinden die statistisch
  niet significant zijn komt omdat de statistische toets een te lage
  kracht heeft om het verschil te detecteren wanneer er maar 5
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{11145}\NormalTok{)}
\CommentTok{\# Aantal simulaties en steekproefgrootte per groep}
\NormalTok{nSim }\OtherTok{\textless{}{-}} \DecValTok{10000}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-21-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-21-2.pdf}}
...
\item
  Hoe meer gegevens hoe makkelijker we het werkelijk verschil oppikken
  in de steekproef.
\item
  Dat wordt ook geïllustreerd in het gemiddelde verschil in lengte
  tussen mannen en vrouwen: daar zit in de grote studie veel minder
  variabiliteit op van steekproef tot steekproef omdat ze veel
  nauwkeuriger kunnen worden geschat omdat er meer gegevens zijn in de
  steekproef.
\end{itemize}

\subsubsection{Controle van vals
positieven}\label{controle-van-vals-positieven}

Wat gebeurt er als er geen verschil is tussen beide groepen?

\begin{itemize}
\item
  We moeten hiervoor experimenten simuleren waarbij de groepen gelijk
  zijn.
\item
...
\item
  ...
  de NHANES studie. Dan weten we dat er in de populatie geen verschil is
  in lengte tussen beide groepen die we zullen vergelijken.
\item
  Als we toch een verschil vinden in een steekproef dan weten we dat dit
  een vals positief resultaat is!
\item
  We doen de simulatiestudie opnieuw voor steekproeven met 5 subjecten
  per groep
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{13245}\NormalTok{)}
\CommentTok{\# Aantal simulaties en steekproefgrootte per groep}
\NormalTok{nSim }\OtherTok{\textless{}{-}} \DecValTok{10000}
\NormalTok{nSamp }\OtherTok{\textless{}{-}} \DecValTok{5}
...
\NormalTok{femSamps }\OtherTok{\textless{}{-}}\NormalTok{ femSamps2 }\OtherTok{\textless{}{-}}\FunctionTok{matrix}\NormalTok{(}\ConstantTok{NA}\NormalTok{, }\AttributeTok{nrow=}\NormalTok{nSamp, }\AttributeTok{ncol=}\NormalTok{nSim)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{nSim)}
\NormalTok{\{}
\NormalTok{  femSamps[,i] }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{Height, nSamp)}
\NormalTok{  femSamps2[,i] }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{Height, nSamp)}
\NormalTok{\}}

\NormalTok{res }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{verschil=}\FunctionTok{colMeans}\NormalTok{(femSamps) }\SpecialCharTok{{-}} \FunctionTok{colMeans}\NormalTok{(femSamps2),}
\NormalTok{  Rfast}\SpecialCharTok{::}\FunctionTok{ttests}\NormalTok{(femSamps, femSamps2)}
\NormalTok{  )}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-22-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-22-2.pdf}}

Op basis van 10000 steekproeven zien we dat we in 442 steekproeven ten
onrechte besluiten dat er een verschil is in gemiddelde lengte tussen
twee groepen vrouwen.

Met de statistische analyse controleren we dus het aantal vals positieve
resultaten correct op 5\%.
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-23-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-23-2.pdf}}

Op basis van 10000 steekproeven zien we dat we in 499 steekproeven ten
onrechte besluiten dat er een verschil is in gemiddelde lengte tussen
twee groepen vrouwen.

Met de statistische analyse controleren we dus ook bij het nemen van een
grote steekproef het aantal vals positieve resultaten correct op 5\%.
...
\def\labelenumi{\arabic{enumi}.}
\item
  In elke steekproef worden at random andere proefpersonen uit de
  populatie getrokken.
\item
...
\item
  Ook onze conclusies zijn onzeker en kunnen wijzigen van steekproef tot
  steekproef.
\item
  Met statistiek controleren we de kans op het trekken van foute
  conclusies.
\end{enumerate}

\section{Case study: Salk vaccin}\label{case-study-salk-vaccin}

In 1916 brak de eerste grote polio epidemie uit in de USA. Begin de
jaren 50 ontwikkelde John Salk een vaccin met belovende resultaten in
het lab. In 1954 heeft de National Foundation for Infantile Paralysis
(NFIP) een grote studie opgezet om de effectiviteit van het Salk vaccin
na te gaan.

\begin{itemize}
\tightlist
\item
  Veronderstel dat de NFIP in 1954 een groot aantal kinderen zou hebben
  gevaccineerd, wat zouden ze dan kunnen besluiten als de polio
  incidentie in 1954 lager was dan in 1953?
\end{itemize}

Neen, het zou kunnen dat het verschil in polio incidentie veroorzaakt
werd door het feit dat de infectie minder hevig was in 1954. We hebben
dus een controle nodig!
...
\item
  Cases: kinderen van de tweede graad van het lager onderwijs waarvan de
  ouders toestemden met vaccinatie.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nfip }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{group=}\FunctionTok{c}\NormalTok{(}\StringTok{"cases"}\NormalTok{,}\StringTok{"controls"}\NormalTok{,}\StringTok{"noConcent"}\NormalTok{),}
  \AttributeTok{grade=}\FunctionTok{c}\NormalTok{(}\StringTok{"g2"}\NormalTok{,}\StringTok{"g1g3"}\NormalTok{,}\StringTok{"g2"}\NormalTok{),}
  \AttributeTok{vaccin=}\FunctionTok{c}\NormalTok{(}\StringTok{"yes"}\NormalTok{,}\StringTok{"no"}\NormalTok{,}\StringTok{"no"}\NormalTok{),}
  \AttributeTok{total=}\FunctionTok{c}\NormalTok{(}\DecValTok{221998}\NormalTok{,}\DecValTok{725173}\NormalTok{,}\DecValTok{123605}\NormalTok{),}
  \AttributeTok{polio=}\FunctionTok{c}\NormalTok{(}\DecValTok{54}\NormalTok{,}\DecValTok{391}\NormalTok{,}\DecValTok{56}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{noPolio =}\NormalTok{ total }\SpecialCharTok{{-}}\NormalTok{ polio)}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(nfip, tableType)}
\end{Highlighting}
\end{Shaded}
...
We zien 54 polio besmettingen bij de gevaccineerde kinderen en 391 bij
de controle groep.
...
\tightlist
\item
  We voegen een extra column toe aan het nfip data object d.m.v. de
  mutate functie. We berekenen de incidentie per miljoen kinderen
  (incidencePM) en slaan de gewijzigde dataset op onder dezelfde naam.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nfip }\OtherTok{\textless{}{-}}\NormalTok{ nfip }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{incidencePM =} \FunctionTok{round}\NormalTok{(nfip}\SpecialCharTok{$}\NormalTok{polio}\SpecialCharTok{/}\NormalTok{nfip}\SpecialCharTok{$}\NormalTok{total}\SpecialCharTok{*}\FloatTok{1e6}\NormalTok{,}\DecValTok{0}\NormalTok{))}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(nfip, tableType)}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  We observeren nu dat de incidentie meer dan dubbel zo hoog is in de
  controle groep als in de vaccinatie groep.
\item
  We observeren echter ook dat de incidentie lager is in de groep van
  kinderen uit de tweede graad waarvan de ouders geen toestemming gaven
  voor inenting!?
\item
  Wat betekent dit?
\end{itemize}
...
\begin{center}
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{01-Inleiding_files/figure-pdf/unnamed-chunk-26-1.pdf}
\end{center}

We observeren een lagere polio (P) incidentie voor kinderen bij wie de
ouders geen toestemming gaven dan in de controle groep. Toestemming voor
vaccinatie (V) is geassocieerd met de socio-economische status (S).
Kinderen van lagere socio-economische status zijn meer resistent tegen
de ziekte.

Er is dus sprake van confounding: de socio-economische status is
geassocieerd met zowel de polio incidentie als met de toestemming op
vaccinatie.

Controle groep en gevaccineerde groep zijn dus niet vergelijkbaar: Ze
verschillen in socio economische status en bovendien ook in leeftijd! We
kunnen aan de hand van het experiment het effect van de vaccinatie niet
correct inschatten.
...
\tightlist
\item
  Kinderen worden at random toegewezen aan controle of case arm van het
  experiment nadat de ouders toestemden met vaccinatie.
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{salk }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{group=}\FunctionTok{c}\NormalTok{(}\StringTok{"cases"}\NormalTok{,}\StringTok{"control"}\NormalTok{,}\StringTok{"noConcent"}\NormalTok{),}
  \AttributeTok{treatment=}\FunctionTok{c}\NormalTok{(}\StringTok{"vaccine"}\NormalTok{,}\StringTok{"placebo"}\NormalTok{,}\StringTok{"none"}\NormalTok{),}
  \AttributeTok{total=}\FunctionTok{c}\NormalTok{(}\DecValTok{200745}\NormalTok{,}\DecValTok{201229}\NormalTok{, }\DecValTok{338778}\NormalTok{),}\AttributeTok{polio=}\FunctionTok{c}\NormalTok{(}\DecValTok{57}\NormalTok{,}\DecValTok{142}\NormalTok{,}\DecValTok{157}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{noPolio =}\NormalTok{ total}\SpecialCharTok{{-}}\NormalTok{polio,}
    \AttributeTok{incidencePM =} \FunctionTok{round}\NormalTok{(polio}\SpecialCharTok{/}\NormalTok{total}\SpecialCharTok{*}\FloatTok{1e6}\NormalTok{,}\DecValTok{0}\NormalTok{)}
\NormalTok{    )}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(salk, tableType)}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  We observeren een veel groter effect nu cases en controles
  vergelijkbaar zijn, incidentie van respectievelijk 284 en 706 per
  miljoen.
\item
  De polio incidentie voor kinderen die geen toestemming geven blijft
  vergelijkbaar 453 en 463 per miljoen respectievelijk in de NFIP- en
  Salk-studie.
\end{itemize}

We zullen later in de cursus tonen dat het effect van het vaccin
statistisch significant is.

\section{Rol van Statistiek}\label{rol-van-statistiek}

In deze introductie hebben we gezien dat statistiek een belangrijke rol
speelt in empirisch onderzoek. We toonden aan dat
...
\item
  ...
  \begin{itemize}
  \item
    het belangrijk is om de scope van de studie goed te specifiëren voor
    de start van het experiment
  \item
    aselecte steekproeftrekking (random sampling uit de populatie) nodig
    is om een representatieve steekproef te nemen
  \item
...
\item
  ...
  \item
    visualiseren
  \item
    samenvatten en beschrijven van geobserveerde data zodat relevante
    aspecten naar voor komen.
  \end{itemize}
\item
...
Alle kennisclips die in dit hoofdstuk zijn verwerkt kan je in deze
youtube playlist vinden:
\href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJJ7apU5sAbRlUsve2nWz5ev}{Kennisclips
Hoofdstuk2}

Link naar webpage/script die wordt gebruikt in de kennisclips:
\href{https://statomics.github.io/sbc/rmd/02-concepts.html}{script
Hoofdstuk2}
...
tak van de statistiek en is een cruciaal onderdeel van een studie. Het
...
van de studie veralgemeend kunnen worden naar de populatie toe.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{02-Concepten_files/figure-pdf/fig-pop2Samp2Pop-1.pdf}

}

\caption{\label{fig-pop2Samp2Pop}Verschillende stappen in een studie.
(1) In de design fase/ proefopzet definieert de onderzoeker de
populatie, bepaalt hij/zij op welke manier een steekproef zal worden
genomen uit de populatie en hoe het experiment zal worden uitgevoerd.
Ook het volledige data analyse plan moet in deze fase zijn vastgelegd.
Vervolgens wordt het experiment uitgevoerd en worden de gegevens
verzameld. (2) De gegevens worden vervolgens verkend en samengevat.
Hierbij verwerft men inzicht in de gegevens en kunnen aannames worden
nagegaan die noodzakelijk zijn voor de verdere data analyse stappen. (3)
Tenslotte zal men hetgeen men observeert in de steekproef trachten te
veralgemenen naar de populatie toe a.d.h.v. statistische inferentie.}
...
introduceren. We doen dat in dit hoofdstuk aan de hand van de NHANES
studie.

\begin{example}[NHANES
studie]\protect\hypertarget{exm-nhanesExConcepten}{}\label{exm-nhanesExConcepten}
...
\ref{tbl-nhanesConcepten}).

\textbf{Einde voorbeeld}

\begin{table}

\caption{\label{tbl-nhanesConcepten}}

\centering{

\caption{\label{tab:tbl-nhanesConcepten}Overzicht van een aantal variabelen uit de NHANES studie.}
\centering
...
variabelen}. Nominale gegevens zijn gegevens die men kan benoemen. Ze
worden niet gemeten en kennen geen natuurlijke ordening; bijvoorbeeld
geslacht, ras, bloedgroep, kleur van ogen, \ldots{} Ordinale variabelen
kennen wel een ordening; bijvoorbeeld de BMI klasse volgens het WHO, de
...
principe willekeurig klein zijn (1 uur, 1 minuut, \ldots). Analoog zijn
het gewicht, BMI, fluorescentie-metingen in een ELISA experiment,
...
\begin{example}[oefening]\protect\hypertarget{exm-oefening}{}\label{exm-oefening}

~

\end{example}

Geef het type aan van de variabelen in Tabel \ref{tbl-nhanesConcepten}

\section{Populatie}\label{sec-pop}
...
tot subject (bvb. van persoon tot persoon, van dier tot dier, \ldots) in
de populatie.
...
onderhevig aan random variabiliteit. De geobserveerde steekproef in de
NHANES studie \(x_1, x_2, . . . , x_{10000}\) kan dus als n = 10000
realisaties worden beschouwd van dezelfde toevallige veranderlijke X,
voor subject \(i\), met \(i = 1,2,...,10000\). Een random veranderlijke,
een karakteristiek van de populatie, wordt beschreven door gebruik te
maken van een \emph{verdeling}.

De verdeling beschrijft de waarschijnlijkheid om een bepaalde waarde te
observeren voor de toevallig veranderlijke wanneer men volledig lukraak
een proefpersoon kiest uit de populatie.

Als we weten hoe de variabele verdeeld is dan kunnen we
probabiliteitstheorie gebruiken om de kans te berekenen dat een bepaald
voorval (event) zich voordoet: vb wat is de kans dat het IQ van een
random subject uit de populatie kleiner of gelijk is aan 80.
...
probabiliteitstheorie}\label{intermezzo-probabiliteitstheorie}

\subsubsection{Discrete toevallig
veranderlijken}\label{discrete-toevallig-veranderlijken}

Stel dat we een discrete random variabele meten \(X\). Alle mogelijke
waarden voor \(X\) worden de steekproefruimte \(\Omega\) genoemd.

\begin{itemize}
\item
  Voor Gender is de steekproefruimte \(\Omega=(0,1)\) met 0 (vrouw) of 1
  (man).
\item
  Voor het werpen van een dobbelsteen is de steekproefruimte
  \(\Omega=(1,2,3,4,5,6)\).
\end{itemize}
...
Event ruimte \(\mathcal{A}\) is de klasse van alle mogelijke events die
kunnen optreden bij een bepaald experiment.

Twee events (\(A_1\) en \(A_2\)) zijn mutueel exclusief als ze niet
samen op kunnen treden.

\begin{itemize}
\tightlist
\item
  v.b. event van de oneven getallen \(A_1=(1,3,5)\) en het event om
  \(A_2=(6)\) te gooien.
\item
  Dus \(A_1 \bigcap A_2=\emptyset\).
\end{itemize}

Probabiliteit \(Pr(A)\) is een function \(Pr: A \rightarrow [0,1]\) die
voldoet aan
...
\item
  \(Pr(\Omega)=1\).
\item
  Voor mutueel exclusieve events \(A_1, A_2, \ldots A_k\) geldt dat
  \(Pr(A_1 \cup A_2 \ldots \cup A_k)= Pr(A_1) + \ldots + Pr(A_k)\).
\end{enumerate}
...
\tightlist
\item
  oneven number \(A=(1,3,5)\): is de unie van 3 mutueel exclusieve
  events \(A_1=1\), \(A_2=3\) en \(A_3=5\) zodat
  \(Pr(A)=Pr(1)+Pr(3)+Pr(5)=1/6+1/6+1/6=0.5\)
\item
  \(\Omega=(1,2,3,4,5,6)\): \(Pr(\Omega)=1\)
\end{itemize}

Als we twee subjecten (j en k) onafhankelijk trekken van de populatie
dan is de gezamelijke probabiliteit \(P(X_j,X_k)= P(X_j)P(X_k)\)

\paragraph{Verdeling}\label{verdeling}

De verdeling van een discrete toevallig veranderlijke \(X\) beschrijft
de kans op elke mogelijke waarde van de steekproefruimte.

Voorbeeld: Gender is een binaire variabele (0: vrouw, 1: man) en binaire
variabelen volgen een Bernoulli verdeling. 50.8\% van de subjecten in de
Amerikaanse populatie zijn vrouw en 49.2\% is man.
...
\begin{Shaded}
\begin{Highlighting}[]
    \FunctionTok{tibble}\NormalTok{(}\AttributeTok{X=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{),}\AttributeTok{prob=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.508}\NormalTok{,}\FloatTok{0.492}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{X,}\AttributeTok{xend=}\NormalTok{X,}\AttributeTok{y=}\DecValTok{0}\NormalTok{,}\AttributeTok{yend=}\NormalTok{prob)) }\SpecialCharTok{+}
      \FunctionTok{geom\_segment}\NormalTok{() }\SpecialCharTok{+}
      \FunctionTok{ylab}\NormalTok{(}\StringTok{"Probability"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-2-1.pdf}}

Toevallig veranderlijke \(X\) volgt een Bernoulli verdeling \(B(\pi)\)
met parameter \(\pi=0.492\), \[B(\pi)= \pi^x(1-\pi)^{(1-x)}\]

\paragraph{Cumulatieve distributie
functie}\label{cumulatieve-distributie-functie}

De cumulatieve distributie functie F(x) geeft de probabiliteit weer om
een toevallige veranderlijke X te observeren waarvoor geldt dat
\(X\leq x\): \[ F(x) = \sum\limits_{\forall X\leq x} P(x)\]

Gender voorbeeld \(F(0)=1-\pi\) en \(F(1)= P(X=0) + P(X=1)=1\)

\begin{Shaded}
\begin{Highlighting}[]
    \FunctionTok{tibble}\NormalTok{(}\AttributeTok{X=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{0.5}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\FloatTok{1.5}\NormalTok{),}\AttributeTok{cumprob=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{0.508}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{X,}\AttributeTok{y=}\NormalTok{cumprob)) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-3-1.pdf}}

Dobbelsteen voorbeeld:

\begin{Shaded}
\begin{Highlighting}[]
    \FunctionTok{tibble}\NormalTok{(}\AttributeTok{X=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{,}\FloatTok{6.5}\NormalTok{),}\AttributeTok{cumprob=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FunctionTok{cumsum}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\DecValTok{6}\NormalTok{,}\DecValTok{6}\NormalTok{)),}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{X,}\AttributeTok{y=}\NormalTok{cumprob)) }\SpecialCharTok{+}
      \FunctionTok{geom\_step}\NormalTok{(}\AttributeTok{direction=}\StringTok{"hv"}\NormalTok{) }\SpecialCharTok{+}
      \FunctionTok{ylab}\NormalTok{(}\StringTok{"F(x)"}\NormalTok{)}
\end{Highlighting}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-4-1.pdf}}

\paragraph{Gemiddelde}\label{gemiddelde}

Het gemiddelde of de verwachte waarde \(E[X]\) van een discrete
toevallig veranderlijke \(X\) is gegeven door:

\[E[X]=\sum\limits_{x\in\Omega} x P(X=x)\]

Merk op dat de operator \(E[.]\) staat voor de verwachte waarde van een
toevallige veranderlijke of een functie van toevallig veranderlijken.
...
De variantie is een maat voor de variabiliteit van een toevallig
veranderlijke en wordt gegeven door:

\[E[(X-E[X])^2]=\sum\limits_{x\in\Omega} (x-E[X])^2 P(X=x)\]

Het is dus de verwachte waarde van de kwadratische afwijkingen van een
toevallig veranderlijke rond zijn gemiddelde en is dus een maat voor de
variabiliteit of spreiding van de toevallige veranderlijke.
...
\subsubsection{Continue toevallig
veranderlijke}\label{continue-toevallig-veranderlijke}

Een continue toevallig veranderlijke kan binnen bepaalde grenzen alle
mogelijke waarden aannemen. De kans dat een continue toevallige
veranderlijke exact één bepaalde waarde aanneemt is daarom gelijk aan 0.

De verdeling wordt daarom weergegeven a.d.h.v. de densiteitsfunctie of
de dichtheidsfunctie \(f(x)\)

Veel biologische karakteristieken zijn approximatief normaal verdeeld
(lengte, bloeddruk, IQ, concentratie metingen na logaritmische
transformatie)
...
Van het IQ is geweten dat het normale verdeling volgt met gemiddelde
\(\mu=100\) en standaardafwijking \(\sigma=15\).

\[IQ \sim N(100,15^2)\]

In R kunnen we de dnorm functie gebruiken om de densiteit te berekenen
voor een bepaalde waarde X=x.

\begin{itemize}
\tightlist
\item
  De argumenten van \texttt{dnorm} zijn \texttt{mean} (\(\mu\)) en
  \texttt{sd} (standaardafwijking \(\sigma\)).
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iq }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}
  \AttributeTok{IQ =} \FunctionTok{seq}\NormalTok{(}\DecValTok{40}\NormalTok{,}\DecValTok{150}\NormalTok{,.}\DecValTok{1}\NormalTok{),}
  \AttributeTok{Densiteit =} \FunctionTok{dnorm}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\DecValTok{40}\NormalTok{,}\DecValTok{150}\NormalTok{,.}\DecValTok{1}\NormalTok{),}\AttributeTok{mean=}\DecValTok{100}\NormalTok{,}\AttributeTok{sd=}\DecValTok{15}\NormalTok{)}
\NormalTok{  )}
\NormalTok{iq }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{IQ,}\AttributeTok{y=}\NormalTok{Densiteit)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/IQ-1.pdf}}
\end{center}

Binnen bepaalde grenzen kunnen continue toevallig veranderlijken alle
mogelijke waarden aannemen dus is \(\Omega\) oneindig groot.
...
Omdat X continu is berekenen we deze probabiliteit a.d.h.v. een
integraal
...
We kunnen \(F(x)\) berekenen voor een normaal verdeelde toevallig
veranderlijke met de functie \texttt{pnorm} die opnieuw argumenten
\texttt{mean} en \texttt{sd} heeft.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{iq }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Probability=}\FunctionTok{pnorm}\NormalTok{(IQ,}\AttributeTok{mean=}\DecValTok{100}\NormalTok{,}\AttributeTok{sd=}\DecValTok{15}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{IQ,}\AttributeTok{y=}\NormalTok{Probability)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-5-1.pdf}}

De probabiliteit dat het IQ van een random subject lager is dan 80 wordt
in R berekend door

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pnorm}\NormalTok{(}\DecValTok{80}\NormalTok{,}\AttributeTok{mean=}\DecValTok{100}\NormalTok{,}\AttributeTok{sd=}\DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-7-1.pdf}}
\end{center}

\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-8-1.pdf}}
\end{center}

Voor de grootst mogelijke waarde voor \(X\) integreren we over de
volledige steekproefruimte \(\Omega\) dus
...
De parameter \(\mu\) is dus het gemiddelde van een Normaal verdeelde
veranderlijke X in de populatie.
...
De parameter \(\sigma^2\) is dus de variantie van een Normaal verdeelde
veranderlijke X in de populatie.

Het is vaak moeilijk om de variantie te interpreteren gezien ze niet in
de zelfde eenheden staat als het gemiddelde. Daarom werken we vaak met
de standaardafwijking (SD):

\[SD=\sqrt{E[(X-E[X])^2]}\]

De standaardafwijking voor de normale verdeling, \(\sigma\) heeft de
interessante interpretatie dat ongeveer 68\% van de populatie een waarde
heeft voor de karakteristiek X binnen het interval van 1
standaardafwijking(\(\sigma\)) rond het gemiddelde:

\[P(\mu-\sigma < X < \mu + \sigma) \approx 0.68\]

\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-9-1.pdf}}
\end{center}

Voor Normaal verdeelde toevallig veranderlijken heeft ongeveer 95\% van
de subjecten in de populatie een waarde die binnen twee
standaardafwijkingen (\(2 \sigma\)) ligt van het gemiddelde.

\[P[\mu - 2 \sigma < X < \mu + 2 \sigma]\approx 0.95\]

\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-10-1.pdf}}
\end{center}

Deze intervallen worden ook wel een referentie interval genoemd.

\subsection{Standaardisatie}\label{standaardisatie}

Normale data worden vaak gestandaardiseerd.

\[z=\frac{x-\mu}{\sigma}\]

Na standaardisatie volgen de data een standaard Normaal verdeling met
gemiddelde \(\mu=0\) en variantie \(\sigma^2=1\): \[z \sim N(0,1)\]

We kunnen de \texttt{qnorm} functie gebruiken om kwantielen
\(z_{2.5\%}\) en \(z_{97.5\%}\) te berekenen die respectievelijk
corresponderen met \(F(z_{2.5\%})=0.025\) en \(F(z_{97.5\%})=0.975\).
...
Voor een standaard Normaal verdeelde toevallig veranderlijke valt
inderdaad ongeveer \(0.975 - 0.025=0.95\) van de waarden binnen het
interval {[}-2,2{]}, of binnen 2 standaardafwijkingen (\(\sigma=1\)) van
het gemiddelde (\(\mu=0\)).

\subsection{Achtergrond Normale verdeling}\label{sec-normalcalc}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{02-Concepten_files/figure-pdf/fig-continu-1.pdf}

}

\caption{\label{fig-continu}Bovenste rij: dichtheidsfunctie van een
Normale verdeling met gemiddelde \(\mu=80\) en standaardafwijking
\(\sigma=12\), met de rode oppervlakte onder de curve die links de kans
\(P(X<64)\), in het midden de kans \(P(X<80)\) en rechts de kans
\(P(64<X<80)\) voorstelt. Onderste rij: overeenkomstige
distributiefunctie \(F(x)=P(X\leq x)\), met telkens de waarde van \(x\)
en de bijhorende kans aangeduid.}
...
\(x\) in Figuur \ref{fig-continu} voor \(\mu=80\) en \(\sigma=12\) en
wordt een \emph{distributiefunctie} genoemd.

\begin{definition}[distributiefunctie]\protect\hypertarget{def-distributiefunctie}{}\label{def-distributiefunctie}

~

\end{definition}

De functie die voor elk getal \(x\) uitdrukt wat de kans is dat een
lukrake meting \(X\) met gekende verdeling (bvb. een Normale verdeling)
kleiner of gelijk is aan \(x\), wordt de \textbf{distributiefunctie} van
die verdeling genoemd.
...
standaarddeviatie \(\sigma\) terug een Normaal verdeelde
...
\begin{exercise}[]\protect\hypertarget{exr-02-concepten-1}{}\label{exr-02-concepten-1}

~

\end{exercise}

Een labo bepaalt in een visstaal Hg via een methode op basis van
Atomaire Absorptiespectrometrie. In werkelijkheid bevat het staal
(gemiddeld) 1.90 ppm. De meetmethode is echter niet perfect, zoals
aangegeven door een standaarddeviatie van 0.10 ppm. Wat is de kans dat
de laborant die het staal onderzoekt, een meetresultaat van 2.10 ppm of
meer vaststelt?
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{pnorm}\NormalTok{(}\FloatTok{2.1}\NormalTok{, }\AttributeTok{mean =} \FloatTok{1.9}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\(P( -
z_{0.025}\leq Z \leq z_{0.025}) = 95\%\). Voor een reeks
...
\begin{definition}[referentie-interval]\protect\hypertarget{def-referentie-interval}{}\label{def-referentie-interval}

~

\end{definition}

Een \textbf{\((1-\alpha)100\%\) referentie-interval} voor een
veranderlijke \(X\) (bvb. albumine-concentratie in het bloed) in een
gegeven studiepopulatie (bvb. volwassen Belgen onder de 60 jaar) is een
interval dat zó gekozen werd dat het met \((1-\alpha)100\%\) kans de
observatie voor een lukraak individu uit die populatie bevat. Voor een
Normaal verdeelde veranderlijke \(X\) met gemiddelde \(\mu\) en
...
In echte studies kennen we de verdeling in de populatie typisch niet! In
de praktijk is het om financiële en logistieke redenen bijna nooit
mogelijk om de volledige populatie te bestuderen. Populatieparameters
(v.b. gemiddeld IQ, variantie van IQ) kunnen daarom meestal niet exact
bepaald worden. Enkel een deel van de populatie kan onderzocht worden,
hetgeen men de \emph{steekproef} noemt. Volgens een gestructureerd
design worden daartoe \textbf{lukraak subjecten} uit de doelpopulatie
getrokken en geobserveerd. De onbekende parameters worden vervolgens
geschat o.b.v. die steekproef en noemt men schattingen. In de praktijk
hoopt men uiteraard dat de schattingen die men bekomt op basis van de
steekproef vergelijkbaar zijn met de overeenkomstige populatieparameters
die men voor de volledige populatie zou bekomen.

Stel bijvoorbeeld dat we op basis van de NHANES studie de lengte van
volgroeide vrouwen en mannen wensen te bestuderen. Telkens een lukraak
...
De verdeling in de populatie is ongekend en moet worden geschat op basis
van de steekproef. Als we aannemen dat de gegevens een bepaalde
verdeling volgen (b.v. de normale verdeling \(N(\mu,\sigma^2)\)) dan
moeten we enkel de populatie parameters (\(\mu\) en \(\sigma^2\))
schatten op basis van de steekproef. We noemen dit schattingen (engels:
estimates) en noteren ze als volgt: \(\hat \mu\) en \(\hat \sigma^2\).

\emph{Samenvatting}

\begin{itemize}
\item
  Voor we het experiment uitvoeren is de populatie karakteristiek voor
  de proefpersonen \(1,\ldots,n\) die we uit de populatie zullen trekken
  ongekend en zijn dat toevallig veranderlijken: \(X_1, \ldots, X_n\)
\item
  Dit is noodzakelijk om te kunnen redeneren over hoe de resultaten van
  steekproef tot steekproef kunnen wijzigen
\item
  In een steekproef observeren we gerealiseerde uitkomsten
  \(x_1, x_2, \dots, x_n\): v.b. gender of lengte van subjecten in de
  steekproef.
\end{itemize}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(NHANES)}
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Gender)) }\SpecialCharTok{+} \FunctionTok{geom\_bar}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-13-1.pdf}}
...
\item
  We kunnen \(\pi\) schatten op basis van de steekproef door het
  steekproefgemiddelde te berekenen \(\bar x = \sum\limits_{i=1}^n x_i\)
\item
  Merk op dat het steekproefgemiddelde zelf een toevallig veranderlijke
  is! Het wijzigt ook van steekproef tot steekproef!
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{count}\NormalTok{(Gender) }\SpecialCharTok{|\textgreater{}}
...
\subsection{Empirische verdeling}\label{empirische-verdeling}

We kunnen de verdeling van de lengte voor volwassen vrouwen schatten aan
de hand van het histogram.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-15-1.pdf}}

We kunnen de cumulatieve distributie functie schatten door gebruik te
maken van de empirische cumulatieve distributie functie.
...
\item
  Dus empirische cumulatieve distributie functie van het staal is een
  discrete verdeling met probabiliteit 1/n op elke observatie.
\item
...
\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-16-1.pdf}}

We kunnen de empirische cumulatieve distributie functie gebruiken om
kansen te berekenen. Wat is de kans dat een vrouw kleiner is dan 150 cm.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ecdfFem }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(}\StringTok{"Height"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ecdf}\NormalTok{()}
\FunctionTok{ecdfFem}\NormalTok{(}\DecValTok{150}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{502}\NormalTok{)}
\NormalTok{fem10}\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{sample\_n}\NormalTok{(}\AttributeTok{size=}\DecValTok{10}\NormalTok{)}

\NormalTok{fem10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+}
  \FunctionTok{stat\_ecdf}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-18-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ecdfFem10 }\OtherTok{\textless{}{-}}\NormalTok{ fem10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(Height) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ecdf}\NormalTok{()}
\FunctionTok{ecdfFem10}\NormalTok{(}\DecValTok{150}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Merk op dat die kans niet goed wordt geschat o.b.v. de kleine
steekproef. Er zijn immers te weinig observaties om de kansen goed te
kunnen schatten.

Merk ook op dat we die kans ook hadden kunnen schatten door te berekenen
hoeveel lengtemetingen er lager zijn dan 150.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{count}\NormalTok{(Height }\SpecialCharTok{\textless{}=}\DecValTok{150}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
In de introductie zagen we dat de lengte metingen een mooie klokvorm
hadden. We kunnen dus aannemen dat de metingen approximatief normaal
verdeeld zijn. We zullen dat in hoofdstuk 4 Data Exploratie illustreren
a.d.h.v. diagnostische plots.

\begin{itemize}
\item
  We kunnen de verdeling van de lengte metingen ook benaderen d.m.v. een
  normale verdeling.
\item
  ...
  \item
    variantie via steekproefvariantie (\(\hat{\sigma}^2= s^2\)) of de
    standaardafwijking d.m.v. steekproef standaarddeviatie
    (\(\hat\sigma=s\)).
  \end{itemize}
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{HeightSum }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..)) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Lengte (cm)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun=}\NormalTok{dnorm,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{],}
      \AttributeTok{sd=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{sd[}\DecValTok{1}\NormalTok{]}
\NormalTok{      )}
\NormalTok{    )}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-23-1.pdf}}

We doen nu hetzelfde op basis van de steekproef met de 10 vrouwen.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{HeightSum10 }\OtherTok{\textless{}{-}}\NormalTok{ fem10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{mean=}\FunctionTok{mean}\NormalTok{(Height),}\AttributeTok{sd=}\FunctionTok{sd}\NormalTok{(Height))}
...
\NormalTok{fem10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{10}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Lengte (cm)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun=}\NormalTok{dnorm,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{],}
      \AttributeTok{sd=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{sd[}\DecValTok{1}\NormalTok{]}
\NormalTok{      )}
\NormalTok{    ) }\SpecialCharTok{+}
  \FunctionTok{xlim}\NormalTok{(}\DecValTok{130}\NormalTok{,}\DecValTok{190}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{02-Concepten_files/figure-pdf/unnamed-chunk-25-1.pdf}}

We kunnen de normale benadering nu ook gebruiken om de kans te berekenen
dat een vrouw kleiner is dan 150 cm: Pr(X \textless= 150).

We doen dit op basis van de volledige steekproef en vergelijken dit uit
wat we bekomen met de ECDF.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pnorm}\NormalTok{(}\DecValTok{150}\NormalTok{,HeightSum}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{],HeightSum}\SpecialCharTok{$}\NormalTok{sd[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pnorm}\NormalTok{(}\DecValTok{150}\NormalTok{,HeightSum10}\SpecialCharTok{$}\NormalTok{mean[}\DecValTok{1}\NormalTok{],HeightSum10}\SpecialCharTok{$}\NormalTok{sd[}\DecValTok{1}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
Voor kleine steekproef is geschatte kans o.b.v. empirische verdeling
...
Het bepalen van grenswaarden voor de lengte die vrij veel voorkomen
kunnen worden bekomen door gebruik te maken van een referentie interval.

Typisch wordt een 95\% referentie interval gebruikt zodat we voor 95\%
van de subjecten in de populatie verwachten dat ze een karakteristiek
hebben die in het referentie interval ligt.

We kunnen dat opnieuw op basis van de empirische verdeling.

\begin{itemize}
\item
  We moeten hiervoor \(\hat{F}(x_{2.5\%})=0.025\) en
  \(\hat{F}(x_{97.5\%})=0.975\) berekenen zodat 95\% van de observaties
  in de steekproef vallen in het interval \([x_{2.5\%},x_{97.5\%}]\).
\item
...
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(Height)}\SpecialCharTok{\&}\NormalTok{Age}\SpecialCharTok{\textgreater{}}\DecValTok{18}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(Height) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{quantile}\NormalTok{(}\AttributeTok{prob=}\FunctionTok{c}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\FloatTok{0.975}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Op basis van de grote steekproef schatten we dat 95\% van de vrouwen
  in de populatie een lengte heeft die ligt in het interval {[}147.6,
  176.7{]}.
\end{itemize}
...
\item
  We hebben immers niet voldoende observaties om een goede benadering te
  hebben voor extreme quantielen.
\end{itemize}

\subsubsection{Normale benadering}\label{normale-benadering-1}

We kunnen de functie qnorm gebruiken om quantielen te berekenen van de
normale verdeling. We weten dat een 95\% referentie interval ongeveer
binnen twee standaard deviaties rond het gemiddelde ligt.

We doen dit nu voor de - Grote steekproef

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\AttributeTok{mean=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{mean,}\AttributeTok{sd=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{sd)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{mean }\SpecialCharTok{{-}} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ HeightSum}\SpecialCharTok{$}\NormalTok{sd}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{mean=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{mean,}\AttributeTok{sd=}\NormalTok{HeightSum}\SpecialCharTok{$}\NormalTok{sd)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.025}\NormalTok{,}\AttributeTok{mean=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{mean,}\AttributeTok{sd=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{sd)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{mean=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{mean,}\AttributeTok{sd=}\NormalTok{HeightSum10}\SpecialCharTok{$}\NormalTok{sd)}
\end{Highlighting}
\end{Shaded}
...
We zien dat de benadering voor de kleine steekproef op basis van de
aanname van Normaliteit opnieuw goed werkt!

\subsection{Conclusies}\label{conclusies-1}

\begin{itemize}
\item
  Voor de grote steekproef geven de empirische verdeling en de normale
  benadering vergelijkbare resultaten.
\item
  Voor de kleine steekproef werkt de normale benadering beter dan de
  ...
  \item
    Er zijn inderdaad weinig gegevens in de steekproef die toelaten om
    deze quantielen direct te schatten.
  \item
    Met de normale benadering kunnen we alle data gebruiken om het
    gemiddelde en de standaarddeviatie te schatten.
  \item
    Als de aanname van normaliteit geldt dan krijgen we betere
    schattingen voor deze kwantielen.
  \end{itemize}
\end{itemize}
...
om \textbf{populatieparameters die een vaste waarde aannemen maar die
...
De cursus is als volgt georganiseerd: In hoofdstuk \ref{sec-chap-design}
verdiepen we ons in studiedesign. Vervolgens gaan we in op
data-exploratie in hoofdstuk \ref{sec-chap-describe}, hierbij zullen we
de gegevens in een steekproef grondig exploreren zodoende inzicht te
verwerven in de data en hoe we ze statistisch kunnen modelleren. In
hoofdstuk \ref{sec-chap-besluit} introduceren we de grondslagen van
...
toe. In hoofdstukken \ref{sec-chap-linReg}--Hoofdstuk~\ref{sec-chap-glm}
zullen we meer geavanceerde statistische modellen en methoden
introduceren om data te modelleren en voor statistische besluitvorming.
...
\chapter{Studiedesign}\label{sec-chap-design}

Alle kennisclips die in dit hoofdstuk zijn verwerkt kan je in deze
youtube playlist vinden:
\href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJL1GjhnpEDlx78OJ6qUzSix}{Kennisclips
Hoofdstuk3}

Link naar webpage/script die wordt gebruik in de kennisclips:
\href{https://statomics.github.io/sbc/rmd/03-experimentalDesign.html}{script
Hoofdstuk3}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{03-Proefopzet_files/figure-pdf/fig-pop2Samp2PopDesign-1.pdf}

}

\caption{\label{fig-pop2Samp2PopDesign}Verschillende stappen in een
studie. In dit hoofdstuk ligt de focus op proefopzet.}
...
Studiedesigns worden opgesplitst in \emph{experimentele studies of
...
Een \textbf{experiment} is een reeks observaties die gemaakt worden
onder condities die gecontroleerd worden door de onderzoeker. De
onderzoeker controleert hierbij verschillende factoren (zoals de keuze
van de interventie voor een locatie, plant, dier), met als doel een
zuiver antwoord op de gestelde onderzoeksvraag te bepalen. \footnote{Met
  ``zuiver'' wordt hier bedoeld dat het zuivere interventie-effect uit
  de gegevens kan gehaald worden zonder dat het antwoord wordt beïnvloed
  door andere aspecten/variabelen.}
...
vertekend\footnote{ Voorlopig verstaan we onder het feit dat een
  ...
  zuivere effect van de behandeling weerspiegelt.} is door vergelijkbare
groepen dieren te creëren; bijvoorbeeld, door lukraak (bijvoorbeeld door
...
laboratorium na te gaan. Meer concreet wenste men na te gaan wat de
invloed was van vaccinatie op de polio-incidentie.

\begin{definition}[incidentie en
prevalentie]\protect\hypertarget{def-incidentie-en-prevalentie}{}\label{def-incidentie-en-prevalentie}

~

\end{definition}

De \textbf{incidentie} van een bepaalde ziekte of aandoening (bvb.
polio) wordt gedefinieerd als het verwachte aantal nieuwe gevallen van
die ziekte dat optreedt gedurende een vooraf bepaald tijdsinterval,
uitgedrukt per eenheid van een ziektevrije populatie. Het drukt m.a.w.
de kans uit dat een individu zonder de bestudeerde aandoening tijdens
het gegeven tijdsinterval deze aandoening zal opdoen.
...
kinderen bestond. Ongeveer 725000 kinderen uit de eerste en derde graad
...
\item
  ...
  polio ontwikkelen. In Hoofdstuk \ref{sec-chap-besluit} zullen we
  methoden aanleren om uit te maken of een geobserveerd
  vaccinatie-effect (d.w.z. een vaccinatie-effect dat geschat of
  berekend werd o.b.v. de gegevens) al dan niet toevallig is.
\item
...
\begin{example}[De nood aan
controle]\protect\hypertarget{exm-de-nood-aan-controle}{}\label{exm-de-nood-aan-controle}

~

\end{example}

Hairston (1980) bestudeerde de stelling dat 2 soorten salamander (P.
jordani en P. glutinosus) in de Great Smoky Mountains mekaar
rivaliseren. Hij zette daartoe experimenten op waarbij P. glutinosus
verwijderd werd van bepaalde territoria. De populatie van P. jordani
begon toe te nemen in de 3 jaren die volgden op de verwijdering van de
salamanders, maar nam al even sterk toe op controleterritoria waar P.
glutinosus niet verwijderd was. Had Hairston geen controleterritoria
onderzocht, dan had hij mogelijks de toename in de populatie van P.
jordani verkeerdelijk toegeschreven aan het verwijderen van P.
glutinosus.

\textbf{Einde voorbeeld}

\begin{definition}[confounding en
confounder]\protect\hypertarget{def-confounding-en-confounder}{}\label{def-confounding-en-confounder}

~

\end{definition}

\textbf{Confounding} is het probleem dat verschillen ten gevolge van
verschillende experimentele interventies niet kunnen losgekoppeld worden
van andere factoren, \textbf{confounders} genoemd, die verschillen
tussen de interventiegroepen. Een confounder manifesteert zich als een
variabele die geassocieerd is met de blootstelling of interventie (bvb.
...
\begin{example}[Confounding in mariene
veldexperimenten]\protect\hypertarget{exm-confounding-in-mariene-veldexperimenten}{}\label{exm-confounding-in-mariene-veldexperimenten}

~

\end{example}

Om het effect te onderzoeken van roofvissen op mariene zeebodemhabitats
zou men gebieden met en zonder viskooien kunnen vergelijken. Als men
vervolgens verschillen observeert tussen beide types gebieden, dan kan
dat het gevolg zijn van het verwijderen van roofvissen (via de kooien),
maar eveneens van de aanwezigheid van kooien (bijvoorbeeld, door schaduw
die de kooi afwerpt, door de afgenomen waterstroming, \ldots). Het
effect van roofvissen verwijderen wordt dus mogelijks verward met het
effect van kooien plaatsen. De aanwezigheid van kooien manifesteert zich
hier dus als een confounder. Om dergelijke confounding te vermijden, kan
men controlekooien met grote gaten plaatsen waar de vis vrij in en uit
kan zwemmen, maar die voor de rest vergelijkbaar zijn met de
experimentele kooien. In dat geval zijn beide studiegebieden van kooien
voorzien en zal een vergelijking van experimentele en controlekooien
duidelijk een veel meer betrouwbare evaluatie toelaten van het effect
van roofvissen. Toch blijft dergelijke vergelijking niet gegarandeerd
vrij van confounding. Bijvoorbeeld, als het effect van kooien plaatsen
er voornamelijk in bestaat om de stroming van water (en bijgevolg
sedimentatie) te beïnvloeden, dan speelt de vraag of de stroming van
water ook niet beïnvloed wordt door het feit dat vissen, omwille van de
grote gaten, makkelijker in controlekooien zwemmen dan in experimentele
kooien.
...
\begin{definition}[gerandomiseerde
studie]\protect\hypertarget{def-gerandomiseerde-studie}{}\label{def-gerandomiseerde-studie}

~

\end{definition}

Een \textbf{gerandomiseerd gecontroleerde} studie is een experiment
waarbij de toewijzing van subjecten aan de verschillende
interventie-armen volledig lukraak gebeurt zodat de toewijzing van een
gegeven subject onmogelijk op voorhand voorspeld kan worden. Als gevolg
hiervan zijn de verschillende interventiegroepen (in
principe\footnote{We beklemtonen dat dit \emph{in principe} zo is, omdat
  er binnen een beperkt experiment (d.w.z met een relatief klein aantal
  proefpersonen/proefdieren) uiteraard toevallige verschillen tussen
  beide groepen kunnen ontstaan; we komen hier later op terug.}) in alle
gekende en ongekende factoren (zoals leeftijd, lichaamsgewicht,
vatbaarheid voor polio \ldots) vergelijkbaar zodat geobserveerde
verschillen in uitkomst tussen de verschillende groepen (in principe)
kunnen toegeschreven worden aan de interventie (d.i. het vaccin).
...
\caption{\label{tbl-nfipStudy}}

\centering{

\caption{\label{tab:tbl-nfipStudy}De NFIP studie: aantal kinderen en incidentie (uitgedrukt per
...
Tabellen \ref{tbl-nfipStudy} en \ref{tbl-dbrcStudy} geven de resultaten
...
\ref{tbl-dbrcStudy} stellen we vast dat de incidentie daalt van 71 tot
...
als gevolg van het vaccin (zie Tabel \ref{tbl-nfipStudy}). De oorzaak is
dat de controlegroep in deze studie kinderen bevat die minder vatbaar
zijn voor polio dan de vaccin-groep.

\begin{table}

\caption{\label{tbl-dbrcStudy}}

\centering{

\caption{\label{tab:tbl-dbrcStudy}De gerandomiseerd gecontroleerde studie: aantal kinderen en incidentie (uitgedrukt per
100000 kinderen per jaar).}
\centering
\begin{tabular}[t]{lrr}
\toprule
...
\subsection{Gerandomiseerde gecontroleerde
studies}\label{gerandomiseerde-gecontroleerde-studies}
...
\begin{definition}[systematische
allocatie]\protect\hypertarget{def-systematische-allocatie}{}\label{def-systematische-allocatie}
...
\emph{(in het Engels: haphazard allocation)} is een toewijzingsmethode
die mogelijks op een lukraak mechanisme lijkt, maar waarbij men de
toewijzing van (sommige) subjecten op voorhand kan voorspellen.
...
vervolg]\protect\hypertarget{exm-confounding-in-mariene-veldexperimenten-vervolg}{}\label{exm-confounding-in-mariene-veldexperimenten-vervolg}

~

\end{example}

Beschouw opnieuw het experiment naar het effect van roofvissen op
zeebodemhabitats. Stel dat we 12 lukrake gebieden op de zeebodem
gemarkeerd hebben en vervolgens wensen te beslissen waar we de
experimentele kooien (die effectief vis vasthouden) en de controlekooien
zullen plaatsen. Dan zouden we de kooien kunnen randomiseren door op
elke plaats een muntje op te gooien en vervolgens een experimentele kooi
te plaatsen wanneer men kop gooit en een controlekooi anders. Die
procedure is erop gericht te garanderen dat experimentele kooien op
vergelijkbare plaatsen opgesteld worden als controlekooien. Om te
vermijden dat er, per toeval, meer controlekooien dan experimentele
kooien geplaatst worden, kunnen we een gebalanceerde randomisatie
uitvoeren met blokken van grootte 2. Hoe men dit kan uitvoeren, ligt
echter minder voor de hand. Eén mogelijkheid kan erin bestaan om de
verschillende gebieden willekeurig te nummeren en die nummers lukraak
dooreen te gooien teneinde een nieuwe nummering te bekomen die
gegarandeerd lukraak is. Vervolgens kan men in volgorde van de bekomen
nummering blokken van grootte 2 randomiseren om zelfde aantallen
experimentele kooien en controlekooien te bekomen.
...
\begin{definition}[gestratificeerde
randomisatie]\protect\hypertarget{def-gestratificeerde-randomisatie}{}\label{def-gestratificeerde-randomisatie}
...
uitgevoerd per groep subjecten met gelijkaardige prognostische
factoren\footnote{Een \emph{prognostische factor} is een variabele die
  sterk geassocieerd is met de bestudeerde uitkomst. Bijvoorbeeld, roken
  is een prognostische factor voor longkanker omdat het risico op
  longkanker sterk verschilt tussen rokers en niet-rokers.} (bvb.
afzonderlijk op plaatsen dicht versus ver van de kust). Ze wordt
gebruikt om te voorkomen dat die prognostische factoren door toeval niet
gelijk verdeeld zouden zijn over de verschillende interventiegroepen en
als gevolg daarvan, net zoals confounders, een storende invloed zouden
...
subjecten dat het interventie-effect moeilijk op te pikken is tussen de
vele ruis op de gegevens. Als de gegevens veel minder variabel zijn per
blok, laat het randomiseren van de interventie per blok immers toe om
het interventie-effect per blok te evalueren met veel minder
ruis\footnote{In Hoofdstuk \ref{sec-chap-besluit} zullen we uitleggen
  hoe men dit kan realiseren via een gepaarde analyse van de gegevens}.
In de biologische wetenschappen stellen blokken vaak experimentele
subjecten voor die gelijkaardig zijn in tijd of ruimte, hoewel men ook
organismen van dezelfde leeftijd, grootte, \ldots{} kan beschouwen.

Blok designs worden in de levenswetenschappen ook vaak gebruikt om op
een efficiënte manier om te gaan met de ruis die wordt veroorzaakt door
...
celculturen) en zal men de behandelingen randomiseren binnen elk blok
zodat de interventie-effecten opnieuw met veel minder ruis kunnen worden
geschat.

\begin{example}[Oxidatieve stress in
Arabidopsis]\protect\hypertarget{exm-oxidatieve-stress-in-arabidopsis}{}\label{exm-oxidatieve-stress-in-arabidopsis}

~

\end{example}

\citet{Jacques2015} onderzochten de impact van oxidatieve stress op het
proteome in \emph{Arabidopsis thaliana}. Hierbij bestudeerden ze het
proteoom (alle proteïnen) in catalase knock-out en wild type A. thaliana
planten. De planten werden gedurende 5 weken opgegroeid in een
groeikamer. Vervolgens werd het proteoom bepaald na een controle
behandeling, na 1 uur hoge lichtbehandeling of na 3 uur hoge
lichtbehandeling. Het experiment werd op drie verschillende tijdstippen
herhaald. Op elk tijdstip werden 6 proteomen geëxtraheerd: 1 proteoom
voor elke combinatie van genotype x behandeling. Bijgevolg is dit een
randomized complete block design met tijdstip als block.

\textbf{Einde voorbeeld}

\begin{example}[Effect van
bladschade]\protect\hypertarget{exm-effect-van-bladschade}{}\label{exm-effect-van-bladschade}

~

\end{example}

Microbe-specifieke molecules (MSM) kunnen door het immuunsysteem van
planten worden herkend en een defensieve response induceren die ze
resistent maakt tegen bepaalde ziektes. \citet{Valdes2014} bestudeerde
het effect van MSM op de genexpressie van Soja in een RNA-seq
studie\footnote{gen-expressie studie waarbij gen-expressie gemeten wordt
  met next-generation sequencing technologie}. De planten werden
opgegroeid in 12 potten. Elke pot bevatte vijf verschillende planten. Na
3 weken werden alle bladeren geoogst per pot. De bladeren afkomstig van
elke pot werden in twee gesneden. De ene helft werd behandeld met een
controle, de andere helft met MSMs en vervolgens werd het RNA
geëxtraheerd. Om voldoende RNA te bekomen werden alle bladhelften
afkomstig van dezelfde behandeling en dezelfde pot gebruikt per extract.
Het experiment is dus een gerandomiseerd compleet blok design met pot
als block.
...
\begin{example}[Kiezelwieren en zware
metalen]\protect\hypertarget{exm-kiezelwieren-en-zware-metalen}{}\label{exm-kiezelwieren-en-zware-metalen}
...
een aantal fysicochemische variabelen (pH, opgeloste zuurstof, \ldots),
de zinkconcentratie en variabelen die de kiezelwieren beschrijven (mate
van voorkomen, diversiteit, \ldots). De primaire onderzoeksvraag was of
de diversiteit van kiezelwieren gelijk was in 4 groepen met
verschillende concentraties zink: \(<20 \mu\)g/l, \(21-50 \mu\)g/l,
\(51-200 \mu\)g/l en \(>200 \mu\)g/l.
...
\begin{example}[Competitie tussen species lage
begroeiing]\protect\hypertarget{exm-competitie-tussen-species-lage-begroeiing}{}\label{exm-competitie-tussen-species-lage-begroeiing}
...
begroeiing in Centraal-Amerikaanse wouden. Ze voerden een experiment uit
om de effecten van 4 interventies (relatieve dichtheid van 1 species,
Besleria of Palicourea, en een tweede species Cephaelia was 10:10
(A)\footnote{Dus 10\% van het gebied wordt uitgemaakt door de ene
...
planten) nodig zijn dan in een parallel design om even
precies\footnote{Wat we concreet bedoelen met het feit dat er minder
  proefsubjecten nodig zijn om het effect met een gegeven precisie in te
  schatten. Voorlopig volstaat de intuïtieve betekenis van deze zin.}
het interventie-effect te kunnen schatten. Bovendien laat dit design toe
om confounding te vermijden in situaties waar replicatie moeilijk is,
zoals volgend voorbeeld illustreert.

\begin{example}[Effect van koper op neerstrijken van
larven]\protect\hypertarget{exm-effect-van-koper-op-neerstrijken-van-larven}{}\label{exm-effect-van-koper-op-neerstrijken-van-larven}
...
\begin{definition}[interactie of
effect-modificatie]\protect\hypertarget{def-interactie-of-effect-modificatie}{}\label{def-interactie-of-effect-modificatie}

~

\end{definition}

Een \textbf{interactie} tussen 2 interventies drukt uit dat een
combinatie van 2 interventies een effect heeft dat groter of kleiner is
dan de som van de effecten van de afzonderlijke interventies (op een
zekere schaal).

\textbf{Einde definitie}

\begin{example}[Grootte van
salamanderlarven]\protect\hypertarget{exm-grootte-van-salamanderlarven}{}\label{exm-grootte-van-salamanderlarven}
...
\begin{example}[Groei van esdoorn versus
beuk]\protect\hypertarget{exm-groei-van-esdoorn-versus-beuk}{}\label{exm-groei-van-esdoorn-versus-beuk}
...
\begin{example}[Gezondheidscampagne in
Wales]\protect\hypertarget{exm-gezondheidscampagne-in-wales}{}\label{exm-gezondheidscampagne-in-wales}
...
en zonder P. glutinosus te corrigeren voor de confounder voedselrijkdom,
...
effect van P. glutinosus op de groei van P. jordani \emph{gecontroleerd}
(in het Engels: \emph{adjusted} of \emph{controlled}) werd voor de
voedselrijkdom van het studiegebied.

\begin{example}[Simpson's
paradox]\protect\hypertarget{exm-simpson-s-paradox}{}\label{exm-simpson-s-paradox}
...
Tabel \ref{tbl-sexbias} getabuleerd (resultaten voor de andere
...
richtingen C en E waar de jongens het lichtjes beter doen. Dit lijkt
...
Tabel \ref{tbl-sexbias} hebben jongens meer de neiging om
...
\ref{tbl-sexbias} levert een analyse op die gecontroleerd is voor de
...
\caption{\label{tbl-sexbias}}

\centering{

\caption{\label{tab:tbl-sexbias}Resultaten van de toelatingsexamens volgens geslacht en studierichting.}
\centering
...
\begin{example}[Confounders in de NHANES
studie]\protect\hypertarget{exm-confounders-in-de-nhanes-studie}{}\label{exm-confounders-in-de-nhanes-studie}
...
\begin{example}[Observationele versus gerandomiseerde
studies]\protect\hypertarget{exm-observationele-versus-gerandomiseerde-studies}{}\label{exm-observationele-versus-gerandomiseerde-studies}
...
\section{Prospectieve studies}\label{sec-design-prosp}
...
\begin{example}[Vruchtbaarheid van
schelpdieren]\protect\hypertarget{exm-vruchtbaarheid-van-schelpdieren}{}\label{exm-vruchtbaarheid-van-schelpdieren}
...
\section{Retrospectieve studies}\label{sec-design-retro}
...
\begin{example}[Genetische
associatiestudies]\protect\hypertarget{exm-brcaLeu}{}\label{exm-brcaLeu}
...
Tabel \ref{tbl-leu}. We stellen vast dat 89 van de 800 cases het allel
...
\(89/145=61.4\%\) aan borstkanker lijdt, dit cijfer niet veralgemeenbaar
...
\caption{\label{tbl-leu}}

\centering{

\caption{\label{tab:tbl-leu}Kruistabel van borstkanker-status versus BRCA1-allel.}
\centering
...
\subsection{Pre-test/Post-test studies}\label{sec-prepost}
...
statistiek}\label{sec-chap-describe}

Alle kennisclips die in dit hoofdstuk zijn verwerkt kan je in deze
youtube playlist vinden:
\href{https://www.youtube.com/watch?v=AVd-8WE_DhU&list=PLZH1hP8_LbJLKTeg_D9CHC3xbk0nfBa-1}{Kennisclips
Hoofdstuk4}

Link naar webpage/script die wordt gebruik in de kennisclips:
\href{https://statomics.github.io/sbc/rmd/04-dataExploration.html}{script
Hoofdstuk4}
...
gegevens verzameld werden in de studie de bekomen gegevens neer te
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-pop2Samp2PopDataExpl-1.pdf}

}

\caption{\label{fig-pop2Samp2PopDataExpl}Verschillende stappen in een
studie. In dit hoofdstuk ligt de focus op de data-exploratie en
...
\begin{example}[NHANES
studie]\protect\hypertarget{exm-nhanesEx}{}\label{exm-nhanesEx}
...
van de gegevens die werden verzameld tussen 2009-2012 bij 10000
Amerikanen en die werden opgenomen in het R-pakket NHANES. Er werd een
groot aantal fysieke, demografische, nutritionele, levensstijl en
gezondheidskarakteristieken gecollecteerd in deze studie (zie Tabel
\ref{tbl-nhanesDatExpl}). Merk op dat ontbrekende waarnemingen hier
gecodeerd worden a.d.h.v. de code \texttt{NA} (Not Available / Missing
Value)
...
\caption{\label{tbl-nhanesDatExpl}}

\centering{

\caption{\label{tab:tbl-nhanesDatExpl}Overzicht van een aantal variabelen uit de NHANES studie.}
\centering
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#De data van de NHANES studie bevindt zich}
\CommentTok{\#in het R package NHANES}
\FunctionTok{library}\NormalTok{(NHANES) }\CommentTok{\#laad NHANES package}

\CommentTok{\#NHANES is een data frame met de gegevens}
\CommentTok{\#De rijen bevatten informatie over elk subject}
\CommentTok{\#De kolommen de variabelen die werden geregistreerd}
\CommentTok{\#vb variabele Gender, BMI, ...}
\CommentTok{\#Een variabele (kolom) kan uit de dataframe}
\CommentTok{\#worden gehaald door gebruik van het $ teken}
\CommentTok{\#en de naam van de variabele}
\CommentTok{\# We slaan de frequentietabel voor variable Gender}
\CommentTok{\# op in object \textquotesingle{}tab\textquotesingle{}}

\NormalTok{tab }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{Gender)}
\NormalTok{tab}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  \texttt{geom\_bar}. We definiëren de kleur via het argument
  \texttt{fill}
\end{enumerate}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
We stellen vast dat 5020 van de 10000 subjecten, ofwel 50.2\% vrouwen in
de studie zijn opgenomen.
...
dataset. De staven staan los van elkaar met een breedte die constant is,
maar verder willekeurig. Als de steekproef representatief is voor de
populatie, dan krijgen we hier misschien een eerste impressie dat er
iets meer vrouwen zijn in de populatie.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{stem}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{BMI)}
\end{Highlighting}
\end{Shaded}
...
\emph{histogram}, hetgeen men in \texttt{ggplot} bekomt via
...
\item
  Selecteer de variable BMI als de data om in de x-coordinaat te
  visualiseren voor het aestetics argument van ggplot gebruik hiervoor
  de \texttt{aes} functie
\item
  Voeg een laag toe voor het histogram. Wanneer je geen aestetics
  \texttt{aes} meegeeft verkrijg je standaard absolute frequenties. Met
  \texttt{fill=..counts..} in de aestetics kan je de balken van het
  histogram inkleuren a.d.h.v. de absolute frequenties.
\item
  Indien je het wenst kan je op een histogram met densities ook nog een
  laag toevoegen met een niet parametrische densiteitsschatter voor de
  verdeling d.m.v. de \texttt{geom\_density} functie.
\end{enumerate}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-histo-1.pdf}

}

\caption{\label{fig-histo}Histogram van het BMI in de NHANES studie.}
...
Een histogram is vooral geschikt om de distributie te schatten in grote
datasets. Daar kan men dan veel intervallen gebruiken. Daarom heeft de
ggplot functie standaard 30 intervallen.
...
gevonden wordt. Figuur \ref{fig-histo} toont een histogram met kernel
density schatter van de het BMI.
...
\begin{definition}[percentiel]\protect\hypertarget{def-percentiel}{}\label{def-percentiel}
...
reeks waarnemingen wordt gedefinieerd als een uitkomstwaarde \(x_{25}\)
zodat minstens \(25\%\) van die waarnemingen kleiner of gelijk zijn aan
\(x_{25}\) en minstens \(75\%\) van die waarnemingen groter of gelijk
zijn aan \(x_{25}\). Het \emph{75\% percentiel} of \emph{75\% kwantiel}
van een reeks waarnemingen definieert men als een uitkomstwaarde
\(x_{75}\) zodat minstens 75\% kleiner of gelijk zijn aan \(x_{75}\) en
minstens \(25\%\) van die waarnemingen groter of gelijk zijn aan
\(x_{75}\). Algemeen wordt het \emph{\(k\%\) percentiel} van een reeks
waarnemingen gedefinieerd als een waarde (van \(x\)) waarvoor de
cumulatieve frequentie gelijk is aan \(k/100.\) Als er meerdere
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{quantile}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{BMI,}\FunctionTok{c}\NormalTok{(}\FloatTok{0.25}\NormalTok{,.}\DecValTok{5}\NormalTok{,.}\DecValTok{75}\NormalTok{),}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-boxBMI-1.pdf}

}

\caption{\label{fig-boxBMI}Boxplot van BMI in de NHANES studie.}
...
\begin{Highlighting}[]
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\StringTok{""}\NormalTok{,}\AttributeTok{y=}\NormalTok{BMI)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\begin{definition}[rekenkundig
gemiddelde]\protect\hypertarget{def-rekenkundig-gemiddelde}{}\label{def-rekenkundig-gemiddelde}

~

\end{definition}

Het \textbf{(rekenkundig) gemiddelde} \(\overline{x}\) (spreek uit:
\emph{x-streep} of \emph{x-bar}) van een reeks waarnemingen
...
Merk op dat het rekenkundig gemiddelde ook verkregen zou worden als
gemiddelde voor een discrete distributie met kansen van 1/n op elke
waarde uit de steekproef. Wanneer we het steekproefgemiddelde gebruiken
dan schatten we de distributie in de populatie als het ware aan de hand
van de empirische distributie van de data. We maken dus geen
distributionele veronderstellingen hiervoor.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#opnieuw is de na.rm statement hier nodig}
\CommentTok{\#omdat ontbrekende waarden voorkomen.}
\end{Highlighting}
\end{Shaded}

\emph{Indien men de grootste observatie (81.25) vervangt door 8125 om
als het ware een tikfout voor te stellen, dan wijzigt het rekenkundig
...
\begin{definition}[mediaan]\protect\hypertarget{def-mediaan}{}\label{def-mediaan}
...
kwantiel} \(x_{50}\) van een reeks waarnemingen
\(x_i, i=1, 2, \dots, n\) is per definitie een uitkomstwaarde \(x_{50}\)
zodat minstens \(50\%\) van die waarnemingen groter of gelijk zijn aan
\(x_{50}\) en minstens \(50\%\) van die waarnemingen kleiner of gelijk
zijn aan \(x_{50}\).
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{median}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{BMI,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Merk op dat we hier gebruik maken van het argument na.rm=TRUE}
\CommentTok{\#Dit komt omdat we niet beschikken over het BMI}
\CommentTok{\#voor elke persoon: ontbrekende waarnemingen}
\CommentTok{\#Die worden in R als een NA voorgesteld}
\CommentTok{\#Als we het argument na.rm=TRUE gebruiken wordt}
\CommentTok{\#de mediaan berekend op basis van de beschikbare observaties}
\end{Highlighting}
\end{Shaded}

Indien men de grootste observatie (81.25) vervangt door 8125, dan
wijzigt de mediaan niet. Merk ook op dat de mediaan lager is dan het
gemiddelde, hij is minder gevoelig voor de outliers in de dataset.

\begin{definition}[modus]\protect\hypertarget{def-modus}{}\label{def-modus}
...
\begin{definition}[scheve
verdeling]\protect\hypertarget{def-scheve-verdeling}{}\label{def-scheve-verdeling}
...
waarden rechts van de mediaan verder uitlopen dan links, dan is de
verdeling \emph{scheef naar rechts} (in het Engels: \emph{positively
skew}) en is het gemiddelde (meestal) groter dan de mediaan. Als de
waarden links van de mediaan verder uitlopen dan rechts, dan is de
verdeling \emph{scheef naar links} (in het Engels: \emph{negatively
skew}) en is het gemiddelde (meestal) kleiner dan de mediaan.
...
\begin{definition}[geometrisch
gemiddelde]\protect\hypertarget{def-geometrisch-gemiddelde}{}\label{def-geometrisch-gemiddelde}

~

\end{definition}

Het \textbf{geometrische gemiddelde} van een reeks waarnemingen
\(x_i, i=1,
2, \dots, n\) ontstaat door er de natuurlijke logaritme van te
berekenen, het gemiddelde hiervan te nemen en dit vervolgens terug te
transformeren naar de originele schaal door er de exponentiële functie
van te nemen:
...
\item
  Is het rekenkundig gemiddelde van log-transformeerde data
  \(\rightarrow\) klassieke statistische methoden kunnen direct worden
  gebruikt, b.v. hypothese testen en betrouwbaarheidsintervallen (zie
  hoofdstuk 5)
\item
  Veel biologische en chemische variabelen zoals concentraties,
  intensiteiten, etc kunnen niet negatief zijn.
\item
  Verschillen op log schaal hebben de betekenis van een
  \texttt{log\ fold\ change}:
\end{enumerate}
...
\item
  Een verschil van 1 op \(\log_2\) schaal betekent een verdubbeling op
  de originele schaal \(FC=2\).
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{logSummary }\OtherTok{\textless{}{-}}
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize}\NormalTok{(}
    \AttributeTok{logMean =} \FunctionTok{mean}\NormalTok{(BMI }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{(),}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
    \AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(BMI }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{(),}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
...
\NormalTok{    ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{geoMean=}\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{logMean)}

\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{BMI }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}
    \AttributeTok{bins=}\DecValTok{30}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}\AttributeTok{fun=}\NormalTok{dnorm,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{logSummary}\SpecialCharTok{$}\NormalTok{logMean,}
      \AttributeTok{sd=}\NormalTok{logSummary}\SpecialCharTok{$}\NormalTok{sd)}
\NormalTok{    )}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-histLogBMI-1.pdf}

}

\caption{\label{fig-histLogBMI}Boxplot van BMI en log(BMI) in de NHANES
studie.}
...
\begin{example}[BMI]\protect\hypertarget{exm-bmi}{}\label{exm-bmi}

~

\end{example}

Het gemiddelde en mediane BMI bedraagt 26.66 en 25.98 , respectievelijk.
Het gemiddelde is hier groter dan de mediaan omdat de BMI scheef
verdeeld is naar rechts (zie Figuur \ref{fig-histLogBMI}). De verdeling
wordt meer symmetrisch na log-transformatie. Het gemiddelde en mediane
log-BMI liggen ook dichter bij elkaar en bedragen respectievelijk 3.25
en 3.26. De geometrische gemiddelde BMI-concentratie bekomen we door de
exponentiële functie te evalueren in 3.25, hetgeen ons 25.69 oplevert.
Merk op dat dit inderdaad beter met de mediaan overeenstemt dan het
...
\subsection{Spreidingsmaten}\label{sec-spreiding}
...
onderscheid in Hoofdstuk \ref{sec-chap-linReg} rond lineaire regressie.
...
\begin{definition}[variantie]\protect\hypertarget{def-variantie}{}\label{def-variantie}

~

\end{definition}

De \textbf{variantie} een reeks waarnemingen \(x_i, i=1, 2, \dots, n\)
is per definitie
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Het gebruik van functie sd() levert de standarddeviatie}
\CommentTok{\# van de variabele BMI in de NHANES dataset.}
\CommentTok{\# Het na.rm=TRUE argument wordt gebruikt omdat er}
\CommentTok{\# ontbrekende waarnemingen voorkomen.}
\FunctionTok{sd}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{BMI,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{var}\NormalTok{(NHANES}\SpecialCharTok{$}\NormalTok{BMI,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{definition}[bereik en
interkwartielafstand]\protect\hypertarget{def-bereik-en-interkwartielafstand}{}\label{def-bereik-en-interkwartielafstand}

~

\end{definition}

Het \textbf{bereik} of de \textbf{range} \(R_x\) van een reeks
waarnemingen \(x_i, i=1,2,...,n\), is per definitie het verschil tussen
de grootste en kleinste geobserveerde waarde. De
\textbf{interkwartielafstand} van een reeks waarnemingen
\(x_i, i=1,2,...,n\) is per definitie de afstand tussen het derde
kwartiel \(x_{75}\) en het eerste kwartiel \(x_{25}\). Dat wordt ook
grafisch weergegeven op een boxplot (breedte van de box). Hierbinnen
liggen circa 50\% van de observaties. Circa 95\% van de observaties kan
men vinden tussen het 2.5\% en 97.5\% percentiel.
...
heeft van de Normale verdeling. Dat is bijvoorbeeld zo als men een
...
belang omdat heel wat technieken uit de verdere hoofdstukken er zullen
van uit gaan dat de gegevens Normaal verdeeld zijn. Hoewel een
...
rechte te zien. Systematische afwijkingen van een rechte wijzen op
systematische afwijkingen van Normaliteit. Lukrake afwijkingen van een
rechte kunnen het gevolg zijn van toevallige biologische variatie en
zijn daarom niet indicatief voor afwijkingen van Normaliteit.

Om inzicht te krijgen in QQ-plots simuleren we eerst data uit de normale
verdeling om te zien hoe deze plots eruit zien als de data normaal
verdeeld zijn.

\begin{itemize}
\tightlist
\item
  We simuleren data voor 9 steekproeven met een gemiddeld van 18 en een
  standaard afwijking van 9.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{20}
\NormalTok{mu }\OtherTok{\textless{}{-}} \DecValTok{18}
\NormalTok{sigma }\OtherTok{\textless{}{-}} \DecValTok{9}
\NormalTok{nSamp }\OtherTok{\textless{}{-}}\DecValTok{9}

\NormalTok{normSim }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(n}\SpecialCharTok{*}\NormalTok{nSamp,}\AttributeTok{mean=}\NormalTok{mu,}\AttributeTok{sd=}\NormalTok{sigma),}\AttributeTok{nrow=}\NormalTok{n) }\SpecialCharTok{|\textgreater{}} \FunctionTok{as.data.frame}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\def\labelenumi{\arabic{enumi}.}
\item
  We converteren het in het tidy formaat via de \texttt{gather} functie.
  Hierbij wordt een eerste kolom gemaakt samp die de kolomnamen van de
  originele dataset normSim voor elk overeenkomstig gesimuleerd data
  punt bij zal houden. De inhoud van de kolommen van de originele
  dataset normSim, de gesimuleerde waarden, worden opgeslagen in de
  variable met naam data.
\item
  we maken een ggplot histogram voor de variabele data
\item
  Aan de hand van de functie \texttt{facet\_wrap} kunnen we de data
  opsplitsen volgens de variabele samp. We krijgen dus een histogram
  voor elk sample.
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{normSim }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(samp,data) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{data)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{30}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density..)) }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{samp)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-11-1.pdf}}

Gezien er vrij weinig data punten zijn en omdat er veel distributies
vergeleken moeten worden is het handiger om dit via een boxplot te doen.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{normSim }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(samp,data) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ samp,}\AttributeTok{y =}\NormalTok{ data)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position=}\StringTok{"jitter"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-12-1.pdf}}

Hoewel alle observaties in alle steekproeven uit dezelfde populatie zijn
getrokken zien we toch vrij grote fluctuaties van steekproef tot
steekproef in de mediaan, maar zeker ook in de boxgrootte en het bereik
van de data in elke steekproef. Dus ondanks het feit dat we over een
vrij grote steekproef beschikken (20 observaties) is er toch een grote
...
\item
  Voeg een laag toe met de rechte in de QQ-plot via de functie
  \texttt{geom\_qq\_line} om te kunnen evalueren hoe goed de data een
...
\NormalTok{normSim }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(samp,data) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{data)) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-13-1.pdf}}

Zelf voor Normal data zien we duidelijk nog afwijkingen door sampling
variabiliteit! De plots laten ons toe om ons visueel te trainen om
QQ-plots van Normale data te herkennen.

Om de interpretatie van de QQ-plot goed te kunnen illustreren gaan we
een histogram en QQ-plot naast elkaar zetten. D.m.v. het package
\texttt{gridExtra} kunnen we meerdere GG-plot objecten in een matrix op
dezelfde plot afbeelden.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  We maken een eerste object aan met het histogram. We slaan dit nu op
  als object p1 in plaats van dit te visualiseren.
\item
  Maak een object p2 met de QQ-plot
\item
  Gebruik de functie \texttt{grid.arrange} om de objecten p1 en p2 af te
  beelden en we geven aan dat we dit in 2 kolommen zullen doen
  \texttt{ncol=2}. (je kan ook de dimensie in rijen geven (nrow=1))
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(gridExtra)}
\NormalTok{p1 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(BMI)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{BMI))}\SpecialCharTok{+}
   \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..)) }\SpecialCharTok{+}
   \FunctionTok{xlab}\NormalTok{(}\StringTok{"BMI"}\NormalTok{) }\SpecialCharTok{+}
   \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"All females in study"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density..))}

\NormalTok{p2 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(BMI)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{BMI)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-14-1.pdf}}

The QQ-plot toont dat de kwantielen van de data in de steekproef

\begin{itemize}
\item
  groter zijn (boven de lijn liggen) dan wat we verwachten voor Normaal
  verdeelde data in de linkerstaart: compressie van de linkerstaart
  t.o.v. de Normale verdeling. De waarden in de linkerstaart liggen dus
  dichter bij top van de distributie dan wat we verwachten voor normaal
  verdeelde data.
\item
  groter zijn (boven de lijn liggen) dan wat we verwachten voor Normaal
  verdeelde data: lange staart naar rechts. De waarden in de
  rechterstaart liggen dus verder van de top van de distributie dan wat
  we verwachten voor normaal verdeelde data.
\end{itemize}
...
\begin{example}[Houtluizen]\protect\hypertarget{exm-houtluizen}{}\label{exm-houtluizen}
...
Tabel \ref{tbl-cox} toont de bekomen gegevens. Hier stelt \(a\) (\(c\))
...
\caption{\label{tbl-cox}}

\centering{

\caption{\label{tab:tbl-cox}Kruistabel van species houtluis versus type grond.}
\centering
...
\begin{definition}[absolute risico
verschil]\protect\hypertarget{def-absolute-risico-verschil}{}\label{def-absolute-risico-verschil}

~

\end{definition}

Het \textbf{absolute risico verschil} of absolute kansverschil op een
...
ARV genoteerd en gedefinieerd als het verschil
...
\begin{definition}[relatief
risico]\protect\hypertarget{def-relatief-risico}{}\label{def-relatief-risico}

~

\end{definition}

Het \textbf{relatief risico} op een gegeven gebeurtenis (bvb. om
Armadilidium aan te treffen) voor populatie T (Test, bvb. kleigrond)
versus C (Controle, bvb. kalkgrond) wordt met RR genoteerd en
...
\subsection{Retrospectieve studies}\label{sec-retrospect}

Beschouw de case-controle studie uit Voorbeeld \ref{exm-brcaLeu},
waarvan de gegevens samengevat zijn in Tabel \ref{tbl-leu2}. Omdat men
...
\caption{\label{tbl-leu2}}

\centering{

\caption{\label{tab:tbl-leu2}Kruistabel van borstkanker-status versus BRCA1-allel.}
\centering
\begin{tabular}[t]{llll}
\toprule
Genotype & Controles & Cases & Totaal\\
...
bijgevolg \((89/800)/(56/572)=1.14\). Vrouwen met borstkanker hebben dus
14\% meer kans om de allelcombinatie Leu/Leu te hebben op het BRCA1 gen
dan vrouwen zonder borstkanker. Dit suggereert dat er een
associatie\footnote{Al is het nog de vraag of die associatie toevallig
  is, dan wel systematisch. We komen in het hoofdstuk
  \ref{sec-chap-categorisch}. terug op technieken om dit te onderzoeken.}
is tussen het polymorfisme op het BRCA1 gen en borstkanker, maar drukt
...
De \textbf{odds ratio} op een gegeven gebeurtenis (bvb. borstkanker)
voor populatie T (bvb. vrouwen met allel Leu/Leu) versus C (bvb. vrouwen
zonder allel Leu/Leu) wordt met OR genoteerd en gedefinieerd als het
quotiënt \begin{equation*}
OR=\frac{\mbox{odds}_T}{\mbox{odds}_C}
\end{equation*} van de odds op deze gebeurtenis in populaties T en C.

\textbf{Einde definitie}

Op basis van de gegevens in Tabel \ref{tbl-leu2} kan de odds ratio op
...
variabelen}\label{sec-kruistabel}
...
\caption{\label{tbl-genderBMI}}

\centering{

\caption{\label{tab:tbl-genderBMI}Kruistabel van Gender vs BMI klasse.}
\centering
\begin{tabular}[t]{lrrrr}
\toprule
...
Tabel \ref{tbl-genderBMI} toont zo'n kruistabel voor het aantal mannen
...
variabele}\label{sec-asskwalcont}

Boxplots zijn meer compact dan een histogram en laat om die reden
gemakkelijker vergelijkingen tussen verschillende groepen toe. Twee
dergelijke boxplots worden getoond in Figuur
\ref{fig-boxplotCholGender}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Gender,}\AttributeTok{y =} \FunctionTok{log}\NormalTok{(DirectChol))) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"log(Direct Cholestorol)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-boxplotCholGender-1.pdf}

}

\caption{\label{fig-boxplotCholGender}Boxplot van log-getransformeerde
directe HDL cholestorol concentratie in functie van Gender voor alle
subjecten van de NHANES studie.}
...
in Hoofdstuk \ref{sec-chap-besluit} dieper op deze vraag ingaan.
...
\(\log(C_2)-\log(C_1)=\log(C_2/C_1)\) weten we dat de HDL cholestorol
concentratie in de NHANES studie gemiddeld 1.19 keer hoger ligt voor
vrouwen dan voor mannen.

In de introductie hebben we bij het microbiome voorbeeld gezien dat het
ook erg nuttig is om de ruwe data weer te geven op de boxplot. Als het
aantal gegevens niet te hoog is kunnen we eenvoudig een extra laag
toevoegen met de originele datapunten. Merk op dat het wel belangrijk is
om de outliers dan niet weer te geven in de boxplot, anders zal men deze
twee keer afbeelden. Eens in de geom\_boxplot laag een eens in de
geom\_point laag. Daarom zetten we het symbool voor de outliers op NA.

In onderstaande grafiek plotten we de relatieve abundanties van
\textbf{Staphylococcus} van de oksel microbiome case study.
...
\item
  ...
  \texttt{ggplot(aes(x=trt,y=rel))}
\item
  We voegen laag toe voor de boxplot dmv de functie
  \texttt{geom\_boxplot()}. Merk op dat we het argument
  \texttt{outlier.shape} op NA (not available) zetten
  \texttt{outlier.shape=NA} in the \texttt{geom\_boxplot} functie omdat
  we anders outliers twee keer weer zullen geven. Eerst via de boxplot
  laag en daarna omdat we een laag met alle ruwe data toevoegen aan de
  plot.
\item
  We geven de ruwe data weer via de
  \texttt{geom\_point(position="jitter")} functie. We gebruiken hierbij
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ap }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/GTPB/PSLS20/master/data/armpit.csv"}\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-15-1.pdf}}
...
dataset vormt van Hoofdstuk \ref{sec-chap-besluit}. In de studie wenst
men het effect van een bloeddrukverlagend geneesmiddel captopril
evalueren. Voor elke patiënt in de studie werd de systolische bloeddruk
twee keer gemeten: één keer voor en één keer na de behandeling met het
bloeddruk verlagende medicijn captopril. In Figuur \ref{fig-captoDot}
worden de metingen van dezelfde patiënt met een lijntje verbonden.
Hierdoor krijgen we een heel duidelijk beeld van de gegevens. Namelijk,
we krijgen een sterke indruk dat de bloeddruk daalt na het toedienen van
captopril gezien we bijna voor alle patiënten een daling observeren.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Eerst lezen we de data in.}
\CommentTok{\#Deze bevindt zich in de subdirectory dataset}
\CommentTok{\#Het is een tekstbestand waarbij de kolommen van elkaar gescheiden zijn d.m.v comma\textquotesingle{}s.}
\CommentTok{\#sep=","}
\CommentTok{\#De eerste rij bevat de namen van de variabelen}
\NormalTok{captopril }\OtherTok{\textless{}{-}} \FunctionTok{read.table}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/captopril.txt"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{sep=}\StringTok{","}\NormalTok{)}
\FunctionTok{head}\NormalTok{(captopril)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{captoprilTidy }\OtherTok{\textless{}{-}}
\NormalTok{  captopril }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(type,bp,}\SpecialCharTok{{-}}\NormalTok{id)}

\NormalTok{captoprilTidy }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(type}\SpecialCharTok{\%in\%}\FunctionTok{c}\NormalTok{(}\StringTok{"SBPa"}\NormalTok{,}\StringTok{"SBPb"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type =} \FunctionTok{factor}\NormalTok{(}
\NormalTok{    type,}
    \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"SBPb"}\NormalTok{,}\StringTok{"SBPa"}\NormalTok{))}
\NormalTok{    ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{type,}\AttributeTok{y=}\NormalTok{bp)) }\SpecialCharTok{+}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-captoDot-1.pdf}

}

\caption{\label{fig-captoDot}Dotplot van de systolische bloeddruk in de
captopril studie voor en na het toedienen van het bloeddruk verlagend
middel captopril.}

\end{figure}%

\section{Associatie tussen twee continue
variabelen}\label{sec-correlatie}

We zullen dit opnieuw illustreren aan de hand van de NHANES studie. We
bestuderen hierbij lengte en gewicht bij vrouwen.
...
\item
  In het ggplot commando de lengte selecteren in de x-as en het gewicht
  in de y-as.
\item
  Een laag toevoegen d.m.v. \texttt{geom\_point} om een scatterplot te
  bekomen van y i.f.v. x.
\end{enumerate}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES}\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-16-1.pdf}}

Er is een duidelijke associatie tussen gewicht en lengte: als de lengte
stijgt dan stijgt het gewicht gemiddeld ook. Er is echter veel
variabiliteit en ook een indicatie dat het gewicht is scheef verdeeld
naar rechts.
...
op als een object en maken we gebruik van de \texttt{grid.arrange}
functie van het gridExtra package om de plots naast elkaar te plotten.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..)) }\SpecialCharTok{+}
   \FunctionTok{xlab}\NormalTok{(}\StringTok{"Height"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"All females in study"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density..))}

\NormalTok{p2 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-17-1.pdf}}

De lengte data zijn duidelijk approximatief normaal verdeeld.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p3 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{p4 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{Weight)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{()}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-18-1.pdf}}

De gewichtsdata zijn inderdaad scheef verdeeld!

Na log transformatie zijn de gewichtsdata minder scheef, maar nog steeds
niet Normaal verdeeld.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p5 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Weight}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..)) }\SpecialCharTok{+}
   \FunctionTok{xlab}\NormalTok{(}\StringTok{"Weight (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"All females in study"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_density}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density..))}

\NormalTok{p6}\OtherTok{\textless{}{-}}\NormalTok{ NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{Weight}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{()}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-19-1.pdf}}

De scheefheid is er nog maar is sterk gereduceerd. We maken nu een plot
van lengte in functie van het log\(_2\) getransformeerde gewicht.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES}\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Height,}\AttributeTok{y=}\NormalTok{Weight }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Weight (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-20-1.pdf}}

We introduceren nu een statistiek om de associatie te schatten: de
correlatie.
...
\item
  Covariantie: hoe variëren \(X_i\) en \(Y_i\) rond hun gemiddelde
  \((E[X],E[Y])\)?
\end{itemize}
...
\tightlist
\item
  De covariantie is dus de verwachte waarde van het product van de
  afwijking van de X waarde t.o.v. zijn verwachte waarde E{[}X{]} en de
  afwijking van de Y waarde t.o.v.zijn verwachte waarde E{[}Y{]}.
\end{itemize}

We kunnen de covariantie nu ook standardiseren zodat we een maat krijgen
die voor elke dataset vergelijkbaar wordt: de correlatie. We doen dit
door de covariantie te delen door de standaardafwijking van elke
variabele:
...
We introduceren nu een schatter voor de correlatie tussen twee continue
toevallig veranderlijken op basis van de data in de steekproef:

\[
\mbox{Cor}(X,Y)=\frac{\sum_{i=1}^{n}(x_{i}-\bar{x})(y_{i}-\bar{y})}{(n-1)s_{x}s_{y}}
\]

We vervangen de verwachte waarden weer door het steekproefgemiddelden
\(\bar x\) en \(\bar y\), en, we berekenen het gemiddeld product van de
afwijkingen in x en y in de steekproef. Let op dat we hierbij weer
corrigeren voor het aantal vrijheidsgraden. We geven elke observatie
geen gewicht van 1/n maar van 1/(n-1). We hebben inderdaad het
gemiddelde geschat, hier is dat gemiddelde bivariaat (het heeft een x en
y coordinaat).

Deze schatter wordt ook wel de Pearson correlatie genoemd en heeft
volgende eigenschappen:

\begin{itemize}
\item
  Er is een positieve correlatie wanneer \(y\) gemiddeld toeneemt bij
  een toename van: \(x \ \nearrow \ \Rightarrow \ y \ \nearrow\)
\item
  Er is een negatieve correlatie als \(y\) gemiddeld afneemt bij een
  toename in \(x\): \(x \ \nearrow \ \Rightarrow \ y \ \searrow\)
\item
  De correlatie ligt ook altijd tussen -1 en 1
\end{itemize}

In de figuur \ref{fig-bijdrageCor} wordt de bijdrage weergegeven van
individuele metingen in de correlatie. Als punten in het 1ste en 3de
kwadrant liggen is er een positieve bijdrage van de observatie in de
correlatie, als ze in het 2de en 4de kwadrant liggen is er een negatieve
bijdrage.
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-bijdrageCor-1.pdf}}

}

\caption{\label{fig-bijdrageCor}Bijdrage van individuele metingen in de
correlatie.}

\end{figure}%

We berekenen vervolgens de correlatie voor lengte, gewicht en het log
getransformeerde gewicht.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NHANES}\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Age }\SpecialCharTok{\textgreater{}=} \DecValTok{18} \SpecialCharTok{\&}\NormalTok{ Gender}\SpecialCharTok{==}\StringTok{"female"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{select}\NormalTok{(Weight,Height) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{log2Weight=}\NormalTok{Weight}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{na.exclude}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
...
\item
  Gebruik de Pearson correlatie niet voor scheef verdeelde data of data
  met outliers!
\end{itemize}

\subsubsection{Impact van outliers}\label{impact-van-outliers}

In figuur \ref{fig-corOutlier} wordt de impact van outliers op de
Pearson correlatie geïllustreerd d.m.v. gesimuleerde data met één
outlier. We zien dat de correlatie bijna halveert ten gevolge van de
outlier!
...
\NormalTok{simData }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{x}\SpecialCharTok{*}\DecValTok{2} \SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(}\FunctionTok{length}\NormalTok{(x)))}
\NormalTok{p1 }\OtherTok{\textless{}{-}}\NormalTok{ simData }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"cor ="}\NormalTok{,}\FunctionTok{cor}\NormalTok{(simData[,}\DecValTok{1}\NormalTok{],simData[,}\DecValTok{2}\NormalTok{]) }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{2}\NormalTok{)))}

\NormalTok{outlier}\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(simData,}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\SpecialCharTok{{-}}\DecValTok{4}\NormalTok{))}
\NormalTok{p2 }\OtherTok{\textless{}{-}}\NormalTok{ outlier }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"cor ="}\NormalTok{,}\FunctionTok{cor}\NormalTok{(outlier[,}\DecValTok{1}\NormalTok{],outlier[,}\DecValTok{2}\NormalTok{]) }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{2}\NormalTok{)))}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-corOutlier-1.pdf}}

}

\caption{\label{fig-corOutlier}Correlatie van gesimuleerde data met 1
outlier}

\end{figure}%

\subsubsection{De Pearson correlatie pikt enkel linear associatie
op}\label{de-pearson-correlatie-pikt-enkel-linear-associatie-op}

In figuur \ref{fig-corQuad} simuleren we data met een kwadratisch
verband en observeren we dat de correlatie bijna nul is!

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{100}\NormalTok{)}
\NormalTok{quadratic }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{x}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{+} \FunctionTok{rnorm}\NormalTok{(}\FunctionTok{length}\NormalTok{(x)))}
\NormalTok{quadratic }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"cor ="}\NormalTok{,}\FunctionTok{cor}\NormalTok{(quadratic[,}\DecValTok{1}\NormalTok{],quadratic[,}\DecValTok{2}\NormalTok{]) }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{2}\NormalTok{))) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(quadratic[,}\DecValTok{2}\NormalTok{]),}\AttributeTok{col=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FunctionTok{mean}\NormalTok{(quadratic[,}\DecValTok{1}\NormalTok{]),}\AttributeTok{col=}\StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/fig-corQuad-1.pdf}}

}

\caption{\label{fig-corQuad}Correlatie van gesimuleerde data met een
kwadratisch verband. De data in de bovenste kwadranten compenseren
elkaar als het ware alsook in de onderste kwadranten (ongeveer evenveel
positieve en negatieve bijdragen door de data in de correlatie)}

\end{figure}%

\subsection{Verschillende groottes van
correlatie}\label{verschillende-groottes-van-correlatie}

Om een inzicht te krijgen in de grootte van de correlatie, simuleren we
data met een verschillende correlatie. We geven telkens de correlatie
weer boven de plot. Hoe sterker de correlatie hoe meer de puntenwolk
naar een lineair verband toegaat.

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-22-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{04-DataExploratie_files/figure-pdf/unnamed-chunk-22-2.pdf}}

\subsection{Spearman correlatie}\label{spearman-correlatie}

De Spearman correlatie is de Pearson correlatie na transformatie van de
data naar ranks. Hierdoor wordt deze schatter minder gevoelig voor
outliers.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(outlier)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(outlier,}\AttributeTok{method=}\StringTok{"spearman"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
We verifiëren dat de Spearman correlatie de Pearson correlatie is van
rang getransformeerde data. Die wordt bekomen door de observaties te
ordenen van klein naar groot en elke observatie te vervangen door zijn
rangorde.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rankData}\OtherTok{\textless{}{-}}\FunctionTok{apply}\NormalTok{(outlier,}\DecValTok{2}\NormalTok{,rank)}
\FunctionTok{cor}\NormalTok{(rankData)}
\end{Highlighting}
\end{Shaded}
...
We berekenen nu de Spearman correlatie in de NHANES studie. We
observeren dat de correlatie tussen lengte en gewicht, en lengte en log2
getransformeerd gewicht exact gelijk is. Dat is logisch want de
log-transformatie is een monotone transformatie en verandert de ordening
van de data dus niet, de ranks van gewicht en deze van het log gewicht
zijn identiek!
...
\NormalTok{NHANES}\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{log2Weight=}\NormalTok{Weight}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{na.exclude}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{cor}\NormalTok{(}\AttributeTok{method=}\StringTok{"spearman"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  vorm van de verdeling. Wanneer de 2 variabelen die we onderzoeken niet
  Normaal verdeeld zijn, dan zijn er 2 mogelijkheden om een zinvolle
  correlatiecoëfficiënt weer te geven. Variabelen die scheef verdeeld
  zijn, kan men transformeren (bvb. een log-transformatie) in de hoop
  dat de getransformeerde gegevens bij benadering Normaal verdeeld zijn
  en lineair samenhangen.
\item
  Merk op dat een correlatiecoëfficiënt van 0 tussen 2 variabelen \(X\)
  en \(Y\) niet noodzakelijk impliceert dat deze variabelen
  onafhankelijk zijn. Zie kwadratisch verband! Daarom is het van belang
  om de aard van samenhang tussen 2 variabelen steeds te onderzoeken via
  een scatterplot alvorens een correlatiecoëfficiënt te rapporteren.
  Wanneer het verband monotoon is, maar sterk niet-lineair is, dan is
  het aangewezen om niet de Pearson correlatiecoëfficiënt, maar
  Spearman's correlatiecoëfficiënt te rapporteren. Indien het verband
  niet-monotoon is, dan zijn correlatiecoëfficiënten niet geschikt en
  moet men overstappen op meer geavanceerde regressietechnieken.
\item
  ...
  de gegevens worden gestaafd. Volgend voorbeeld illustreert dit. Denk
  hierbij aan het voorbeeld van de associatie van groente consumptie en
  covid mortaliteit.
\item
  ...
  incidenties, \ldots) die reeds berekend werden voor groepen subjecten.
  Dit is het geval bij het covid voorbeeld uit de introductie waarbij
  men mortaliteit modellereert in functie van de gemiddelde dagelijkse
  groenteconsumptie per capita in verschillende landen. Wanneer men
  aldus een \emph{ecologische correlatie} vaststelt voor groepen
  subjecten of individuen (in dit geval,landen), impliceert dat niet
  noodzakelijk dat deze correlatie ook voor de subjecten zelf
  opgaat\footnote{In het Engels is dit welbekend onder de naam
    \emph{`ecological fallacy'}.}. Volgend voorbeeld illustreert dit.
\end{enumerate}

\begin{example}[Ecological
fallacy]\protect\hypertarget{exm-ecological-fallacy}{}\label{exm-ecological-fallacy}
...
\section{Clips over de code in dit
hoofdstuk}\label{clips-over-de-code-in-dit-hoofdstuk}
...
\chapter{Statistische besluitvorming}\label{sec-chap-besluit}
...
\begin{itemize}
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJKyD9Jw5cqd-btYs11f9tkz}{Kennisclips
  Hoofdstuk5 Puntschatters en Intervalschatters}
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJKEtDy2errIWf8hLJODw-jK}{Kennisclips
  Hoofdstuk5 Hypothesetoetsen}
\end{itemize}
...
\begin{itemize}
\item
  \href{https://statomics.github.io/sbc/rmd/05-statisticalInference.html}{script
  Hoofdstuk5}
\item
  \href{https://statomics.github.io/sbc/rmd/05-statisticalInference-twosampleT.html}{script
  Hoofdstuk5: Two-sample t-test}
\end{itemize}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoPop2Samp2Pop-1.pdf}

}

\caption{\label{fig-captoPop2Samp2Pop}Verschillende stappen in de
captopril studie.}
...
pre-test/post-test design. De patiënten werden at random gekozen uit de
populatie. Van elke patiënt in de studie werd de systolische en
...
waardoor we een mogelijke bloeddrukverlaging niet noodzakelijkerwijs
...
tekstbestand met naam \texttt{captopril.txt} op de github pagina
\url{https://raw.githubusercontent.com/statOmics/sbc/master/data/captopril.txt}.
...
\CommentTok{\#Eerst lezen we de data in.}
\CommentTok{\#Deze bevindt zich in de subdirectory dataset}
\CommentTok{\#Het is een tekstbestand waarbij de kolommen van elkaar gescheiden zijn d.m.v kommas.}
\CommentTok{\#sep=","}
\CommentTok{\#De eerste rij bevat de namen van de variabelen}
\NormalTok{captopril }\OtherTok{\textless{}{-}} \FunctionTok{read.table}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/captopril.txt"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{,}\AttributeTok{sep=}\StringTok{","}\NormalTok{)}
\FunctionTok{head}\NormalTok{(captopril)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{captoprilTidy }\OtherTok{\textless{}{-}}\NormalTok{ captopril }\SpecialCharTok{|\textgreater{}} \FunctionTok{gather}\NormalTok{(type,bp,}\SpecialCharTok{{-}}\NormalTok{id)}
\NormalTok{captoprilTidy }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(type) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"bp"}\NormalTok{,}\FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{mean}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{sd=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{sd}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{n=}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(x)))) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{captoprilTidy }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"bp"}\NormalTok{,}\FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{mean}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{sd=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{sd}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{n=}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(x)))) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{se=}\NormalTok{sd}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{type,}\AttributeTok{y=}\NormalTok{mean)) }\SpecialCharTok{+}
  \FunctionTok{geom\_bar}\NormalTok{(}\AttributeTok{stat=}\StringTok{"identity"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin=}\NormalTok{mean}\SpecialCharTok{{-}}\NormalTok{se, }\AttributeTok{ymax=}\NormalTok{mean}\SpecialCharTok{+}\NormalTok{se),}\AttributeTok{width=}\NormalTok{.}\DecValTok{2}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{210}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"blood pressure (mmHg)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoBar-1.pdf}

}

\caption{\label{fig-captoBar}Barplot van de gemiddelde bloeddruk in de
captopril studie. De foutenvlag is 2x de standaard deviatie op de
metingen (SBPb: systolic BloodPressure before, DBPb: Diasystolic
BloodPressure before, SBPa: systolic BloodPressure after, DBPa:
Diasystolic BloodPressure after).}
...
\NormalTok{captoprilTidy }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position=}\StringTok{"jitter"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{210}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoBox-1.pdf}

}

\caption{\label{fig-captoBox}Boxplot en ruwe data van de bloeddruk in de
captopril studie (SBPb: systolic BloodPressure before, DBPb: Diasystolic
BloodPressure before, SBPa: systolic BloodPressure after, DBPa:
Diasystolic BloodPressure after).}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#De geom\_line layer laat ons de bloeddrukmetingen voor dezelfde personen verbinden met een lijn}
\NormalTok{captoprilTidy }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(type}\SpecialCharTok{\%in\%}\FunctionTok{c}\NormalTok{(}\StringTok{"SBPa"}\NormalTok{,}\StringTok{"SBPb"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type=}\FunctionTok{factor}\NormalTok{(type,}\AttributeTok{levels=}\FunctionTok{c}\NormalTok{(}\StringTok{"SBPb"}\NormalTok{,}\StringTok{"SBPa"}\NormalTok{))) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{type,}\AttributeTok{y=}\NormalTok{bp)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =}\NormalTok{ id)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoDotBsl-1.pdf}

}

\caption{\label{fig-captoDotBsl}Dotplot van de systolische bloeddruk in
de captopril studie voor en na het toedienen van captopril.}
...
\CommentTok{\#uit de dataset via naam van variabele d.m.v. ${-}teken}
\CommentTok{\#en berekenen het verschil}
\NormalTok{delta }\OtherTok{\textless{}{-}}\NormalTok{ captopril}\SpecialCharTok{$}\NormalTok{SBPa}\SpecialCharTok{{-}}\NormalTok{captopril}\SpecialCharTok{$}\NormalTok{SBPb}
\NormalTok{captopril}\SpecialCharTok{$}\NormalTok{deltaSBP }\OtherTok{\textless{}{-}}\NormalTok{ delta}
\NormalTok{captopril }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\StringTok{"Systolic blood pressure"}\NormalTok{,}\AttributeTok{y=}\NormalTok{deltaSBP)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position=}\StringTok{"jitter"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Difference (mm mercury)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoBoxDelta-1.pdf}

}

\caption{\label{fig-captoBoxDelta}Boxplot van het verschil in
systolische bloeddruk voor en na het toedienen van captopril.}
...
\begin{Highlighting}[]
\NormalTok{captopril }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"deltaSBP"}\NormalTok{,}\FunctionTok{list}\NormalTok{(}\AttributeTok{mean=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{mean}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
              \AttributeTok{sd=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{sd}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
              \AttributeTok{n=}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(x)))) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{se=}\NormalTok{sd}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n))}
\end{Highlighting}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoBoxDiffQQ-1.pdf}

}

\caption{\label{fig-captoBoxDiffQQ}QQ-plot voor het verschil in
systolische bloeddruk voor en na het toedienen van captopril.}
...
(m.a.w. het hangt af van het design van de studie).
...
\begin{definition}[Onvertekende
schatter]\protect\hypertarget{def-onvertekende-schatter}{}\label{def-onvertekende-schatter}

~

\end{definition}

Een statistiek of schatter \(S\) voor een parameter \(\theta\) wordt
\textbf{onvertekend} genoemd als haar theoretische verwachtingswaarde
gelijk is aan die parameter, d.w.z. \(E(S)= \theta\).
...
\tightlist
\item
  We zullen 15 vrouwen willekeurig selecteren uit de NHANES studie en
  zullen hun cholesterolgehalte registreren.
\item
  We herhalen dit 50 keer om de variatie van steekproef tot steekproef
  te beoordelen
\item
  We plotten de boxplot voor iedere steekproef en duiden het gemiddelde
  aan.
\end{itemize}
...
\NormalTok{fem }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"} \SpecialCharTok{\&} \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(DirectChol)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{select}\NormalTok{(}\StringTok{"DirectChol"}\NormalTok{)}

\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{15} \CommentTok{\# number of subjects per sample}
\NormalTok{nSim }\OtherTok{\textless{}{-}} \DecValTok{50} \CommentTok{\# number of simulations}

\NormalTok{femSamp }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\AttributeTok{nrow=}\NormalTok{n,}\AttributeTok{ncol=}\NormalTok{nSim)}
\ControlFlowTok{for}\NormalTok{ (j }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{nSim)}
\NormalTok{\{}
\NormalTok{  femSamp[,j] }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol,}\DecValTok{15}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{ (j}\SpecialCharTok{\textless{}}\DecValTok{4}\NormalTok{) \{}
\NormalTok{    p }\OtherTok{\textless{}{-}}\NormalTok{ femSamp }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{gather}\NormalTok{(}\StringTok{"sample"}\NormalTok{,}\StringTok{"log2cholesterol"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{sample,}\AttributeTok{y=}\NormalTok{log2cholesterol)) }\SpecialCharTok{+}
      \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
      ...
      \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
      \FunctionTok{ylab}\NormalTok{(}\StringTok{"cholesterol (log2)"}\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-2-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-2-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-2-3.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{femSamp }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(}\StringTok{"sample"}\NormalTok{,}\StringTok{"log2cholesterol"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{sample,}\AttributeTok{y=}\NormalTok{log2cholesterol)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_summary}\NormalTok{(}\AttributeTok{fun.y=}\NormalTok{mean, }\AttributeTok{geom=}\StringTok{"point"}\NormalTok{, }\AttributeTok{shape=}\DecValTok{19}\NormalTok{, }\AttributeTok{size=}\DecValTok{3}\NormalTok{, }\AttributeTok{color=}\StringTok{"red"}\NormalTok{, }\AttributeTok{fill=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"cholesterol (log2)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-2-4.pdf}}

We observeren dat het steekproefgemiddelde fluctueert rond het
...
Om inzicht te krijgen in de variabiliteit op \(\bar X\) op basis van een
enkele steekproef zullen we assumpties moeten maken:

We zullen ervan uitgaan dat de metingen \(X_1, X_2, ..., X_n\) werden
gemaakt bij \(n\) \emph{onafhankelijke} observationele eenheden. In
woorden betekent onafhankelijkheid dat elk subject een volledig nieuw
stukje informatie bijdraagt tot het geheel. Een voorbeeld van
afhankelijkheid tussen studie-objecten komt klassiek uit de studie van
kankerverwekkende stoffen. Bij testen op zwangere ratten, worden
metingen gedaan op hun levende foetussen of boorlingen. Foetussen van
eenzelfde moeder delen dezelfde genetische achtergrond en zijn daarom
waarschijnlijk meer aan elkaar gelijk dan foetussen van verschillende
moeders. Zelfs al zijn de moeders die opgenomen worden in zo'n studie
onafhankelijk van elkaar gekozen, de verschillende kleine ratjes leveren
niet langer onafhankelijke stukjes informatie: via de gedeelde moeders
is een afhankelijkheid ingebouwd.
...
\tightlist
\item
  Bloeddrukmetingen voor (\(Y_{i,before}\)) en na (\(Y_{i,after}\))
  toediening van captopril aan dezelfde patiënt \(i=1,\ldots,n\).
\item
  We hebben ze omgezet in n onafhankelijke metingen door het verschil
  \(Y_{i,na}-Y_{i,voor}\) te nemen.
\end{itemize}

De volgende eigenschap illustreert de noodzaak om over onafhankelijke
gegevens te beschikken, wil men gemakkelijk de variabiliteit van het
steekproefgemiddelde kunnen bepalen.
...
\subsubsection{\texorpdfstring{Variantie schatter voor
\(\bar X\)}{Variantie schatter voor \textbackslash bar X}}\label{variantie-schatter-voor-bar-x}
...
\begin{definition}[Standaard
error]\protect\hypertarget{def-standaard-error}{}\label{def-standaard-error}

~

\end{definition}

De standaarddeviatie van \(\bar{X}\) is \(\sigma/\sqrt{n}\) en krijgt in
de literatuur de speciale naam \{standard error\} van het gemiddelde.
Algemeen noemt men de standaarddeviatie van een schatter voor een
bepaalde parameter \(\theta\), de \textbf{standard error} van die
schatter. Men noteert dit als \(SE\).

\textbf{Einde definitie}

\begin{example}[Gemiddelde
bloeddrukverandering]\protect\hypertarget{exm-gemiddelde-bloeddrukverandering}{}\label{exm-gemiddelde-bloeddrukverandering}

~

\end{example}

Stel dat we \(n = 15\) systolische bloeddrukobservaties zullen meten en
dat de standaarddeviatie van de bloeddrukverschillen in de populatie
\(\sigma = 9.0\) mmHg bedraagt, dan is standard error (SE) van de
systolische bloeddrukveranderingen \(\bar X\):
...
\NormalTok{se }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(delta)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)}
\NormalTok{se}
\end{Highlighting}
\end{Shaded}
...
\item
  Neem 1000 steekproeven per steekproef grootte van de NHANES studie,
  voor iedere steekproef berekenen we:
  ...
  \end{itemize}
\item
  We maken een boxplot van de steekproefstandaardevaties en de standaard
  errors voor de verschillende steekproefgroottes
\item
  In plaats van een for loop te gebruiken zullen we de sapply functie
  gebruiken die efficiënter is. Het neemt een vector of lijst als invoer
  en past de functie toe op ieder element van de vector of lijst.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{24}\NormalTok{)}
\NormalTok{femSamp10 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}
  \DecValTok{1}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(j,x,size) }\FunctionTok{sample}\NormalTok{(x,size),}
  \AttributeTok{size=}\DecValTok{10}\NormalTok{,}
  \AttributeTok{x=}\NormalTok{fem}\SpecialCharTok{$}\NormalTok{DirectChol)}

\NormalTok{femSamp50 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}
  \DecValTok{1}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(j,x,size) }\FunctionTok{sample}\NormalTok{(x,size),}
  \AttributeTok{size=}\DecValTok{50}\NormalTok{,}
  \AttributeTok{x=}\NormalTok{fem}\SpecialCharTok{$}\NormalTok{DirectChol)}

\NormalTok{femSamp100 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}
  \DecValTok{1}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(j,x,size) }\FunctionTok{sample}\NormalTok{(x,size),}
...
\NormalTok{  femSamp10 }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}}
    \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{gather}\NormalTok{(sample,log2Chol) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{group\_by}\NormalTok{(sample)}\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"log2Chol"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{median=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{median}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{mean=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{mean}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{sd=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{sd}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    \AttributeTok{n=}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(x)))) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{se=}\NormalTok{sd}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)) ,}
\NormalTok{  femSamp50 }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}  
    \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{gather}\NormalTok{(sample,log2Chol) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{group\_by}\NormalTok{(sample)}\SpecialCharTok{|\textgreater{}}
    \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"log2Chol"}\NormalTok{,}
               \FunctionTok{list}\NormalTok{(}\AttributeTok{median=}\SpecialCharTok{\textasciitilde{}}\FunctionTok{median}\NormalTok{(.,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{),}
                    ...
                    \AttributeTok{n=}\ControlFlowTok{function}\NormalTok{(x) }\FunctionTok{sum}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(x)))) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{se=}\NormalTok{sd}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)),}
\NormalTok{  femSamp100 }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{gather}\NormalTok{(sample,log2Chol) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{group\_by}\NormalTok{(sample)}\SpecialCharTok{|\textgreater{}}
...
We illustreren de impact van steekproefgrootte op de distributie van de
gemiddeldes van verschillende steekproeven

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{ n }\SpecialCharTok{|\textgreater{}} \FunctionTok{as.factor}\NormalTok{(),}\AttributeTok{y =}\NormalTok{ mean)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Direct cholesterol (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"sample size"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-5-1.pdf}}

\begin{itemize}
\tightlist
\item
  Merk op dat de variatie van de steekproefgemiddelden inderdaad afneemt
  naarmate de steekproefgrootte toeneemt. De schatting wordt dus
  nauwkeuriger naarmate de steekproefgrootte toeneemt.
\end{itemize}

\textbf{Standard deviatie}

We illustreren nu de impact van de steekproefgrootte op de verdeling van
de standaarddeviatie van de verschillende steekproeven

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{n}\SpecialCharTok{|\textgreater{}}\FunctionTok{as.factor}\NormalTok{(),}\AttributeTok{y=}\NormalTok{sd)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"standard deviation"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"sample size"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-6-1.pdf}}

\begin{itemize}
\item
  De standaarddeviatie blijft vergelijkbaar voor de steekproefgroottes.
  Het is gecentreerd rond dezelfde waarde: de standaarddeviatie in de
  populatie. Het vergroten van de steekproefgrootte heeft inderdaad geen
  invloed op de variabiliteit in de populatie!
\item
  Opnieuw zien we dat de variabiliteit van de standaarddeviatie afneemt
  naarmate de steekproefgrootte toeneemt. De standaarddeviatie kan dus
  ook nauwkeuriger worden geschat naarmate de steekproefgrootte
  toeneemt.
\end{itemize}

\textbf{Standaard error van het gemiddelde}

Ten slotte illustreren we de impact van de steekproefgrootte op de
verdeling van de standaarddeviatie van het gemiddelde van de
verschillende steekproeven, de standaard error.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{n}\SpecialCharTok{|\textgreater{}}\FunctionTok{as.factor}\NormalTok{(),}\AttributeTok{y=}\NormalTok{se)) }\SpecialCharTok{+}
\FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-7-1.pdf}}

\begin{itemize}
\tightlist
\item
  De standaard error (de schatter voor de nauwkeurigheid van het
  steekproefgemiddelde) vermindert aanzienlijk naarmate de
  steekproefgrootte toeneemt, wat opnieuw bevestigt dat de schatting van
  het steekproefgemiddelde nauwkeuriger wordt.
\end{itemize}
...
\tightlist
\item
  We illustreren dit voor herhaalde steekproeven met steekproefgrootte
  10
\end{itemize}
...
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{select}\NormalTok{(mean,median) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(type,estimate) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ type,}\AttributeTok{y =}\NormalTok{ estimate)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"10 personen"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-8-1.pdf}}

Vervolgens vergelijken we de verdeling van het gemiddelde en de mediaan
in herhaalde steekproeven van steekproefgrootte 50.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(n }\SpecialCharTok{==} \DecValTok{50}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{select}\NormalTok{(mean, median) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(type, estimate) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ type,}\AttributeTok{y =}\NormalTok{ estimate)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"50 personen"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-9-1.pdf}}

\subsection{Verdeling van het
steekproefgemiddelde}\label{sec-verdelingXbar}
...
met gemiddelde \(\mu\) en variantie \(\sigma^2/n.\)

\subsubsection{NHANES: cholesterol}\label{nhanes-cholesterol}

We illustreren dit nogmaals met een simulatie gebruik makende van de
NHANES-studie. De log2-cholesterolwaarden zijn normaal verdeeld.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ fem }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()))}\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density.., }\AttributeTok{fill =}\NormalTok{ ..count..)) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Direct cholesterol (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun =}\NormalTok{ dnorm,}
    \AttributeTok{color =} \StringTok{"red"}\NormalTok{,}
    \AttributeTok{args =} \FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\FunctionTok{mean}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()),}
      \AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{())}
\NormalTok{      )}
\NormalTok{    ) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Alle vrouwen in NHANES studie"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-10-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fem }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample =}\NormalTok{ DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Alle vrouwen in NHANES study"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-10-2.pdf}}

\paragraph{Evalueer de verdeling van het gemiddelde voor steekproeven
van grootte
10}\label{evalueer-de-verdeling-van-het-gemiddelde-voor-steekproeven-van-grootte-10}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{log2Chol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp10[,}\DecValTok{1}\NormalTok{] }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{log2}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(log2Chol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{log2Chol))}\SpecialCharTok{+}
    \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{10}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{xlab}\NormalTok{(}\StringTok{"Direct cholesterol (log2)"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{stat\_function}\NormalTok{(}
      \AttributeTok{fun=}\NormalTok{dnorm,}
      \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
      \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
        \AttributeTok{mean=}\NormalTok{femSamp10[,}\DecValTok{1}\NormalTok{]}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}}\FunctionTok{mean}\NormalTok{(), }\AttributeTok{sd=}\NormalTok{femSamp10[,}\DecValTok{1}\NormalTok{]}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}}\FunctionTok{sd}\NormalTok{())}
\NormalTok{      ) }\SpecialCharTok{+}
    \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"10 random females"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{xlim}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{range}\NormalTok{())}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-11-1.pdf}}

Vervolgens kijken we naar de verdeling van het steekproefgemiddelde over
1000 steekproeven van steekproefgrootte 10.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meanLog2Chol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanLog2Chol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{meanLog2Chol)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{15}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Mean cholesterol (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun=}\NormalTok{dnorm,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{femSamp10}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{(),}
      \AttributeTok{sd=}\NormalTok{femSamp10}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{sd}\NormalTok{())}
\NormalTok{    ) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 10 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-12-1.pdf}}
...
\NormalTok{meanLog2Chol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp10 }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanLog2Chol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{meanLog2Chol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 10 females"}\NormalTok{)}
\end{Highlighting}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-12-2.pdf}}

\textbf{We hebben dus bevestigd dat het gemiddelde ongeveer normaal
verdeeld is voor studies met 10 vrouwen, terwijl de originele gegevens
...
error op de bloeddrukverandering bedroeg 2.33 mm Hg. Dus op 100 studies
met n = 15 subjecten, verwachten we dat de geschatte gemiddelde
systolische bloeddrukafwijking (\(\bar X\)) op minder dan 2 × 2.33 =
4.66mm Hg van het werkelijke populatiegemiddelde (\(\mu\)) ligt in 95
studies.

\subsubsection{Niet-normaal verdeelde
data}\label{niet-normaal-verdeelde-data}

Als individuele observaties geen normale verdeling hebben, is \(\bar X\)
nog steeds \textit{ongeveer} normaal verdeeld wanneer het aantal
observaties groot genoeg is.

Hoe groot moet de steekproef zijn om de normale benadering te laten
werken hangt af van de scheefheid van de distributie!
...
\tightlist
\item
  We kunnen dit evalueren in de NHanes-studie als we de gegevens niet
  log2 transformeren.
\end{itemize}
...
\begin{Highlighting}[]
\NormalTok{fem }\SpecialCharTok{|\textgreater{}}
   \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{DirectChol))}\SpecialCharTok{+}
   \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..)) }\SpecialCharTok{+}
   \FunctionTok{xlab}\NormalTok{(}\StringTok{"Direct cholesterol"}\NormalTok{) }\SpecialCharTok{+}
   \FunctionTok{stat\_function}\NormalTok{(}
     \AttributeTok{fun=}\NormalTok{dnorm,}
     \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
     \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
       \AttributeTok{mean=}\FunctionTok{mean}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol),}
       \AttributeTok{sd=}\FunctionTok{sd}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol))}
\NormalTok{    ) }\SpecialCharTok{+}
   \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"All females in Nhanes study"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-13-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ fem }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{DirectChol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"All females in Nhanes study"}\NormalTok{)}
\end{Highlighting}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-13-2.pdf}}

De cholesterol data zijn duidelijk niet-normaal verdeeld.

\textbf{Verdeling van het steekproefgemiddelde voor verschillende
steekproefgroottes}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{121}\NormalTok{)}
\NormalTok{femSamp5 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}
  \DecValTok{1}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(j,x,size) }\FunctionTok{sample}\NormalTok{(x,size),}
  \AttributeTok{size =} \DecValTok{5}\NormalTok{,}
  \AttributeTok{x =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol)}

\NormalTok{meanChol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp5 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanChol) }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{meanChol)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{15}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Mean cholesterol"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun=}\NormalTok{dnorm,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{femSamp5}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{(),}
      \AttributeTok{sd=}\NormalTok{femSamp5}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{sd}\NormalTok{())}
\NormalTok{    ) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 5 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meanChol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp5 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanChol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{meanChol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 5 females"}\NormalTok{)}
\end{Highlighting}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-2.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meanChol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp10 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanChol) }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{meanChol)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{..density.., }\AttributeTok{fill=}\NormalTok{..count..),}\AttributeTok{bins=}\DecValTok{15}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Mean cholesterol"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    ...
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{,}
    \AttributeTok{args=}\FunctionTok{list}\NormalTok{(}
      \AttributeTok{mean=}\NormalTok{femSamp10}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{(),}
      \AttributeTok{sd=}\NormalTok{femSamp10}\SpecialCharTok{|\textgreater{}} \FunctionTok{colMeans}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{sd}\NormalTok{())}
\NormalTok{    ) }\SpecialCharTok{+}
\FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 10 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-4.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meanChol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp50 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanChol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{meanChol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 50 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-5.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{meanChol }\OtherTok{\textless{}{-}}\NormalTok{ femSamp100 }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{colMeans}\NormalTok{()}
\FunctionTok{data.frame}\NormalTok{(meanChol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{meanChol)) }\SpecialCharTok{+}
  \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 100 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-14-6.pdf}}

\textbf{We merken op dat wanneer de data niet normaal verdeeld zijn, de
verdeling van het steekproefgemiddelde niet normaal verdeeld is over
kleine steekproeven}

\textbf{Voor grote steekproeven is het steekproefgemiddelde van
niet-normale gegevens echter nog steeds ongeveer normaal verdeeld.}

\subsubsection{Centrale Limietstelling
(CLT)}\label{centrale-limietstelling-clt}
...
In Sectie \ref{sec-bigek} zullen we dit uitwerken voor het geval waar de
populatievariantie \(\sigma^2\) op de metingen gekend is. Deze
...
\subsection{Gekende variantie op de metingen}\label{sec-bigek}
...
\begin{definition}[95 procent betrouwbaarheidsinterval voor
populatiegemiddelde]\protect\hypertarget{def-95-procent-betrouwbaarheidsinterval-voor-populatiegemiddelde}{}\label{def-95-procent-betrouwbaarheidsinterval-voor-populatiegemiddelde}
...
\begin{equation}\protect\phantomsection\label{eq-bi}{
\left[\bar X - 1.96 \frac{\sigma}{\sqrt{n}},\bar X + 1.96 \frac{\sigma}{\sqrt{n}}\right]
}\end{equation}
...
\[\left[-18.93-1.96\times 9/\sqrt{15},-18.93+1.96\times 9/\sqrt{15}\right]=[-23.48,-14.38]mmHg\]
...
\ref{sec-interpretBI} (nadat we de intervallen hebben uitgebreid voor de
meer realistische setting waarbij de variantie in de populatie ongekend
is).
...
Vergelijking \ref{eq-bi} het gemiddelde \(\mu\) bij benadering met 95\%
...
\subsubsection{NHANES log2 cholesterol
voorbeeld}\label{nhanes-log2-cholesterol-voorbeeld}

\paragraph{1 steekproef}\label{steekproef-1}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{3146}\NormalTok{)}
\NormalTok{samp50 }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol,}\DecValTok{50}\NormalTok{)}

\NormalTok{ll }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(samp50 }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()) }\SpecialCharTok{{-}} \FloatTok{1.96}\SpecialCharTok{*}\FunctionTok{sd}\NormalTok{(samp50 }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{50}\NormalTok{)}
\NormalTok{ul }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(samp50 }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()) }\SpecialCharTok{+} \FloatTok{1.96}\SpecialCharTok{*}\FunctionTok{sd}\NormalTok{(samp50 }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{())}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{50}\NormalTok{)}
\NormalTok{popMean }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{())}

\FunctionTok{c}\NormalTok{(}\AttributeTok{ll=}\NormalTok{ll,}\AttributeTok{ul=}\NormalTok{ul,}\AttributeTok{popMean=}\NormalTok{popMean)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res}\SpecialCharTok{$}\NormalTok{ll }\OtherTok{\textless{}{-}}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{mean}\FloatTok{{-}1.96}\SpecialCharTok{*}\NormalTok{res}\SpecialCharTok{$}\NormalTok{se}
\NormalTok{res}\SpecialCharTok{$}\NormalTok{ul }\OtherTok{\textless{}{-}}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{mean}\FloatTok{+1.96}\SpecialCharTok{*}\NormalTok{res}\SpecialCharTok{$}\NormalTok{se}
\NormalTok{mu }\OtherTok{\textless{}{-}}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol}\SpecialCharTok{|\textgreater{}}
  \FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mean}\NormalTok{()}

\NormalTok{res}\SpecialCharTok{$}\NormalTok{inside}\OtherTok{\textless{}{-}}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{ll }\SpecialCharTok{\textless{}=}\NormalTok{ mu }\SpecialCharTok{\&}\NormalTok{ mu }\SpecialCharTok{\textless{}=}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{ul}
\NormalTok{res}\SpecialCharTok{$}\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{n)}
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{group\_by}\NormalTok{(n) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{coverage=}\FunctionTok{mean}\NormalTok{(inside)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{spread}\NormalTok{(n,coverage)}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  Merk op dat de omvang in de steekproeven met 10 waarnemingen te laag
  is omdat we geen rekening houden met de onzekerheid in de schatting
  van de standaarddeviatie.
\item
  Als we kijken naar de eerste 20 intervallen, bevat 1 van de 20 niet
...
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ sample,}\AttributeTok{y =}\NormalTok{ mean,}\AttributeTok{color =}\NormalTok{ inside)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ mean}\FloatTok{{-}1.96}\SpecialCharTok{*}\NormalTok{se,}\AttributeTok{ymax =}\NormalTok{ mean}\FloatTok{+1.96}\SpecialCharTok{*}\NormalTok{se))}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 10"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()))}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-17-1.pdf}}
...
\tightlist
\item
  Voor grote steekproeven (100) is de omvang prima omdat we de
  standaarddeviatie met een relatief hoge precisie kunnen schatten.
\end{itemize}
...
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ mean}\FloatTok{{-}1.96}\SpecialCharTok{*}\NormalTok{se,}\AttributeTok{ymax =}\NormalTok{ mean}\FloatTok{+1.96}\SpecialCharTok{*}\NormalTok{se))}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 50"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()))}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-18-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(n }\SpecialCharTok{==} \DecValTok{100}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{slice}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{20}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ sample,}\AttributeTok{y =}\NormalTok{ mean,}\AttributeTok{color =}\NormalTok{ inside)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin =}\NormalTok{ mean}\FloatTok{{-}1.96}\SpecialCharTok{*}\NormalTok{se,}\AttributeTok{ymax =}\NormalTok{ mean}\FloatTok{+1.96}\SpecialCharTok{*}\NormalTok{se))}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 100"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()))}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-18-2.pdf}}
...
betrouwbaarheidsniveaus}\label{andere-betrouwbaarheidsniveaus}

Om een betrouwbaarheidsinterval met een ander betrouwbaarheidsniveau,
\((1-
\alpha)100\%\) te construeren, vervangt men 1.96 door het relevante
kwantiel \(z_{\alpha/2}.\)
...
\begin{definition}[Betrouwbaarheidsinterval]\protect\hypertarget{def-betrouwbaarheidsinterval}{}\label{def-betrouwbaarheidsinterval}

~

\end{definition}

Een \textbf{\((1-\alpha)100\)\% betrouwbaarheidsinterval} voor een
...
\begin{definition}[t-verdeling]\protect\hypertarget{def-t-verdeling}{}\label{def-t-verdeling}

~

\end{definition}

Als \(X_1, X_2, ..., X_n\) een steekproef vormen uit de Normale
verdeling \(N(\mu, \sigma^2)\), dan is \((\bar{X} - \mu)/(S/\sqrt{n})\)
verdeeld als een \(t\)-verdeling met \(n-1\) vrijheidsgraden.

\textbf{Einde Definitie}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grid }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{,.}\DecValTok{1}\NormalTok{)}
\NormalTok{densDist }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(grid,}\FunctionTok{dnorm}\NormalTok{(grid), }\FunctionTok{sapply}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{),dt,}\AttributeTok{x=}\NormalTok{grid))}
\FunctionTok{colnames}\NormalTok{(densDist) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"x"}\NormalTok{,}\StringTok{"normal"}\NormalTok{,}\FunctionTok{paste0}\NormalTok{(}\StringTok{"t"}\NormalTok{,}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{)))}

\NormalTok{densDist }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{as.data.frame}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(dist,dens,}\SpecialCharTok{{-}}\NormalTok{x) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{dens,}\AttributeTok{color=}\NormalTok{dist)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{xlab}\NormalTok{(}\StringTok{"x"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Densiteit"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-tdist-1.pdf}

}

\caption{\label{fig-tdist}Normale verdeling en t-verdeling met
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(.}\DecValTok{975}\NormalTok{,}\AttributeTok{df=}\DecValTok{14}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qt}\NormalTok{(}\FunctionTok{c}\NormalTok{(.}\DecValTok{95}\NormalTok{,.}\DecValTok{975}\NormalTok{,.}\DecValTok{995}\NormalTok{),}\AttributeTok{df=}\DecValTok{14}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(delta) }\SpecialCharTok{{-}}  \FunctionTok{qt}\NormalTok{(.}\DecValTok{975}\NormalTok{,}\AttributeTok{df=}\DecValTok{14}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{sd}\NormalTok{(delta)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(delta) }\SpecialCharTok{{-}}  \FunctionTok{qt}\NormalTok{(.}\DecValTok{995}\NormalTok{,}\AttributeTok{df=}\DecValTok{14}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{sd}\NormalTok{(delta)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n)}
\end{Highlighting}
\end{Shaded}
...
betrouwbaarheidsintervallen}\label{sec-interpretBI}

We zullen opnieuw steekproeven trekken van de grote NHANES studie en
deze keer BI's bestuderen voor log2-cholesterol steekproefwaarden. We
voeren eerst herhaalde experimenten uit met steekproefgrootte 10.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res}\SpecialCharTok{$}\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{as.character}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{n) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{as.double}\NormalTok{(res}\SpecialCharTok{$}\NormalTok{n)}

\NormalTok{res}\SpecialCharTok{$}\NormalTok{ll }\OtherTok{\textless{}{-}}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{mean}\SpecialCharTok{{-}}\FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{df=}\NormalTok{res}\SpecialCharTok{$}\NormalTok{n}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{res}\SpecialCharTok{$}\NormalTok{se}
\NormalTok{res}\SpecialCharTok{$}\NormalTok{ul }\OtherTok{\textless{}{-}}\NormalTok{ res}\SpecialCharTok{$}\NormalTok{mean}\SpecialCharTok{+}\FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{df=}\NormalTok{res}\SpecialCharTok{$}\NormalTok{n}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{res}\SpecialCharTok{$}\NormalTok{se}

\NormalTok{mu }\OtherTok{\textless{}{-}}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol}\SpecialCharTok{|\textgreater{}}\FunctionTok{log2}\NormalTok{()}\SpecialCharTok{|\textgreater{}}\FunctionTok{mean}\NormalTok{()}
...
We zien dat de omvang van de intervallen nu worden gecontroleerd op hun
nominale betrouwbaarheidsniveau van 95\%.
...
\NormalTok{res }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{geom\_errorbar}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin=}\NormalTok{mean}\SpecialCharTok{{-}}\FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{df=}\DecValTok{9}\NormalTok{)}\SpecialCharTok{*}\NormalTok{se,}
    \AttributeTok{ymax=}\NormalTok{mean}\SpecialCharTok{+}\FunctionTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{,}\AttributeTok{df=}\DecValTok{9}\NormalTok{)}\SpecialCharTok{*}\NormalTok{se))}\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{mean}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N=10"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()))}
\end{Highlighting}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-biInterpret-1.pdf}}

}

\caption{\label{fig-biInterpret}Interpretatie van 95\(\%\)
betrouwbaarheidintervallen. Resultaten op basis van 20 gesimuleerde
steekproeven. We zien in de figuur duidelijk dat het populatiegemiddelde
vast is maar ongekend (volle zwarte lijn) en dat de bovengrens en
ondergrens van betrouwbaarheidsintervallen voor het populatiegemiddelde
varieert van steekproef tot steekproef.}

\end{figure}%

De simulatiestudie toont dus op een empirische wijze aan dat de
constructie correct is. Het demonstreert bovendien de interpretatie van
probabiliteit via herhaalde steekproefname. In Figuur
\ref{fig-biInterpret} wordt de interpretatie ook grafisch weergegeven
voor de eerste 20 gesimuleerde steekproeven. De figuur toont duidelijk
...
Voer de bovenstaande simulatie studie opnieuw uit maar verdubbel de
steekproefgrootte. Welke impact heeft dit op de BIs?
...
gemiddelde van {[}-23.9,-13.9{]}mmHg. Op basis van het
...
\subsection{Introductie d.m.v. captopril
voorbeeld}\label{introductie-d.m.v.-captopril-voorbeeld}

\begin{itemize}
\item
  We introduceren hypothese testen eerst intuïtief a.d.h.v. het
  captopril voorbeeld.
\item
  Op basis van de steekproef kunnen we niet bewijzen dat er een effect
  is van het toedienen van captopril (\(H_1\), alternatieve hypothese).
\item
  ...
  \item
    Hoe waarschijnlijk is het om een effect waar te nemen dat minstens
    zo groot is als wat we in de steekproef in een willekeurige
    steekproef hebben gezien als \(H_0\) waar is?
  \end{itemize}
\end{itemize}
...
\begin{itemize}
\item
  Onder \(H_0\) zijn de bloeddrukmetingen voor en na toediening van
  captopril twee ``base line'' bloeddrukmetingen voor een patiënt
\item
  Onder \(H_0\) kunnen we de bloeddrukmetingen voor iedere patiënt in
  willekeurige volgorde plaatsen (permuteren).
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{35}\NormalTok{)}
\NormalTok{captoprilSamp }\OtherTok{\textless{}{-}}\NormalTok{ captopril}
\NormalTok{perm }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\ConstantTok{FALSE}\NormalTok{, }\ConstantTok{TRUE}\NormalTok{), }\DecValTok{15}\NormalTok{, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{captoprilSamp}\SpecialCharTok{$}\NormalTok{SBPa[perm] }\OtherTok{\textless{}{-}}\NormalTok{ captopril}\SpecialCharTok{$}\NormalTok{SBPb[perm]}
\NormalTok{captoprilSamp}\SpecialCharTok{$}\NormalTok{SBPb[perm] }\OtherTok{\textless{}{-}}\NormalTok{ captopril}\SpecialCharTok{$}\NormalTok{SBPa[perm]}
\NormalTok{captoprilSamp}\SpecialCharTok{$}\NormalTok{deltaSBP }\OtherTok{\textless{}{-}}\NormalTok{ captoprilSamp}\SpecialCharTok{$}\NormalTok{SBPa}\SpecialCharTok{{-}}\NormalTok{captoprilSamp}\SpecialCharTok{$}\NormalTok{SBPb}
\NormalTok{captoprilSamp }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{gather}\NormalTok{(type, bp, }\SpecialCharTok{{-}}\NormalTok{id) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(type }\SpecialCharTok{\%in\%} \FunctionTok{c}\NormalTok{(}\StringTok{"SBPa"}\NormalTok{,}\StringTok{"SBPb"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{type =} \FunctionTok{factor}\NormalTok{(type, }\AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"SBPb"}\NormalTok{, }\StringTok{"SBPa"}\NormalTok{)))}\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ type,}\AttributeTok{y =}\NormalTok{ bp)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =}\NormalTok{ id)) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-23-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{deltaSBP =} \FunctionTok{c}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP,captoprilSamp}\SpecialCharTok{$}\NormalTok{deltaSBP),}
  \AttributeTok{shuffled=}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\ConstantTok{FALSE}\NormalTok{,}\ConstantTok{TRUE}\NormalTok{),}\AttributeTok{each=}\DecValTok{15}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ shuffled, }\AttributeTok{y =}\NormalTok{ deltaSBP)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape =} \ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position =} \StringTok{"jitter"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{stat\_summary}\NormalTok{(}
    \AttributeTok{fun.y =}\NormalTok{ mean,}
    ...
    \AttributeTok{color =} \StringTok{"red"}\NormalTok{,}
    \AttributeTok{fill =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Difference (mm mercury)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-24-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-25-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-25-2.pdf}}
...
\item
  We hoeven in principe alleen de tekens van de waargenomen
  bloeddrukverschillen \(x\) te wisselen als we permuteren.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{permH }\OtherTok{\textless{}{-}} \FunctionTok{expand.grid}\NormalTok{(}
...
\NormalTok{permH[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  We zullen dit voor alle mogelijke permutaties doen en we zullen het
  gemiddelde bijhouden.
\end{itemize}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#calculate the means for the permuted data}
\NormalTok{muPerm }\OtherTok{\textless{}{-}} \FunctionTok{colMeans}\NormalTok{(permH}\SpecialCharTok{*}\NormalTok{captopril}\SpecialCharTok{$}\NormalTok{deltaSBP)}
\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{permMean =}\NormalTok{ muPerm) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{permMean)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}
    \AttributeTok{xintercept =} \FunctionTok{mean}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP),}
    \AttributeTok{col =} \StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-27-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sum}\NormalTok{(muPerm }\SpecialCharTok{\textless{}=} \FunctionTok{mean}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(muPerm }\SpecialCharTok{\textless{}=} \FunctionTok{mean}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP))}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  We zien dat maar 1 van de gemiddelden die werden verkregen onder
  \(H_0\) (door permutatie) zo extreem was als het steekproefgemiddelde
  dat we in de captopril-studie hebben waargenomen.
\item
  Dus de kans om een bloeddrukdaling waar te nemen die groter of gelijk
  is dan die in de captopril-studie in een willekeurige steekproef onder
  de nulhypothese, is 1 op de 32768.
\end{itemize}

We hebben dus sterk bewijs dat \(H_0\) onjuist is en daarom verwerpen we
\(H_0\) en concluderen \(H_1\): het toedienen van captopril heeft een
effect op de bloeddruk van patiënten met hypertensie.

\subsubsection{Pivot}\label{pivot}

\begin{itemize}
\item
  In de praktijk gebruiken we altijd statistieken die de effectgrootte
  (gemiddeld verschil) afwegen tegen ruis (standaard error)
\item
  Als we de nulhypothese ontkrachten, standaardiseren we het gemiddelde
  rond \(\mu_0 = 0\) het gemiddelde onder \(H_0\)
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{deltaPerms }\OtherTok{\textless{}{-}}\NormalTok{ permH}\SpecialCharTok{*}\NormalTok{captopril}\SpecialCharTok{$}\NormalTok{deltaSBP}
\NormalTok{tPerm }\OtherTok{\textless{}{-}} \FunctionTok{colMeans}\NormalTok{(deltaPerms)}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{apply}\NormalTok{(deltaPerms,}\DecValTok{2}\NormalTok{,sd)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{15}\NormalTok{))}
\NormalTok{tOrig }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP)}\SpecialCharTok{/}\FunctionTok{sd}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP)}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{15}\NormalTok{)}

\NormalTok{tPermPlot }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{permT =}\NormalTok{ tPerm) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{permT)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density.., }\AttributeTok{fill =}\NormalTok{ ..count..)) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =}\NormalTok{ tOrig,}\AttributeTok{col =} \StringTok{"blue"}\NormalTok{)}
\NormalTok{tPermPlot}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-28-1.pdf}}

\begin{itemize}
\tightlist
\item
  Opnieuw heeft slechts 1 van de permutaties een t-statistiek die zo
  extreem is als de statistiek die wordt waargenomen in de
  captopril-studie.
\end{itemize}

Wanneer er geen effect is van captopril, is het bijna onmogelijk om een
teststatistiek te verkrijgen die zo extreem is als degene die werd
waargenomen in de steekproef (t=-8.12).

\begin{itemize}
\item
  De kans om een grotere bloeddrukdaling waar te nemen dan degene die we
  in onze steekproef hebben waargenomen in een willekeurige steekproef
  onder \(H_0\) is 1/32768.
\item
  We noemen deze kans de \emph{p-waarde}.
\item
  Het meet de sterkte van het bewijs tegen de nulwaarde: hoe kleiner de
  p-waarde, hoe meer bewijs we hebben dat de nulwaarde niet waar is.
\item
...
Wanneer is de p-waarde klein genoeg om te concluderen dat er sterk
bewijs is tegen de nulhypothese?

\begin{itemize}
\item
  We werken doorgaans met een significantieniveau van \(\alpha = 0,05\)
\item
  We stellen dat we de test hebben uitgevoerd op het significantieniveau
  van 5\%
\end{itemize}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{Permutatietests zijn computationeel
veeleisend}\label{permutatietests-zijn-computationeel-veeleisend}

\begin{itemize}
\item
  Kunnen we beoordelen hoe extreem de bloeddrukdaling was zonder
  permutatie?
\item
  We weten dat de bloeddrukverschillen ongeveer normaal verdeeld zijn,
  dus
\end{itemize}

\[t=\frac{\bar X - \mu}{se_{\bar X}}\]

volgt een t-verdeling (met 14 vrijheidsgraden voor het Captopril
voorbeeld).
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tPermPlot }\SpecialCharTok{+}
  \FunctionTok{stat\_function}\NormalTok{(}
    \AttributeTok{fun =}\NormalTok{ dt,}
    \AttributeTok{color =} \StringTok{"red"}\NormalTok{,}
    \AttributeTok{args =} \FunctionTok{list}\NormalTok{(}\AttributeTok{df=}\DecValTok{14}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-29-1.pdf}}

\begin{itemize}
\item
  Merk op dat de permutatie-nulverdeling inderdaad overeenkomt met een
  t-verdeling met 14 vrijheidsgraden.
\item
  Zodat we de statistische test kunnen uitvoeren met behulp van
  statistische modellen van de gegevens.
\item
  Hiervoor moeten we assumpties maken, die we verifiëren in de data
  exploratie.
\end{itemize}

We overlopen nu alle componenten van een hypothese test waarbij we
gebruik maken van veronderstellingen over de distributie van de
gegevens.
...
wensen te bewijzen aan de hand van de studie. Hier:
...
m.a.w. gemiddeld gezien blijft de systolische bloeddruk na toediening
van captopril onveranderd.
...
waar de index ``0'' in \(\text{P}_0\left[.\right]\) aangeeft dat de kans
onder de nulhypothese berekend wordt. Het is met andere woorden de kans
om in een willekeurige steekproef onder de nulhypothese een waarde voor
de teststatistiek T te bekomen die lager of gelijk is aan\footnote{meer
...
Waarbij \(f_t(.;14)\) de densiteitsfunctie is van de t-verdeling. De
oppervlakte onder de densiteitsfunctie is opnieuw een kans. Deze kans
kan berekend worden in R m.b.v. de functie \texttt{pt(x,df)} die twee
argumenten heeft, de waarde van de test-statistiek \texttt{x} en het
aantal vrijheidsgraden van de t-verdeling \texttt{df}. \texttt{pt(x,df)}
berekent de kans om een waarde te observeren die kleiner of gelijk is
aan x wanneer men een willekeurige observatie trekt uit een t-verdeling
met df vrijheidsgraden.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(delta)}
\NormalTok{stat}\OtherTok{\textless{}{-}}\NormalTok{(}\FunctionTok{mean}\NormalTok{(delta)}\SpecialCharTok{{-}}\DecValTok{0}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(}\FunctionTok{sd}\NormalTok{(delta)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(n))}
\NormalTok{stat}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pt}\NormalTok{(stat,n}\DecValTok{{-}1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{definition}[\(p\)-waarde]\protect\hypertarget{def-p-waarde}{}\label{def-p-waarde}

~

\end{definition}

De \textbf{p-waarde} (ook wel \textbf{geobserveerd significantieniveau}
genoemd) is de kans om onder de nulhypothese een even of meer
``extreme'' toetsinggrootheid waar te nemen (in de richting van het
alternatief) dan de waarde \(t\) die geobserveerd werd o.b.v. de
steekproef. Hoe kleiner die kans is, hoe sterker het bewijs tegen de
nulhypothese.
...
wordt het \textbf{significantieniveau} genoemd en wordt voorgesteld door
\(\alpha\).

\begin{definition}[significantieniveau]\protect\hypertarget{def-significantieniveau}{}\label{def-significantieniveau}

~

\end{definition}

De drempelwaarde \(\alpha\) staat gekend als het
\textbf{significantieniveau} van de statistische test. Een statistische
test uitgevoerd op het \(\alpha\) significantieniveau wordt een
\textbf{niveau-\(\alpha\) test} genoemd (Engels: \emph{level-\(\alpha\)
test}).
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoTest-1.pdf}

}

\caption{\label{fig-captoTest}Interpretatie van p-waarde, kritieke
waarde, verwerpingsgebied, aanvaardingsgebied voor het captopril
voorbeeld.}
...
\NormalTok{deltaSim }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}
  \FunctionTok{rnorm}\NormalTok{(n}\SpecialCharTok{*}\NormalTok{nsim,mu,sigma),}
  \AttributeTok{nrow=}\NormalTok{n,}
  \AttributeTok{ncol=}\NormalTok{nsim)}

\NormalTok{pSim }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(}
\NormalTok{  deltaSim,}
  \DecValTok{2}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(x, mu, alternative)    }
    \FunctionTok{t.test}\NormalTok{(x,}
      \AttributeTok{mu =}\NormalTok{ mu,}
      \AttributeTok{alternative =}\NormalTok{ alternative)}\SpecialCharTok{$}\NormalTok{p.value,}
      \AttributeTok{mu =}\NormalTok{ mu0,}
      \AttributeTok{alternative=}\StringTok{"less"}
\NormalTok{  )}

\FunctionTok{mean}\NormalTok{(pSim}\SpecialCharTok{\textless{}}\NormalTok{alpha)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{pValue =}\NormalTok{ pSim) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{pValue)) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-32-1.pdf}}
...
Voer de simulatiestudie opnieuw uit verdubbel hierbij het aantal
observaties in de steekproef. Wat observeer je?
...
\item
  n=15
\item
  \(\mu=-2\) mmHg, er is dus een bloeddrukdaling van 2 mmHg door de
  behandeling.
\item
  \(\sigma =9\) mmHg
\item
...
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{15}
\NormalTok{sigma }\OtherTok{\textless{}{-}} \DecValTok{9}
\NormalTok{mu }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\DecValTok{2}
\NormalTok{mu0 }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{alpha }\OtherTok{\textless{}{-}} \FloatTok{0.05}
...
\pandocbounded{\includegraphics[keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/unnamed-chunk-33-1.pdf}}

\begin{itemize}
\tightlist
\item
  We observeren dat een power van 0.2055 of een type II error van
  0.7945.
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(delta,}\AttributeTok{alternative=}\StringTok{"less"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{with}\NormalTok{(captopril,}
...
\item
  ...
  effect. Er was geen goeie controle! Het gebrek aan een goeie controle
...
detecteren.\\
Stel dat men het bloeddrukverschil had gedefinieerd als
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{delta2 }\OtherTok{\textless{}{-}}\NormalTok{ captopril}\SpecialCharTok{$}\NormalTok{SBPb}\SpecialCharTok{{-}}\NormalTok{captopril}\SpecialCharTok{$}\NormalTok{SBPa}
\FunctionTok{t.test}\NormalTok{(delta2,}\AttributeTok{alternative=}\StringTok{"greater"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
moeten gebruiken waarbij men de nulhypothese
...
zodat het gemiddelde onder de alternatieve hypothese verschillend is van
\(0\). Het kan zowel een positieve of negatieve afwijking zijn en men
weet niet bij aanvang van de studie in welke richting het werkelijk
gemiddelde zal afwijken onder de alternatieve hypothese.
...
\item
  ...
  \item
    ...
    \item
      ...
      rechter staart van de verdeling onder \(H_0\). Gezien de
      t-verdeling symmetrisch is, volgt dat we een kritieke waarde \(c\)
      kiezen zodat er een kans is van \(\alpha/2=2.5\%\) dat \(T\geq c\)
      en er \(\alpha/2=2.5\%\) kans is dat \(T\leq -c\). We kunnen dit
      ook nog als volgt formuleren: Er is onder \(H_0\) \(\alpha=5\%\)
      kans dat \(\vert T\vert\geq c\) (zie Figuur \ref{fig-captoTest2}).
    \end{itemize}
  \end{itemize}
\item
...
\(\vert t  \vert\), de geobserveerde test statistiek. Gezien de
verdeling symmetrisch is, kunnen we ook eerst de kans in de rechter
staart van de verdeling berekenen en deze kans vervolgens
vermenigvuldigen met 2 zodoende een tweezijdige p-waarde te bekomen.

Als de onderzoekers niet vooraf gedefinieerd hadden dat ze enkel een
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(delta)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-captoTest2-1.pdf}

}

\caption{\label{fig-captoTest2}Interpretatie van p-waarde, kritieke
waarde, verwerpingsgebied, aanvaardingsgebied voor het captopril
voorbeeld wanneer we een tweezijdige toets uitvoeren.}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{115}\NormalTok{)}
\NormalTok{mu }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{sigma }\OtherTok{\textless{}{-}} \FloatTok{9.0}
\NormalTok{nSim }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{alpha }\OtherTok{\textless{}{-}} \FloatTok{0.05}
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{15}
\NormalTok{pvalsCor }\OtherTok{\textless{}{-}}
\NormalTok{    pvalsInCor }\OtherTok{\textless{}{-}}
    \FunctionTok{array}\NormalTok{(}\DecValTok{0}\NormalTok{,nSim)}
...
\NormalTok{    pvalsCor[i] }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(x)}\SpecialCharTok{$}\NormalTok{p.value}

    \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{mean}\NormalTok{(x)}\SpecialCharTok{\textless{}}\DecValTok{0}\NormalTok{)}
\NormalTok{        pvalsInCor[i] }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(}
\NormalTok{            x,}
            \AttributeTok{alternative=}\StringTok{"less"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{p.value }\ControlFlowTok{else}
\NormalTok{        pvalsInCor[i] }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(}
\NormalTok{            x,}
            \AttributeTok{alternative=}\StringTok{"greater"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{p.value}
\NormalTok{\}}
\FunctionTok{mean}\NormalTok{(pvalsCor }\SpecialCharTok{\textless{}} \FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(pvalsInCor }\SpecialCharTok{\textless{}} \FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#functie var op een matrix berekent varianties sigma\_1\^{}2, sigma\_2\^{}2}
\CommentTok{\#covariantie sigma\_\{12\}}
\NormalTok{vars }\OtherTok{\textless{}{-}} \FunctionTok{var}\NormalTok{(captopril[,}\FunctionTok{c}\NormalTok{(}\StringTok{"SBPb"}\NormalTok{,}\StringTok{"SBPa"}\NormalTok{)])}
\NormalTok{vars}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{SBPa,captopril}\SpecialCharTok{$}\NormalTok{SBPb)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{varXbarDelta }\OtherTok{\textless{}{-}}\NormalTok{ (vars[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{]}\SpecialCharTok{+}\NormalTok{vars[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{]}\SpecialCharTok{{-}}\DecValTok{2}\SpecialCharTok{*}\NormalTok{vars[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{/}\DecValTok{15}
\FunctionTok{sqrt}\NormalTok{(varXbarDelta)}
\end{Highlighting}
\end{Shaded}
...
steekproef het bloeddrukverschil berekenen:
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sd}\NormalTok{(delta)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Een gepaard experiment is eigenlijk een speciale vorm van een randomized
...
\item
  Elke behandeling is getest binnen blok: een controle bloeddrukmeting
  en een bloeddrukmeting na toedienen van captopril
\item
  Tussen de blokken is er inderdaad een grote bron van variabiliteit:
  e.g.~er is een grote variabiliteit tussen blokken! Personen met een
  hoge bloeddruk voor het toedienen van captopril hebben meestal ook nog
  steeds een hoge bloeddruk na de captopril behandeling. De
  standaarddeviatie in de bloeddruk tussen patiënten voor toedienen van
  captopril bedraagt 20.6 mmHg.
\item
  We kunnen het effect van captopril in het gepaard design schatten
  binnen patient. Door het blokdesign kunnen we dus de variabiliteit
  tussen patiënten uit de analyse weren. Voor een gepaard design kunnen
  we dat door b.v. doen a.d.h.v. een analyse op de bloeddrukverschillen
  te doen. De standaard deviatie op de bloeddruk verschillen tussen
  patiënten is inderdaad veel lager 9.03.
\end{itemize}
...
Deze variabele is het relatief aandeel van \emph{Staphylococcus spp.} op
het totaal aantal \emph{Staphylococcus spp.} en \emph{Corynebacterium
spp.}.

We gaan hiervoor opnieuw de microbioom data inlezen. De resultaten
worden weergegeven in Figuur \ref{fig-okselBox}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ap }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/GTPB/PSLS20/master/data/armpit.csv"}\NormalTok{)}
\FunctionTok{head}\NormalTok{(ap)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ap }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Relatieve abundantie"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Behandeling"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-okselBox-1.pdf}

}

\caption{\label{fig-okselBox}Boxplot van de relatieve Staphylococcus
spp. abundantie t.o.v. het totaal van Staphylococcus spp. en
Corynebacterium spp., voor beide behandelingsgroepen.}

\end{figure}%

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ap}\SpecialCharTok{$}\NormalTok{trt }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(ap}\SpecialCharTok{$}\NormalTok{trt) }\CommentTok{\#zet charactervector om in factor}
\NormalTok{ap }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample =}\NormalTok{ rel)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_grid}\NormalTok{(.}\SpecialCharTok{\textasciitilde{}}\NormalTok{trt) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"Relatieve abundantie"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{05-StatistischeBesluitvorming_files/figure-pdf/fig-okselQQ-1.pdf}

}

\caption{\label{fig-okselQQ}QQ-plots van relatieve Staphylococcus spp.
abundantie t.o.v. het totaal van Staphylococcus spp. en Corynebacterium
spp.}
...
Stel \(Y_{ij}\) de uitkomst van observatie \(i=1,\ldots, n_j\) uit
populatie \(j=1,2\). We zullen dikwijls de term \textbf{behandeling} of
\textbf{groep} gebruiken in plaats van populatie, zelfs wanneer de twee
populaties niet geïnterpreteerd kunnen worden als behandelingen.
Beschouw het als een (misgroeide) conventie. In de context van het
voorbeeld is behandeling \(j=1\) de microbiële transplantatie en
behandeling \(j=2\) de placebo behandeling.
...
De alternatieve hypothese drukt dus de onderzoeksvraag uit: een verschil
in relatieve abundantie van \emph{Staphylococcus spp.} na microbiële
transplantatie t.o.v. de placebo behandeling.\\
...
De alternatieve hypothese correspondeert met wat we wensen te bewijzen
aan de hand van de experimentele data: een verschil in gemiddelde
abundantie van \emph{Staphylococcus spp.} in de transplantatie groep
i.v.m. de placebo groep. Dus

\[H_1: \mu_1\neq \mu_2.\]

De R software heeft een specifieke functie voor het uitvoeren van deze
\(t\)-test.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{t.test}\NormalTok{(}
\NormalTok{    rel }\SpecialCharTok{\textasciitilde{}}\NormalTok{ trt,}
    \AttributeTok{data =}\NormalTok{ ap,}
...
van \emph{Staphylococcus spp.}, dan is er de kans om een teststatistiek
te bekomen in een willekeurige steekproef die minstens zo extreem is als
deze die wij geobserveerd hebben minder dan 9 op \(100000\)!
...
\emph{Staphylococcus spp.} is gemiddeld -22.2\% hoger in de transplantie
...
afwijkingen symmetrisch zijn). Eventueel kan je ook beroep doen op de
...
\ref{sec-spreiding}). Als de verschillen tussen de IQR range van beide
groepen niet te groot is, kan men besluiten dat de data homoscedastisch
zijn. Opnieuw kan inzicht gekregen worden in dergelijke plots door
gebruik te maken van simulaties (zie Oefeningen). Men kan eveneens een
formele F-test gebruiken om de varianties te vergelijken (zie
oefeningen), maar hiervoor geldt dezelfde kritiek als voor het testen
van normaliteit (zie vorige sectie).
...
een zeker getal \(\theta_0\). Dan kan men aantonen dat men deze
tweezijdige toetsingsprocedure kan uitvoeren op het \(\alpha 100\%\)
significantieniveau door de nulhypothese te verwerpen als en slechts als
het \((1-\alpha)100\%\) betrouwbaarheidsinterval voor \(\theta\) het
getal \(\theta_0\) niet omvat. Met andere woorden, het
\((1-\alpha)100\%\) betrouwbaarheidsinterval voor \(\theta\) bevat alle
getallen \(\theta_0\) zodat de tweezijdige toets van \(H_0 : \theta=
\theta_0\) versus \(H_1 : \theta \neq \theta_0\) de nulhypothese niet
verwerpt.
...
\item
  Als \(O < E_1 < B < E_2\) dan kan men op het 5\% significantieniveau
  besluiten dat \(\mu_1\) \emph{niet} wetenschappelijk groter is dan
  \(\mu_2\). In dat geval zijn zowel de opties wetenschappelijk
  equivalent met \(\mu_2\) als wetenschappelijk significant kleiner dan
  \(\mu_2\) niet uit te sluiten met 95\% zekerheid.
\item
...
het geneesmiddel Formoterol minder efficiënt is gezien het gemiddeld
...
\chapter{Enkelvoudige lineaire regressie}\label{sec-chap-linReg}
...
\tightlist
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJJyNBiMlv24sSI0oKB8EtI0}{Kennisclips
  Hoofdstuk6 Lineaire Regressie}
\end{itemize}
...
\tightlist
\item
  \href{https://statomics.github.io/sbc/rmd/06-linearRegression.html}{script
  Hoofdstuk6}
\end{itemize}
...
De data is opgeslagen in een tekst bestand met naam \texttt{brca.csv} op
de github repository van de cursus.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brca }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/breastcancer.csv"}\NormalTok{)}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\FunctionTok{head}\NormalTok{(brca),}\AttributeTok{caption=}\StringTok{"Overzicht van de variabelen in de borstkanker dataset."}\NormalTok{,}\AttributeTok{booktabs =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1463}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1951}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1220}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0366}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0732}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0610}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0610}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0488}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1220}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1341}}@{}}

\caption{\label{tbl-brcaMicroLin}Overzicht van de variabelen in de
borstkanker dataset.}
...
\bottomrule\noalign{}
\endlastfoot
OXFT\_209 & gsm65344.cel.gz & tamoxifen & 1 & 3 & 1 & 2.5 & 66 &
1939.1990 & 207.19682 \\
OXFT\_1769 & gsm65345.cel.gz & tamoxifen & 1 & 1 & 1 & 3.5 & 86 &
2751.9521 & 36.98611 \\
OXFT\_2093 & gsm65347.cel.gz & tamoxifen & 1 & 1 & 1 & 2.2 & 74 &
379.1951 & 2364.18306 \\
OXFT\_1770 & gsm65348.cel.gz & tamoxifen & 1 & 1 & 1 & 1.7 & 69 &
2531.7473 & 23.61504 \\
OXFT\_1342 & gsm65350.cel.gz & tamoxifen & 1 & 3 & 0 & 2.5 & 62 &
141.0508 & 3218.74109 \\
OXFT\_2338 & gsm65352.cel.gz & tamoxifen & 1 & 3 & 1 & 1.4 & 63 &
1495.4213 & 107.56868 \\
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\StringTok{""}\NormalTok{, }\AttributeTok{y=}\NormalTok{S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{""}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8 expressie"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-s100a8Boxplot-1.pdf}

}

\caption{\label{fig-s100a8Boxplot}Expressie van het S100A8 gen.}
...
\NormalTok{brcaSubset }\OtherTok{\textless{}{-}}\NormalTok{ brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(S100A8}\SpecialCharTok{\textless{}}\DecValTok{2000}\NormalTok{)}
\CommentTok{\#progress = FALSE zo dat ggpairs niet de vooruitgang print van het plotten}
\NormalTok{brcaSubset[,}\SpecialCharTok{{-}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)] }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggpairs}\NormalTok{(}\AttributeTok{progress =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaGenAl-1.pdf}

}

\caption{\label{fig-brcaGenAl}Scatterplot matrix voor de observaties in
de borstkanker dataset na verwijdering van outliers in de S100A8
expressie (merk op dat we deze outliers in principe niet mochten
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brcaSubset }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{ESR1, }\AttributeTok{y=}\NormalTok{S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaSmooth-1.pdf}

}

\caption{\label{fig-brcaSmooth}Scatterplot voor S100A8 expressie in
functie van de ESR1 expressie met smoother die het verband tussen beide
genen samenvat (na verwijdering van outliers in de S100A8 expressie,
merk op dat we deze outliers in principe niet mochten verwijderen uit de
dataset).}
...
waarbij we de toevallige veranderlijke S100A8 genexpressie voor subject
\(i\) (\(Y_i\)) modelleren in functie van de genexpressie van het ESR1
gen (\(X_i\)). Uiteraard is dit verband niet perfect. Dat wordt
aangegeven door de foutterm \(\epsilon_i\) die uitdrukt dat observaties
\(Y_i\) variëren rond dit verband, m.a.w. het verband modelleert een
conditioneel gemiddelde:

\[E[Y_i|X_i=x]=g(x),\]

het is de verwachte uitkomst\footnote{In de cursus zullen we naar Y
  refereren met de term afhankelijke variable, response variabele of
  uitkomst, wat 3 synoniemen zijn} (\(E[Y]\)) bij subjecten met een
...
het gemiddelde beschrijft voor subjecten met een ESR1 expressieniveau
van \(x\) is de foutterm \(\epsilon_i\) gemiddeld 0 voor deze subjecten:
...
\item
  voeg een ``smooth line'' toe \texttt{geom\_smooth()}
\item
  voeg een rechte toe \texttt{geom\_smooth()} met
  \texttt{method\ =\ "lm"} (linear model). (We zetten
  \texttt{se\ =\ FALSE} om geen puntgewijze betrouwbaarheidsintervallen
  weer te geven)
\end{enumerate}
...
\NormalTok{brcaSubset }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ ESR1, }\AttributeTok{y =}\NormalTok{ S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{col =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLin1-1.pdf}

}

\caption{\label{fig-brcaLin1}Scatterplot voor S100A8 expressie in
functie van de ESR1 expressie met lineair model dat het verband tussen
beide genen samenvat (na verwijdering van outliers in de S100A8
expressie, merk op dat we deze outliers in principe niet mochten
verwijderen uit de dataset zoals we verder in dit hoofdstuk zullen
zien).}
...
\begin{equation}\protect\phantomsection\label{eq-linreg}{
E(Y|X =x)=\beta_0 + \beta_1 x
}\end{equation}

waarbij \(\beta_0\) en \(\beta_1\) ongekende modelparameters zijn. In
...
richtingscoëfficiënt van de rechte weer. Uitdrukking \ref{eq-linreg}
...
verklarende variabele \(X\). Om die reden wordt Model \ref{eq-linreg}
...
De parameters \(\beta_0\) en \(\beta_1\) zijn ongekenden. Indien de
...
van 2 vergelijkingen, bepaald door Model \ref{eq-linreg}, op te lossen).
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLinRes-1.pdf}

}

\caption{\label{fig-brcaLinRes}Scatterplot voor S100A8 expressie in
functie van de ESR1 expressie met lineair model (rode lijn) en residuen
(zwarte gestreepte lijnen).}
...
Merk op dat de helling van de kleinste kwadratenlijn evenredig is met de
correlatie tussen de uitkomst en de verklarende variabele.

Voor gegeven schattingen \(\hat{\beta}_0\) voor \(\beta_0\) en
\(\hat{\beta}_1\) voor \(\beta_1\) laat het lineaire regressiemodel
\ref{eq-linreg} toe om:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(S100A8 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ ESR1, brcaSubset)}
...
Hoofdstuk \ref{sec-chap-besluit} is het op basis van de puntschatters
voor de helling niet duidelijk of dat verband werkelijk voorkomt in de
...
de originele observaties conditioneel op \(X\) eveneens Normaal verdeeld
zijn

\[Y_i\sim N(\beta_0+\beta_1 X_i,\sigma^2),\]

met een gemiddelde dat varieert in functie van de waarde van de
onafhankelijke variabele \(X_i\).
...
van de observaties. Zoals beschreven in Hoofdstuk
\ref{sec-chap-describe} kunnen we de variatie van de uitkomsten rond hun
conditionele gemiddelde beschrijven d.m.v. de afwijkingen tussen de
observaties \(y_i\) en hun (geschatte) gemiddelde
\(\hat{g}(x)=\hat{\beta}_0+\hat{\beta}_1x_i\), de residu's. Het
gemiddelde van die residu's is echter altijd 0 omdat positieve en
negatieve residu's mekaar opheffen. Bijgevolg levert het gemiddelde
residu geen goede maat op voor de variatie en is het beter om naar
kwadratische afwijkingen \(e_i^2\) te kijken. Net zoals de
steekproefvariantie een goede schatter was voor de variantie (Sectie
\ref{sec-spreiding}), zal in de regressiecontext het gemiddelde van die
kwadratische afwijkingen rond de regressierechte opnieuw een goede
...
Analoog als in Hoofdstuk \ref{sec-chap-besluit} kunnen we opnieuw
toetsen en betrouwbaarheidsintervallen construeren op basis van de
teststatistieken
...
expressie van beide genen:

\[H_0: \beta_1=0\]

en onder de alternatieve hypothese is er een associatie tussen beide
genen:
...
genexpressie extreem significant is (p\textless\textless0.001). Als de
nulhypothese waar is en als aan alle voorwaarden is voldaan dan is er
...
stappen (zie Hoofdstuk \ref{sec-chap-glm}). Residuplots worden standaard
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLinDiag1-1.pdf}

}

\caption{\label{fig-brcaLinDiag1}Diagnostische plots voor het nagaan van
de veronderstellingen van het lineair regressiemodel waarbij de S100A8
expressie wordt gemodelleerd i.f.v de ESR1 expressie (na verwijdering
van 3 outliers).}
...
absolute waarde van de gestandaardiseerde error
...
zodat de regressiekromme eruit ziet als een parabool, of een derde orde
model:

\[E(Y|X)=\beta_0+\beta_1X+\beta_2X^2+\beta_3X^3\]

zodat de regressiekromme een derdegraadspolynoom is. Deze methode kan
gezien worden als een vorm van transformatie van de verklarende
variabele en bezit wezenlijk dezelfde eigenschappen en voor- en nadelen.
Een bijkomend voordeel is echter dat het hier niet nodig is om zelf een
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brca }\OtherTok{\textless{}{-}}\NormalTok{ brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{log2S100A8 =} \FunctionTok{log2}\NormalTok{(S100A8),}
    \AttributeTok{log2ESR1 =} \FunctionTok{log2}\NormalTok{(ESR1)}
\NormalTok{    )}

\NormalTok{lm2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(log2S100A8 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ log2ESR1, brca)}

\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ log2ESR1, }\AttributeTok{y =}\NormalTok{ log2S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{col =} \StringTok{"grey"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogLin-1.pdf}

}

\caption{\label{fig-brcaLogLin}Scatterplot voor log2-S100A8 expressie in
functie van de log2-ESR1 expressie met smoother en lineair model die het
verband tussen beide genen samenvatten (outliers worden niet langer
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogLin2-1.pdf}

}

\caption{\label{fig-brcaLogLin2}Diagnostische plots voor het lineair
model voor log2-S100A8 expressie in functie van de log2-ESR1.}
...
Een patiënt met een ESR1 expressie die 1 eenheid op de \(\log_2\) schaal
hoger ligt dan dat van een andere patiënt heeft gemiddeld gezien een
expressie-niveau van het S100A8 gen dat 1.61 eenheden lager ligt (95\%
BI {[}-1.92,-1.31{]}).

Merk op dat dit een crossectionele studie is, we kunnen met het model
alleen maar uitspraken doen over verschillen tussen patiënten!
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{lm2}\SpecialCharTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{2}\SpecialCharTok{\^{}{-}}\FunctionTok{confint}\NormalTok{(lm2)[}\DecValTok{2}\NormalTok{,]}
\end{Highlighting}
\end{Shaded}
...
Een patiënt met een ESR1 expressie die 2 keer zo hoog is als die van een
andere patiënt, zal gemiddeld een S100A8-expressie hebben die 3.06 keer
lager is (95\% BI {[}2.48,3.79{]}).
...
\textbf{Interpretatie 3} Een patiënt met een ESR1 expressie die 1\%
hoger is dan die van een andere patiënt zal gemiddeld een
expressieniveau voor het S100A8 gen hebben dat ongeveer 1.61\% lager is
(95\% BI {[}-1.92,-1.31{]}\%).
...
gemiddeld in een \(\beta_1\)\% verschil in de uitkomst.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grid }\OtherTok{\textless{}{-}} \FunctionTok{log2}\NormalTok{(}\DecValTok{140}\SpecialCharTok{:}\DecValTok{4000}\NormalTok{)}
\NormalTok{g }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(}
\NormalTok{  lm2,}
  \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{log2ESR1=}\NormalTok{grid),}
...
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"ESR1 (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8 (log2)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogLinPred1-1.pdf}

}

\caption{\label{fig-brcaLogLinPred1}Scatterplot voor log2-S100A8
expressie in functie van de log2-ESR1 expressie met model schattingen en
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{newdata }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\AttributeTok{grid=} \DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{grid, }\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{g))}

\NormalTok{p1 }\OtherTok{\textless{}{-}}\NormalTok{ brca }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{ ESR1, }\AttributeTok{y =}\NormalTok{ S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid, }\AttributeTok{y =}\NormalTok{ fit), newdata) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid, }\AttributeTok{y =}\NormalTok{ lwr), newdata, }\AttributeTok{color=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid, }\AttributeTok{y =}\NormalTok{ upr), newdata, }\AttributeTok{color=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"ESR1"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8"}\NormalTok{)}

\NormalTok{p2 }\OtherTok{\textless{}{-}}\NormalTok{ brca }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{ ESR1, }\AttributeTok{y =}\NormalTok{ S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid, }\AttributeTok{y =}\NormalTok{ fit), newdata) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid, }\AttributeTok{y =}\NormalTok{ lwr), newdata, }\AttributeTok{color=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid,}\AttributeTok{y =}\NormalTok{ upr), newdata, }\AttributeTok{color=}\StringTok{"red"}\NormalTok{)  }\SpecialCharTok{+}
  ...
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"log2 ESR1"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"log2 S100A8"}\NormalTok{)}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogLinPred2-1.pdf}

}

\caption{\label{fig-brcaLogLinPred2}Scatterplot voor S100A8 expressie in
functie van de ESR1 expressie met model schattingen (geometrische
gemiddeldes) een 95\(\%\) betrouwbaarheidsintervallen (links: originele
schaal, rechts: originele schaal met logaritmische assen).}
...
met \(\epsilon^*\sim N(0,\sigma^2)\) en \(\epsilon^*\) onafhankelijk van
de steekproefobservaties \(Y_1,\ldots, Y_n\).
...
een t-verdeling volgt met n-2 vrijheidsgraden. Deze statistiek kan
gebruikt worden om een betrouwbaarheidsinterval op de predictie te
construeren, ook wel een \textbf{predictie-interval} (PI) genoemd. Merk
op dat dit predictie-interval een verbeterde versie is van een
referentie-interval wanneer de modelparameters niet gekend zijn. Het PI
houdt immers rekening met de onzekerheid op het geschatte gemiddelde
(gebruik van standard error op predictie i.p.v. standaard deviatie) en
deze op de geschatte standaard deviatie (gebruik van t-verdeling i.p.v
Normale verdeling).
...
\begin{Highlighting}[]
\NormalTok{grid }\OtherTok{\textless{}{-}} \FunctionTok{log2}\NormalTok{(}\DecValTok{140}\SpecialCharTok{:}\DecValTok{4000}\NormalTok{)}
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(}
\NormalTok{  lm2,}
  \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{log2ESR1=}\NormalTok{grid),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{preddata }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\AttributeTok{grid =}\NormalTok{ grid,p))}
\NormalTok{brca }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{log2ESR1,}\AttributeTok{y=}\NormalTok{log2S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_line}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid,}\AttributeTok{y =}\NormalTok{ lwr),}
\NormalTok{    preddata,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ grid,}\AttributeTok{y =}\NormalTok{ upr),}
\NormalTok{    preddata,}
    \AttributeTok{color=}\StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogLinPred3-1.pdf}

}

\caption{\label{fig-brcaLogLinPred3}Scatterplot voor log2-S100A8
expressie in functie van de log2-ESR1 expressie met model voorspellingen
en 95\(\%\) betrouwbaarheidsintervallen en 95\(\%\)
predictie-intervallen. Rode lijn: predictie interval, grijze band:
betrouwbaarheidsinterval, zwarte lijn: lineair model}
...
standaardafwijking, kunnen we a.d.h.v. de \texttt{lm(.)} functie
...
\begin{itemize}
\item
  Vergelijk referentie-interval voor cholesterolgehalte met predictie
  interval.
\item
  Referentie-interval
\end{itemize}
...
\FunctionTok{library}\NormalTok{(NHANES)}
\NormalTok{fem }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(DirectChol))}

\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{(}
\NormalTok{  fem }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(DirectChol) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mean}\NormalTok{() }\SpecialCharTok{+}
    \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{) }\SpecialCharTok{*}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmChol }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data=}\NormalTok{fem)}
\NormalTok{predInt }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(}
\NormalTok{  lmChol,}
  \AttributeTok{interval=}\StringTok{"prediction"}\NormalTok{,}
  \AttributeTok{newdata=}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{noPred=}\DecValTok{1}\NormalTok{)}
\NormalTok{  )}
\FunctionTok{round}\NormalTok{(}\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{predInt,}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Merk op dat het voorspellingsinterval bijna gelijk is aan het
referentie-interval voor de grote steekproef. We konden de parameters
inderdaad heel precies schatten.
...
\NormalTok{fem10 }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(Gender}\SpecialCharTok{==}\StringTok{"female"}\SpecialCharTok{\&!}\FunctionTok{is.na}\NormalTok{(DirectChol)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{sample\_n}\NormalTok{(}\AttributeTok{size=}\DecValTok{10}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmChol10 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(DirectChol }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{() }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data =}\NormalTok{ fem10)}
\NormalTok{predInt10 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(}
\NormalTok{  lmChol10,}
  \AttributeTok{interval =} \StringTok{"prediction"}\NormalTok{,}
  \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{noPred=}\DecValTok{1}\NormalTok{)}
\NormalTok{  )}
\FunctionTok{round}\NormalTok{(}\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{predInt10, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  Merk op dat het PI nu onzekerheid meeneemt in parameterschatters
  (gemiddelde en standaard error). En dat het interval veel breder
  wordt! Dit is hier vooral belangrijk voor de bovengrens omdat we de
  gegevens terug hebben getransformeerd!
\item
  Het interval is bijna net zo breed als dat gebaseerd op de grote
  steekproef.
\item
  Bij kleine steekproeven is het erg belangrijk om met deze extra
  onzekerheid rekening te houden.
\end{itemize}
...
\item
  ...
  de steekproefvariantie van \(Y\) (zie Sectie \ref{sec-spreiding}).
\end{itemize}
...
\begin{Highlighting}[]
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ log2S100A8, }\AttributeTok{x =}\NormalTok{ log2ESR1)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(log2S100A8))) }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ log2ESR1, }\AttributeTok{xend =}\NormalTok{ log2ESR1, }\AttributeTok{y=}\NormalTok{log2S100A8,}
                   \AttributeTok{yend =}\FunctionTok{mean}\NormalTok{(log2S100A8)), }\AttributeTok{lty =} \DecValTok{2}\NormalTok{, }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"ESR1 expressie (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8 expressie (log2)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogSSTot-1.pdf}

}

\caption{\label{fig-brcaLogSSTot}Interpretatie van de totale
kwadratensom (SSTot): de som van de kwadratische afwijkingen rond het
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lm2\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{log2S100A8 =}\NormalTok{ brca}\SpecialCharTok{$}\NormalTok{log2S100A8, }\AttributeTok{fitted =}\NormalTok{ lm2}\SpecialCharTok{$}\NormalTok{fitted.values, }\AttributeTok{log2ESR1 =}\NormalTok{ brca}\SpecialCharTok{$}\NormalTok{log2ESR1)}
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{ log2ESR1, }\AttributeTok{y =}\NormalTok{ log2S100A8)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{log2ESR1, }\AttributeTok{y =}\NormalTok{lm2}\SpecialCharTok{$}\NormalTok{fitted), }\AttributeTok{pch =} \DecValTok{2}\NormalTok{, }\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{,}\AttributeTok{size=}\FloatTok{0.6}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{)  }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{yintercept =} \FunctionTok{mean}\NormalTok{(log2S100A8))) }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}\AttributeTok{data =}\NormalTok{ lm2\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ log2ESR1, }\AttributeTok{xend =}\NormalTok{ log2ESR1,}
                                  \AttributeTok{y =}\NormalTok{ fitted, }\AttributeTok{yend =}  \FunctionTok{mean}\NormalTok{(log2S100A8)), }\AttributeTok{lty =}\DecValTok{2}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8 expressie (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"ESR1 expressie (log2)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogSSR-1.pdf}

}

\caption{\label{fig-brcaLogSSR}Interpretatie van de kwadratensom van de
regressie (SSR): de som van de kwadratische afwijkingen tussen de
geschatte regressierechte en het steekproefgemiddelde van de
uitkomsten.}
...
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{,}\AttributeTok{size=}\FloatTok{0.6}\NormalTok{, }\AttributeTok{color =} \StringTok{"red"}\NormalTok{)  }\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}\AttributeTok{data =}\NormalTok{ lm2\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ log2ESR1, }\AttributeTok{xend =}\NormalTok{ log2ESR1,}
                                  \AttributeTok{y =}\NormalTok{ fitted, }\AttributeTok{yend =}\NormalTok{  log2S100A8), }\AttributeTok{lty =}\DecValTok{2}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"S100A8 expressie (log2)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"ESR1 expressie (log2)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLogSSE-1.pdf}

}

\caption{\label{fig-brcaLogSSE}Interpretatie van de kwadratensom van de
error (SSE): de som van de kwadratische afwijkingen tussen uitkomsten en
de predicties op de geschatte regressierechte.}
...
deze gelijk is aan nul. Dat valt buiten het bestek van deze cursus. De
...
tussen \(0\) en \(1\). Een waarde gelijk aan 1 geeft aan dat er geen
residuele variatie is rond de regressielijn en dat de uitkomst dus een
perfect lineaire relatie met de predictor vertoont. Analoog impliceert
een \(R^2\) waarde van 0 dat er geen associatie is tussen de uitkomst en
de predictor.
...
een F-verdeling met 1 vrijheidsgraad in de teller en n-2 vrijheidsgraden
in de noemer.
...
met \(\epsilon_i \text{ iid } N(0,\sigma^2)\)\footnote{Merk op dat iid
  staat voor independent and identically distributed of onafhankelijk en
  gelijk verdeeld}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brca}\SpecialCharTok{$}\NormalTok{node}\OtherTok{=}\FunctionTok{as.factor}\NormalTok{(brca}\SpecialCharTok{$}\NormalTok{node)}
\NormalTok{lm3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(age}\SpecialCharTok{\textasciitilde{}}\NormalTok{node,brca)}
\FunctionTok{t.test}\NormalTok{(age }\SpecialCharTok{\textasciitilde{}}\NormalTok{ node, brca, }\AttributeTok{var.equal=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-brcaLymf-1.pdf}

}

\caption{\label{fig-brcaLymf}Diagnostische plot voor het model waarbij
leeftijd wordt gemodelleerd a.d.h.v. een dummy variabele voor factor
lymfe knoop status.}
...
hoofdstuk \ref{sec-chap-besluit} om gelijkheid van variantie na te gaan
bij het uitvoeren van een t-test, zien we dat het verschil in
interkwartiel afstand (IQR, boxgrootes) niet zo groot is (Figuur
\ref{fig-boxNode}). Als we data simuleren die \(iid\) normaal verdeeld
zijn en deze at random opsplitsen in twee groepen die gelijk zijn in
grootte als die voor de lymfeknoop status (19 vs 13 patiënten) zien we
dat een dergelijk verschil in IQR gerust kan voorkomen door toeval
(Figuur \ref{fig-boxSim}). We kunnen dus besluiten dat aan alle aannames
is voldaan voor de statistische besluitvorming en dat we de R-output van
...
\begin{Highlighting}[]
\NormalTok{brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ node}\SpecialCharTok{|\textgreater{}}\FunctionTok{as.factor}\NormalTok{(), }\AttributeTok{y =}\NormalTok{ age)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"node"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-boxNode-1.pdf}

}

\caption{\label{fig-boxNode}boxplot van de leeftijd vs lymfeknoop status
in de borstkanker dataset.}
...
\tightlist
\item
  Simulate 9 datasets with the same number of observations as the brca
  dataset from a normal distribution with the same standard deviation as
  in the original data. Store the data of all simulations in a data
  frame
\item
...
\NormalTok{sim\_df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{node =} \FunctionTok{rep}\NormalTok{(brca}\SpecialCharTok{$}\NormalTok{node, }\DecValTok{9}\NormalTok{),}
  \AttributeTok{iid =} \FunctionTok{rnorm}\NormalTok{(}\DecValTok{9} \SpecialCharTok{*} \FunctionTok{nrow}\NormalTok{(brca), }\AttributeTok{sd =} \FunctionTok{sigma}\NormalTok{(lm3)),}
  \AttributeTok{sim =} \FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{9}\NormalTok{, }\AttributeTok{each =} \DecValTok{32}\NormalTok{)}
\NormalTok{  )}
\NormalTok{sim\_df }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ node, }\AttributeTok{y=}\NormalTok{iid)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(.}\SpecialCharTok{\textasciitilde{}}\NormalTok{sim) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(}\StringTok{"iid N(0,"}\NormalTok{,}\FunctionTok{round}\NormalTok{(}\FunctionTok{sigma}\NormalTok{(lm3)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{),}\StringTok{")"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{06-LineareRegressie_files/figure-pdf/fig-boxSim-1.pdf}

}

\caption{\label{fig-boxSim}Simulatie van normaal verdeelde gegevens met
gelijk gemiddelde en variantie. Zoals in de borstkanker dataset zijn er
19 observaties in ene groep en 13 observaties in de andere groep. We
zien dat er door puur toeval een behoorlijk verschil kan optreden in de
IQR tussen beide groepen in de steekproef.}

\end{figure}%

Zoals we illustreerden is het steeds nuttig om simulaties te gebruiken
om te leren inschatten wanneer de diagnostische plots duiden op een
afwijking van de voorwaarden.

\bookmarksetup{startatroot}

\chapter{Variantie analyse}\label{sec-chap-anova}
...
\tightlist
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJIBVGNQ61zxMgc2srezPpnB}{Kennisclips
  Hoofdstuk 7 Variantie Analyse}
\end{itemize}
...
\tightlist
\item
  \href{https://statomics.github.io/sbc/rmd/07-Anova.html}{script
  Hoofdstuk 7}
\end{itemize}
...
\emph{``completely randomized design'' CRD}. In totaal worden 36 ratten
(experimentele eenheden) at random toegekend aan de drie
behandelingsgroepen (12 ratten per groep). De data is opgeslagen in een
tekst bestand met naam \texttt{prostacyclin.txt} in de folder dataset.
Een boxplot en QQ-plots voor de data in elke groep worden weergegeven in
Figuur \ref{fig-prostBox} en \ref{fig-prostBox2} respectievelijk.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prostacyclin }\OtherTok{\textless{}{-}} \FunctionTok{read\_tsv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/prostacyclin.txt"}\NormalTok{)}

\CommentTok{\#dosis wordt als continue covariaat ingelezen}
\CommentTok{\#zet om naar een factor.}

\NormalTok{prostacyclin }\OtherTok{\textless{}{-}}\NormalTok{ prostacyclin }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{dose =} \FunctionTok{as.factor}\NormalTok{(prostacyclin}\SpecialCharTok{$}\NormalTok{dose))}
\FunctionTok{head}\NormalTok{(prostacyclin)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prostacyclin }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dose, }\AttributeTok{y =}\NormalTok{ prostac, }\AttributeTok{fill =}\NormalTok{ dose)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position =} \StringTok{"jitter"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"prostacyclin (ng/ml)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostBox-1.pdf}

}

\caption{\label{fig-prostBox}Data-exploratie van het prostacycline
niveau bij 36 ratten die behandeld werden met drie verschillende
arachidonzuurconcentraties (12 ratten per behandeling). Boxplots van
...
\begin{Highlighting}[]
\NormalTok{prostacyclin }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample =}\NormalTok{ prostac)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_grid}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{ dose)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostBox2-1.pdf}

}

\caption{\label{fig-prostBox2}Data-exploratie van het prostacycline
niveau bij 36 ratten die behandeld werden met drie verschillende
arachidonzuurconcentraties (12 ratten per behandeling). QQ-plot van
prostacycline voor lage, matige en hoge dosisgroep.}
...
\ref{fig-prostBox2} tonen geen grote afwijkingen aan van Normaliteit. De
...
met \(j= \text{1, 2, 3}\), respectievelijk de lage, matige en hoge
...
en de alternatieve hypothese dat er een effect is van de
arachidonzuurconcentratie op het gemiddelde prostacycline niveau bij
ratten. Dat betekent dat minstens twee gemiddelden verschillend zijn

\[H_1: \exists\ j,k \in \{1,\ldots,g\} : \mu_j\neq\mu_k.\]

Of letterlijk: er bestaat minstens één koppel behandelingsgroepen (j en
k) waarvoor het gemiddelde prostacycline niveau \(\mu_j\) verschillend
is van dat in groep \(k\), \(\mu_k\).
...
\begin{equation}\protect\phantomsection\label{eq-regmu3}{
\begin{aligned}
...
Gezien Model \ref{eq-regmu3} een lineair regressiemodel is, kunnen de
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(prostac }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dose, }\AttributeTok{data =}\NormalTok{ prostacyclin)}
...
\end{eqnarray*} kan nu worden herschreven als \begin{eqnarray*}
...
\ref{eq-regmu3} en een gereduceerd model met enkel een intercept. Deze
...
\pandocbounded{\includegraphics[keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostacSST-1.pdf}}
...
Waarbij SSTot opnieuw de totale variabiliteit voorstelt, met name de som
van de kwadratische afwijking van de uitkomsten \(Y_{i}\) t.o.v. het
algemeen gemiddelde prostacycline niveau \(\bar{Y}\) en SSE de residuele
variabiliteit of de som van de kwadratische afwijkingen tussen de
observaties \(Y_{i}\) en de modelvoorspellingen (hier groepsgemiddelden)
...
\pandocbounded{\includegraphics[keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostacSSTotSSE-1.pdf}}

}

\caption{\label{fig-prostacSSTotSSE}Interpretatie van de totale
kwadratensom (SSTot, som van de kwadratische afwijkingen tussen de
uitkomsten \(Y_{i}\) en het steekproefgemiddelde van de uitkomsten
\(\bar Y\), links) en van residuele kwadratensom (SSE, som van de
kwadratische afwijkingen tussen de uitkomsten \(Y_{i}\) en de
groepsgemiddelden \(\bar Y_j\), rechts)}
...
met \(\text{MST}\) de gemiddelde kwadratensom van de behandeling met
\(g-1\) vrijheidsgraden en \(\text{MSE}\) de gemiddelde residuele
kwadratensom uit het niet-gereduceerde model \ref{eq-regmu3}, deze heeft
\(n-g\) vrijheidsgraden (met het aantal groepen \(g=3\)). De
teststatistiek vergelijkt dus variabiliteit verklaard door het model
(MST) met de residuele variabiliteit (MSE) of met andere woorden
vergelijkt het de variabiliteit tussen groepen (MST) met de
variabiliteit binnen groepen (MSE). Grotere waarden voor de
test-statistiek zijn minder waarschijnlijk onder de nulhypothese.
Wanneer aan alle modelvoorwaarden is voldaan, dan volgt de statistiek
onder de nulhypothese opnieuw een F-verdeling, \(F \sim F_{g-1,n-g}\),
met \(g-1\) vrijheidsgraden in de teller en \(n-g\) vrijheidsgraden in
de noemer.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostacF-1.pdf}

}

\caption{\label{fig-prostacF}Een F-verdeling met 2 vrijheidsgraden in de
teller en 33 in de noemer. Het aanvaardingsgebied wordt weergegeven in
blauw, de kritische waarde en de verwerpingsregio bij het \(\alpha=5\%\)
niveau in rood, en, de geobserveerde f-waarde en de p-waarde worden in
oranje.}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-ftheo-1.pdf}

}

\caption{\label{fig-ftheo}Meerdere F-verdelingen met een verschillend
aantal vrijheidsgraden in de teller en de noemer.}
...
en deze partiële hypotheses te testen met two-sample \(t\)-testen. Voor
het vergelijken van groep \(j\) met groep \(k\) wordt de klassieke
...
met \(S_j^2\) en \(S_k^2\) de steekproefvarianties van respectievelijk
...
De \(t\)-testen voor het twee-aan-twee vergelijken van alle gemiddelden
worden dus best gebaseerd op
...
\NormalTok{  prostacyclin,}
  \FunctionTok{pairwise.t.test}\NormalTok{(prostac, dose, }\StringTok{"none"}\NormalTok{)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
opgaat. 3. Voor iedere gesimuleerde dataset zijn er \(m=3\) paarsgewijze
two-sample \(t\)-testen 4. Zodra minstens één van de \(p\)-waarden
kleiner is dan het significantieniveau \(\alpha=5\%\), wordt de
nulhypothese \(H_0: \mu_1=\mu_2=\mu_3\) verworpen omdat er minstens twee
gemiddelden verschillend zijn volgens de \(t\)-testen. 5. We rapporteren
de relatieve frequentie van het verwerpen van de globale nulhypothese,
meer bepaald de kans op een type I fout van de test voor
\(H_0: \mu_1=\mu_2=\mu_3\).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{g }\OtherTok{\textless{}{-}} \DecValTok{3} \CommentTok{\# aantal behandelingen (g=3)}
\NormalTok{ni }\OtherTok{\textless{}{-}} \DecValTok{12} \CommentTok{\# aantal herhalingen in iedere groep}
\NormalTok{n }\OtherTok{\textless{}{-}}\NormalTok{ g}\SpecialCharTok{*}\NormalTok{ni }\CommentTok{\# totaal aantal observaties}
\NormalTok{alpha }\OtherTok{\textless{}{-}} \FloatTok{0.05} \CommentTok{\# significantieniveau van een individuele test}
\NormalTok{N }\OtherTok{\textless{}{-}} \DecValTok{10000} \CommentTok{\#aantal simulaties}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{302}\NormalTok{) }\CommentTok{\#seed zodat resultaten exact geproduceerd kunnen worden}
\NormalTok{trt }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{g, ni)) }\CommentTok{\#factor}
\NormalTok{cnt }\OtherTok{\textless{}{-}} \DecValTok{0} \CommentTok{\#teller voor aantal foutieve verwerpingen}

\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\NormalTok{N) \{}
\ControlFlowTok{if}\NormalTok{ (i }\SpecialCharTok{\%\%} \DecValTok{1000} \SpecialCharTok{==} \DecValTok{0}\NormalTok{) }\FunctionTok{cat}\NormalTok{(i, }\StringTok{"/"}\NormalTok{, N, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n)}
\NormalTok{tests }\OtherTok{\textless{}{-}} \FunctionTok{pairwise.t.test}\NormalTok{(y, trt, }\StringTok{"none"}\NormalTok{)}
\NormalTok{verwerp }\OtherTok{\textless{}{-}} \FunctionTok{min}\NormalTok{(tests}\SpecialCharTok{$}\NormalTok{p.value, }\AttributeTok{na.rm =}\NormalTok{ T) }\SpecialCharTok{\textless{}}\NormalTok{ alpha}
\ControlFlowTok{if}\NormalTok{(verwerp) cnt }\OtherTok{\textless{}{-}}\NormalTok{ cnt}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cnt}\SpecialCharTok{/}\NormalTok{N}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{model1.mcp }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(model1, }\AttributeTok{linfct =} \FunctionTok{mcp}\NormalTok{(}\AttributeTok{dose =} \StringTok{"Tukey"}\NormalTok{))}
\FunctionTok{summary}\NormalTok{(model1.mcp, }\AttributeTok{test =} \FunctionTok{adjusted}\NormalTok{(}\StringTok{"bonferroni"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{calpha\_bon\_t }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(object, level)}
\NormalTok{\{}
    \FunctionTok{abs}\NormalTok{(}
      \FunctionTok{qt}\NormalTok{(}
\NormalTok{        (}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{level)}\SpecialCharTok{/}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{nrow}\NormalTok{(object}\SpecialCharTok{$}\NormalTok{linfct),}
\NormalTok{        object}\SpecialCharTok{$}\NormalTok{df)}
\NormalTok{      )}
\NormalTok{\}}
\FunctionTok{confint}\NormalTok{(model1.mcp, }\AttributeTok{calpha =}\NormalTok{ calpha\_bon\_t)}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{if}\NormalTok{ (i }\SpecialCharTok{\%\%} \DecValTok{1000} \SpecialCharTok{==} \DecValTok{0}\NormalTok{) }\FunctionTok{cat}\NormalTok{(i, }\StringTok{"/"}\NormalTok{, N, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n)}
\NormalTok{tests }\OtherTok{\textless{}{-}} \FunctionTok{pairwise.t.test}\NormalTok{(y, trt, }\StringTok{"bonferroni"}\NormalTok{)}
\NormalTok{verwerp }\OtherTok{\textless{}{-}} \FunctionTok{min}\NormalTok{(tests}\SpecialCharTok{$}\NormalTok{p.value, }\AttributeTok{na.rm =}\NormalTok{ T) }\SpecialCharTok{\textless{}}\NormalTok{ alpha}
\ControlFlowTok{if}\NormalTok{(verwerp) cnt }\OtherTok{\textless{}{-}}\NormalTok{ cnt}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{\}}
\end{Highlighting}
...
\begin{Highlighting}[]
\NormalTok{model1.mcp }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(model1, }\AttributeTok{linfct =} \FunctionTok{mcp}\NormalTok{(}\AttributeTok{dose =} \StringTok{"Tukey"}\NormalTok{))}
\FunctionTok{summary}\NormalTok{(model1.mcp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confint}\NormalTok{(model1.mcp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model1.mcp }\SpecialCharTok{|\textgreater{}}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{07-VariantieAnalyse_files/figure-pdf/fig-prostacTukey-1.pdf}

}

\caption{\label{fig-prostacTukey}\(95\%\) experimentsgewijze
betrouwbaarheidsintervallen voor de paarsgewijze verschillen in
gemiddeld prostacycline niveau tussen alle arachidonzuur dosisgroepen.
De BIs zijn gecorrigeerd voor multipliciteit via de Tukey methode.}
...
\ControlFlowTok{if}\NormalTok{ (i }\SpecialCharTok{\%\%} \DecValTok{1000} \SpecialCharTok{==} \DecValTok{0}\NormalTok{) }\FunctionTok{cat}\NormalTok{(i, }\StringTok{"/"}\NormalTok{, N, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n)}
\NormalTok{m }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(y }\SpecialCharTok{\textasciitilde{}}\NormalTok{ trt)}
\NormalTok{m.mcp }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(m, }\AttributeTok{linfct =} \FunctionTok{mcp}\NormalTok{(}\AttributeTok{trt =} \StringTok{"Tukey"}\NormalTok{))}
\NormalTok{tests }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(m.mcp)}\SpecialCharTok{$}\NormalTok{test}
\NormalTok{verwerp }\OtherTok{\textless{}{-}} \FunctionTok{min}\NormalTok{(}
  \FunctionTok{as.numeric}\NormalTok{(tests}\SpecialCharTok{$}\NormalTok{pvalues),}
  \AttributeTok{na.rm=}\NormalTok{T) }\SpecialCharTok{\textless{}}\NormalTok{ alpha}
\ControlFlowTok{if}\NormalTok{(verwerp) cnt }\OtherTok{\textless{}{-}}\NormalTok{ cnt}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
We vinden dus een FWER van \(5.03\%\) wat heel dicht bij het nominale
...
voorbeeld. Merk op dat we steeds eerst een anova analyse doen voordat
...
We kunnen dus concluderen dat er een extreem significant effect is van
...
concentratie is hoger bij de hoge arachidonzuur dosisgroep dan bij de
...
\tightlist
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJJyR4mqLOxDwwOzysbhaFm1}{Kennisclips
...
\tightlist
\item
  \href{https://statomics.github.io/sbc/rmd/08-NonparametericStatistics.html}{script
  Hoofdstuk 8}
\end{itemize}
...
In een studie werd de cholesterolconcentratie in het bloed gemeten bij 5
...
cholesterolconcentratie verschillend is bij hartpatiënten en gezonde
personen. Boxplots en qqplots van de data worden weergegeven in Figuur
\ref{fig-cholBox} en \ref{fig-cholQQ}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chol }\OtherTok{\textless{}{-}} \FunctionTok{read\_tsv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/chol.txt"}\NormalTok{)}

\NormalTok{chol }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(group))}

\NormalTok{nGroups }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(group) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{table}\NormalTok{()}

\NormalTok{n }\OtherTok{\textless{}{-}}\NormalTok{ nGroups }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chol }\SpecialCharTok{|\textgreater{}}  
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{group,}\AttributeTok{y=}\NormalTok{cholest)) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position=}\StringTok{"jitter"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{08-NietParametrischeStatistiek_files/figure-pdf/fig-cholBox-1.pdf}

}

\caption{\label{fig-cholBox}Boxplot van de cholesterol concentratie in
het bloed bij hartpatiënten (groep 1) en gezonde individuen (groep 2).}

\end{figure}%

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chol }\SpecialCharTok{|\textgreater{}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{cholest)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{08-NietParametrischeStatistiek_files/figure-pdf/fig-cholQQ-1.pdf}

}

\caption{\label{fig-cholQQ}Qqplot van de cholesterol concentratie in het
bloed bij hartpatiënten (groep 1) en gezonde individuen (groep 2).}

\end{figure}%

De boxplots en qqplots geven aan dat er mogelijks outliers in de data
voorkomen. Het is moeilijk om inzicht te krijgen in de verdeling van de
data gezien we maar 5 observaties hebben per groep.

\subsection{Permutatietesten}\label{permutatietesten}

De vraagstelling van het cholesterol voorbeeld is geformuleerd in erg
...
\begin{equation}\protect\phantomsection\label{eq-H0F1F2}{
...
met \(\Delta=\mu_1-\mu_2\), verder hebben de Normale verdelingen
dezelfde variantie.
...
\NormalTok{mu2 }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{sigma2 }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{y }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\DecValTok{2}\SpecialCharTok{:}\DecValTok{2}
\NormalTok{delta }\OtherTok{\textless{}{-}}\NormalTok{ mu1 }\SpecialCharTok{{-}}\NormalTok{ mu2}
\NormalTok{delta}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dnorm}\NormalTok{(y, mu1, sigma1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{dnorm}\NormalTok{(y }\SpecialCharTok{{-}}\NormalTok{ delta, mu2, sigma2)}
\end{Highlighting}
\end{Shaded}
...
gebruikt worden voor het testen van de hypothese \ref{eq-H0F1F2}, maar
dan zonder de Normaliteitsveronderstelling.

We schrijven hypothese \ref{eq-H0F1F2} verkort als

\[H_0: F_1=F_2 \;\;\;\text{ of }\;\;\; H_0:f_1=f_2.\]

Als de nulhypothese waar is, met name dat de verdelingen van de
cholesterolconcentraties gelijk zijn voor hartpatiënten en gezonde
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{G }\OtherTok{\textless{}{-}} \FunctionTok{combn}\NormalTok{(n,nGroups[}\DecValTok{1}\NormalTok{])}
\FunctionTok{dim}\NormalTok{(G)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{G[,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{tOrig}\OtherTok{=}\FunctionTok{t.test}\NormalTok{(cholest}\SpecialCharTok{\textasciitilde{}}\NormalTok{group,chol)}\SpecialCharTok{$}\NormalTok{statistic}
\CommentTok{\#bereken alle permutatiecombinaties en voer voor}
\CommentTok{\#elke combinantie een functie uit die de t{-}test statistiek}
\CommentTok{\#berekent voor de gepermuteerde groepslabels}
\NormalTok{tOrig }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(cholest }\SpecialCharTok{\textasciitilde{}}\NormalTok{ group, chol)}\SpecialCharTok{$}\NormalTok{statistic}
\NormalTok{tOrig}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tStar }\OtherTok{\textless{}{-}} \FunctionTok{combn}\NormalTok{(}
\NormalTok{  n,}
\NormalTok{  nGroups[}\DecValTok{1}\NormalTok{],}
    \ControlFlowTok{function}\NormalTok{(g,y) \{}
    \FunctionTok{t.test}\NormalTok{(y[g],y[}\SpecialCharTok{{-}}\NormalTok{g])}\SpecialCharTok{$}\NormalTok{statistic}
\NormalTok{    \},}
  \AttributeTok{y =}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}} \FunctionTok{pull}\NormalTok{(cholest)}
\NormalTok{  )}
\FunctionTok{head}\NormalTok{(tStar)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{length}\NormalTok{(tStar)}
\end{Highlighting}
\end{Shaded}
...
We kunnen nu de verdeling van de teststatistiek onder \(H_0\)
bestuderen.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{qplot}\NormalTok{(tStar,}\AttributeTok{bins=}\DecValTok{50}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\FunctionTok{expression}\NormalTok{(}\StringTok{"permutatiestatistiek t"}\SpecialCharTok{\^{}}\StringTok{"*"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept=}\NormalTok{tOrig,}\AttributeTok{col=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{08-NietParametrischeStatistiek_files/figure-pdf/fig-tPermDist-1.pdf}

}

\caption{\label{fig-tPermDist}Exacte permutatie nuldistributie van de
Welch t-test voor het cholesterol voorbeeld. Bovenaan histogram van elke
mogelijke waarde voor de test-statistiek. Onderaan een gewoon histogram
met balkbreedtes gelijk aan 1. De geobserveerde waarde voor de
test-statistiek is aangeduid met een rode verticale lijn.}

\end{figure}%

Het histogram (Figuur \ref{fig-tPermDist}) bevat alle informatie voor de
permutatienuldistributie van de two-sample \(t\)-teststatistiek voor de
geobserveerde uitkomsten; merk op dat er 252 unieke waarden van de
teststatistiek berekend zijn.\\
...
\subsubsection{p-waarde}\label{p-waarde-1}
...
cholesterolwaarden die weergegeven worden in de vector
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pval }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(}\FunctionTok{abs}\NormalTok{(tStar)}\SpecialCharTok{\textgreater{}=}\FunctionTok{abs}\NormalTok{(tOrig))}
\NormalTok{pval}
\end{Highlighting}
\end{Shaded}
...
de cholesterol concentraties niet gelijk zijn bij hartpatiënten en bij
...
permutaties uit te voeren.

\subsubsection{Hoe kunnen we conclusie
interpreteren}\label{hoe-kunnen-we-conclusie-interpreteren}

We permuteren immers t statistiek. De effectgrootte in de t-test is de
locatie-shift.

Als locatie-shift model niet opgaat is een significant resultaat
moeilijk te interpreteren. Het is dan immers niet duidelijk tegenover
welk alternatief we dan testen.
...
steekproefgroottes. Bovendien zal blijken dat de testen erg robuust zijn
...
Beschouw \(Y_1, \ldots, Y_n\). We veronderstellen voorlopig dat er geen
twee gelijke observaties voorkomen (i.e.~geen \emph{ties}). De rank van
observatie \(Y_i\) wordt dan gedefinieerd als
...
De rank transformatie wordt geïllustreerd op basis van het cholesterol
voorbeeld.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(cholest)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(cholest) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rank}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{metTies }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{403}\NormalTok{, }\DecValTok{507}\NormalTok{, }\DecValTok{507}\NormalTok{, }\DecValTok{610}\NormalTok{, }\DecValTok{651}\NormalTok{, }\DecValTok{651}\NormalTok{, }\DecValTok{651}\NormalTok{, }\DecValTok{830}\NormalTok{, }\DecValTok{900}\NormalTok{)}
\NormalTok{metTies }\SpecialCharTok{|\textgreater{}} \FunctionTok{rank}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{definition}[Midrank]\protect\hypertarget{def-midrank}{}\label{def-midrank}

~

\end{definition}

Beschouw \(Y_1, \ldots, Y_n\). De \textbf{midrank} van observatie
\(Y_i\) wordt dan gedefinieerd als
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{z }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(cholest)}
\NormalTok{z}
\end{Highlighting}
\end{Shaded}
...
\ref{eq-H0F1F2} tegenover het alternatief \(H_1: \mu_1\neq \mu_2\) (of
...
als teststatistiek te beschouwen. \(S_1\) is de som van de ranks van de
observaties uit de eerste behandelingsgroep; dit verklaart de naam
\emph{rank sum test}.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{wilcox.test}\NormalTok{(cholest }\SpecialCharTok{\textasciitilde{}}\NormalTok{ group, }\AttributeTok{data =}\NormalTok{ chol)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{S1 }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{cholRank=}\FunctionTok{rank}\NormalTok{(cholest)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(group}\SpecialCharTok{==}\DecValTok{1}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(cholRank) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{sum}\NormalTok{()}

\NormalTok{S2 }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{cholRank =} \FunctionTok{rank}\NormalTok{(cholest)) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y1 }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(group}\SpecialCharTok{==}\DecValTok{1}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(}\StringTok{"cholest"}\NormalTok{)}

\NormalTok{y2 }\OtherTok{\textless{}{-}}\NormalTok{ chol }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{filter}\NormalTok{(group}\SpecialCharTok{==}\DecValTok{2}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{pull}\NormalTok{(}\StringTok{"cholest"}\NormalTok{)}

\NormalTok{u1Hlp }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}
\NormalTok{  y1,}
  \ControlFlowTok{function}\NormalTok{(y1i,y2) \{y1i}\SpecialCharTok{\textgreater{}=}\NormalTok{y2\},}
  \AttributeTok{y2=}\NormalTok{y2)}

\FunctionTok{colnames}\NormalTok{(u1Hlp) }\OtherTok{\textless{}{-}}\NormalTok{ y1}
\FunctionTok{rownames}\NormalTok{(u1Hlp) }\OtherTok{\textless{}{-}}\NormalTok{ y2}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{U1 }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(u1Hlp)}
\NormalTok{U1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{S1}\SpecialCharTok{{-}}\NormalTok{nGroups[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{(nGroups[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{+}\DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\DecValTok{2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mean}\NormalTok{(u1Hlp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{U1}\SpecialCharTok{/}\NormalTok{(nGroups[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{*}\NormalTok{nGroups[}\DecValTok{2}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wTest }\OtherTok{\textless{}{-}} \FunctionTok{wilcox.test}\NormalTok{(cholest}\SpecialCharTok{\textasciitilde{}}\NormalTok{group, }\AttributeTok{data =}\NormalTok{ chol)}
\NormalTok{wTest}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{probInd }\OtherTok{\textless{}{-}}\NormalTok{ wTest}\SpecialCharTok{$}\NormalTok{statistic}\SpecialCharTok{/}\FunctionTok{prod}\NormalTok{(nGroups)}
\NormalTok{probInd}
\end{Highlighting}
\end{Shaded}
...
significantieniveau dat de gemiddelde cholesterolconcentratie groter is
...
cholesterolwaarde van hartpatiënten met een kans van
...
cholesterolconcentraties bij hartpatiënten 2 dagen na hun hartaanval en
gezonde individuen (\(p=\) 0.0159). Het is meer waarschijnlijk om hogere
cholesterolconcentraties te observeren bij hartpatiënten dan bij gezonde
...
Nieuwe (en bestaande) chemische substanties moeten getest worden op
genotoxiciteit. De resultaten van genotoxiciteitstesten vormen de basis
voor risico-analyses en de classificatie en labeling van chemische
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dna }\OtherTok{\textless{}{-}} \FunctionTok{read\_delim}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/dna.txt"}\NormalTok{,}\AttributeTok{delim=}\StringTok{" "}\NormalTok{)}

\NormalTok{dna }\OtherTok{\textless{}{-}}\NormalTok{ dna }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{dose =} \FunctionTok{as.factor}\NormalTok{(dna}\SpecialCharTok{$}\NormalTok{dose))}
\NormalTok{dna}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dna }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{dose,}\AttributeTok{y=}\NormalTok{length,}\AttributeTok{fill=}\NormalTok{dose))}\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{position=}\StringTok{"jitter"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{08-NietParametrischeStatistiek_files/figure-pdf/fig-dnaBox-1.pdf}

}

\caption{\label{fig-dnaBox}Boxplot van de comet staart lengte in functie
van de DMH dosis.}
...
\begin{Highlighting}[]
\NormalTok{dna }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample=}\NormalTok{length)) }\SpecialCharTok{+}
  \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{dose)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{08-NietParametrischeStatistiek_files/figure-pdf/fig-dnaQQ-1.pdf}

}

\caption{\label{fig-dnaQQ}QQ-plots van de comet staart lengte per DMH
dosis.}
...
De Kruskal-Wallis Rank Test (KW-test) is een niet-parametrisch
...
\(\text{SST}=\sum_{j=1}^g n_j(\bar{Y}_j-\bar{Y})^2\).
...
De factor \(\frac{12}{n(n+1)}\) zorgt ervoor dat \(KW\) een eenvoudige
asymptotische nuldistributie heeft. In het bijzonder, onder \(H_0\), als
\(\min(n_1,\ldots, n_g)\rightarrow \infty\),
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{kruskal.test}\NormalTok{(length }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dose, }\AttributeTok{data =}\NormalTok{ dna)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{kwPerm }\OtherTok{\textless{}{-}} \FunctionTok{kruskal\_test}\NormalTok{(length }\SpecialCharTok{\textasciitilde{}}\NormalTok{ dose, }\AttributeTok{data =}\NormalTok{ dna,}
            \AttributeTok{distribution =} \FunctionTok{approximate}\NormalTok{(}\AttributeTok{nresample =} \DecValTok{100000}\NormalTok{))}
\NormalTok{kwPerm}
\end{Highlighting}
\end{Shaded}
...
chi-squared = 14, p-value = 0.00033
\end{verbatim}

We kunnen besluiten dat er een extreem significant verschil is in
distributie van de DNA schade ten gevolge van de dosis.

\subsubsection{Posthoc Analyse}\label{posthoc-analyse}

We vragen ons nu uiteraard af welke groepen verschillend zijn. Hiervoor
dienen we een posthoc analyse uit te voeren met paarsgewijze
...
\tightlist
\item
  Dat is eigenlijk suboptimaal na KW-test want de data worden opnieuw
  gerangschikt!
\item
...
We voeren nu verdere posthoc testen uit voor alle paarsgewijse
verschillen a.d.h.v WMW testen.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pairWilcox }\OtherTok{\textless{}{-}} \FunctionTok{pairwise.wilcox.test}\NormalTok{(dna}\SpecialCharTok{$}\NormalTok{length, dna}\SpecialCharTok{$}\NormalTok{dose)}
...
De output geeft paarsgewijze p-waarden weer voor elke vergelijking. De
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nGroep }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(dna}\SpecialCharTok{$}\NormalTok{dose)}

\NormalTok{probInd }\OtherTok{\textless{}{-}} \FunctionTok{combn}\NormalTok{(}
  \FunctionTok{levels}\NormalTok{(dna}\SpecialCharTok{$}\NormalTok{dose),}
  \DecValTok{2}\NormalTok{,}
  \ControlFlowTok{function}\NormalTok{(x) \{}
\NormalTok{         test }\OtherTok{\textless{}{-}} \FunctionTok{wilcox.test}\NormalTok{(}
\NormalTok{       length}\SpecialCharTok{\textasciitilde{}}\NormalTok{dose,}
\NormalTok{       dna }\SpecialCharTok{|\textgreater{}} \FunctionTok{filter}\NormalTok{(dose}\SpecialCharTok{\%in\%}\NormalTok{x)}
\NormalTok{       )}
         \FunctionTok{return}\NormalTok{(test}\SpecialCharTok{$}\NormalTok{statistic}\SpecialCharTok{/}\FunctionTok{prod}\NormalTok{(nGroep[x]))}
\NormalTok{    \})}

\FunctionTok{names}\NormalTok{(probInd) }\OtherTok{\textless{}{-}} \FunctionTok{combn}\NormalTok{(}
\NormalTok{  dna }\SpecialCharTok{|\textgreater{}} \FunctionTok{pull}\NormalTok{(dose) }\SpecialCharTok{|\textgreater{}} \FunctionTok{levels}\NormalTok{(),}
  \DecValTok{2}\NormalTok{,}
\NormalTok{  paste,}
  \AttributeTok{collapse=}\StringTok{"vs"}\NormalTok{)}
...
distributies van de comet-lengtes tussen de DMH behandelingen onderling
...
\chapter{Categorische data analyse}\label{sec-chap-categorisch}
...
\tightlist
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJJnNyz6IMPqq6fCMZJ63y8x}{Kennisclips
  Hoofdstuk 9 Categorische Data Analyse}
\end{itemize}
...
\tightlist
\item
  \href{https://statomics.github.io/sbc/rmd/09-categoricalDataAnalysis.html}{script
  Hoofdstuk 9}
\end{itemize}
...
in Sectie \ref{sec-kruistabel} hebben gezien zijn \emph{kruistabellen}
aangewezen om hun associatie voor te stellen.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boys }\OtherTok{\textless{}{-}} \DecValTok{3175}
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{6155}
\end{Highlighting}
\end{Shaded}
...
een Bernoulli verdeling:

\[X_i \sim B(\pi) \text{ met}\]

\[B(\pi)=\pi^{X_i}(1-\pi)^{(1-X_i)},\]

een distributie met 1 model parameter \(\pi\). \(\pi\) is de verwachte
waarde van \(X_i\):

\[\text{E}[X_i]=\pi,\]

de proportie van ongeboren jongens (d.i. kinderen met een 1) in de
populatie. Bijgevolg is \(\pi\) ook de kans dat een lukraak getrokken
individu een jongen is (een observatie die 1 oplevert).
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-bernoulli-1.pdf}

}

\caption{\label{fig-bernoulli}Bernoulli verdelingen.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pi }\OtherTok{\textless{}{-}}\NormalTok{ boys}\SpecialCharTok{/}\NormalTok{n}
\NormalTok{pi}
\end{Highlighting}
\end{Shaded}
...
te toetsen of de kans \(\pi\) al dan niet gelijk is aan 50\%.

We zullen die vraag eerst beantwoorden met een asymptotisch
betrouwbaarheidsinterval, vervolgens ontwikkelen we een asymptotische
test en een exacte test die ook geldig is in kleine steekproeven.

\subsection{Asymptotisch
Betrouwbaarheidsinterval}\label{asymptotisch-betrouwbaarheidsinterval}

In de Saksenstudie werd een heel grote steekproef getrokken: 6155
onafhankelijke observaties uit dezelfde populatie (verdeling).

We kunnen dus de centrale limietstelling (CLT) toegepassen op
gemiddelde: de data volgen een Bernoulli verdeling, maar gemiddelde
o.b.v. onafhankelijke en identiek verdeelde observaties in heel grote
steekproef volgt approximatief een normaal verdeling.
...
Uit de steekproef weten we verder dat \(\bar x\) = 0.516 en kunnen we de
standard error schatten:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{se }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{((pi}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{pi))}\SpecialCharTok{/}\NormalTok{n)}
\end{Highlighting}
\end{Shaded}
...
En we bekomen volgend betrouwbaarheidsinterval (BI) op het gemiddelde:
{[}0.503, 0.528{]}

\[[\bar x - z_{\alpha/2} \text{SE}_{\bar x}, \bar x + z_{\alpha/2} \text{SE}_{\bar x}]\]

0.5 valt niet binnen het 95\% BI. Uit de equivalentie tussen
betrouwbaarheidsintervallen en statistische testen volgt dus dat de kans
op een jongen significant hoger is dan 50\% op het 5\%
significantie-niveau.

\subsection{Asymptotische Test}\label{asymptotische-test}

Voor een statistische test moeten we de onderzoeksvraag vertalen naar
een nul en alternatieve hypothese in termen van een modelparameter. We
wensen aan te tonen dat de kans \(\pi\) verschillend is van 50\%
(alternatieve hypothese). Daarom zullen we de nul hupothese falsifiëren
dat \(\pi = 0.5\).

\[H_0: \pi = 0.5 \text{ vs } H_1: \pi \neq 0.5\]

Merk op dat voor een Bernoulli verdeling de variantie onder H\(_0\) ook
gekend is: \(\pi_0 (1-\pi_0)\).

Dus onder \(H_0\) is standaard error op \(\bar x\):

\[\text{SE}_{0, \bar x}=\sqrt{\frac{\pi_0 (1-\pi_0)}{n}}\]

We kunnen onder de nulhypothese dus volgende statistiek gebruiken die
een afwijking van de nulhypothese in de richting van het alternatief zal
detecteren.
...
\begin{itemize}
\item
  Onder \(H_0\) verwachten we z dicht bij 0. Onder \(H_1\) zal z
  verschuiven naar negatieve (\(\pi < \pi_0\))of positieve waarden
  (\(\pi>\pi_0\)).
\item
  z volgt onder de nulhypothese dat er evenveel kans is op een jongen of
  een meisje (\(\pi_0=0.5\)) asymptotisch een standaard normaal
  verdeling: we kunnen immers de CLT toepassen!
\end{itemize}

We kunnen eenvoudig een p-waarde bekomen door gebruik te maken van de
cumulatieve distributie van een standaard normale verdeling. Merk op dat
het een tweezijdige test is!

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pi0 }\OtherTok{\textless{}{-}} \FloatTok{0.5}
\NormalTok{se0 }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(pi0}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{pi0)}\SpecialCharTok{/}\NormalTok{n)}
\NormalTok{z }\OtherTok{\textless{}{-}}\NormalTok{ (pi}\SpecialCharTok{{-}}\NormalTok{pi0)}\SpecialCharTok{/}\NormalTok{se0}
\NormalTok{z}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pval }\OtherTok{\textless{}{-}} \FunctionTok{pnorm}\NormalTok{(}\FunctionTok{abs}\NormalTok{(z),}\AttributeTok{lower=}\ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{*}\DecValTok{2}
\NormalTok{pval}
\end{Highlighting}
\end{Shaded}
...
We besluiten dus dat er significant meer kans is dat een ongeboren kind
mannelijk dan vrouwelijk is (p=0.013). De kans dat een ongeboren kind
mannelijk is bedraagt 0.516 (95\% BI {[}0.503, 0.528{]}).

\subsection{Binomiale test}\label{sec-binom}

Om een toets te kunnen construeren van de nulhypothese dat

\[H_0: \pi=1/2 \text{ versus } H_1: \pi\neq 1/2,\]

moeten we de verdeling van de gegevens \(X\) en van de schatter voor de
proportie, \(\hat \pi = \bar X\) (of equivalent de som \(S=n\bar X\))
kennen.
...
\begin{equation}\protect\phantomsection\label{eq-binomk}{
P(S=k) = \left (
\begin{array}{c}
n \\
k \\
...
(uitkomst met 0 genoteerd) en \(\left(\begin{array}{c}
n \\
k \\
\end{array}\right)\) de binomiaalcoëfficient\footnote{Wees voorzichtig
  als je een binomiaalcoëfficient met een zakrekenmachine berekent.
  Teller en noemer kunnen snel zeer groot worden. Om (afrondings)fouten
  te vermijden moet men de uitdrukking eerst zoveel mogelijk
  vereenvoudigen.}
...
\ref{eq-binomk} noemt men een \emph{Binomiaal verdeelde
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-binoms-1.pdf}

}

\caption{\label{fig-binoms}Binomiale verdelingen.}

\end{figure}%

Om nu te toetsen of \(\pi=1/2\) versus het alternatief dat
\(\pi\neq 1/2\), is een voor de hand liggende toetsstatistiek
\(\bar X-1/2\) of, equivalent, \(\Delta=n(\bar
...
\begin{Highlighting}[]
\NormalTok{pi0 }\OtherTok{\textless{}{-}} \FloatTok{0.5}
\NormalTok{s0 }\OtherTok{\textless{}{-}}\NormalTok{ pi0 }\SpecialCharTok{*}\NormalTok{n}
\NormalTok{delta }\OtherTok{\textless{}{-}} \FunctionTok{abs}\NormalTok{(boys}\SpecialCharTok{{-}}\NormalTok{ s0)}
\NormalTok{delta}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sUp }\OtherTok{\textless{}{-}}\NormalTok{ s0 }\SpecialCharTok{+}\NormalTok{ delta}
\NormalTok{sDown }\OtherTok{\textless{}{-}}\NormalTok{ s0 }\SpecialCharTok{{-}}\NormalTok{delta}
\FunctionTok{c}\NormalTok{(sDown,sUp)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#pbinom(sUp{-}1,n,pi) gebruiken omdat we met}
\CommentTok{\#pbinom de kans berekenen in de linkse staart}
\CommentTok{\#anders wordt s=3175 er niet bij geteld!}
\NormalTok{pUp }\OtherTok{\textless{}{-}} \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{pbinom}\NormalTok{(sUp}\DecValTok{{-}1}\NormalTok{, n, pi0)}
\NormalTok{pUp}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pDown }\OtherTok{\textless{}{-}} \FunctionTok{pbinom}\NormalTok{(sDown, n, pi0)}
\NormalTok{pDown}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ pUp}\SpecialCharTok{+}\NormalTok{pDown}
\NormalTok{p}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-pitests-1.pdf}

}

\caption{\label{fig-pitests}Binomiale verdeling van het aantal jongens S
onder \(H_0: \pi=0.5 (n=6155)\).}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{binom.test}\NormalTok{(}\AttributeTok{x =}\NormalTok{ boys, }\AttributeTok{n =}\NormalTok{ n, }\AttributeTok{p =}\NormalTok{ pi0)}
\end{Highlighting}
\end{Shaded}
...
Op het 5\% significantie-niveau besluiten we dat er meer kans is dat een
ongeboren kind mannelijk dan vrouwelijk is.

Voor de Saksen-studie ligt het BI op basis van de CLT heel dicht bij het
exacte BI omdat de studie is gebaseerd op een grote steekproef (\(n=\)
6155).
...
\item
  Voor Saksen-studie ligt BI o.b.v. CLT heel dicht bij exacte BI: grote
  steekproef (\(n=\) 6155).
\end{itemize}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-hamsterKooi-1.pdf}

}

\caption{\label{fig-hamsterKooi}Experimentele opstelling voor het
bepalen van de partnerkeuze bij dwerghamsters}
...
kruistabel (Tabel \ref{tbl-catHamster}).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hamster }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{17}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{13}\NormalTok{),}\AttributeTok{ncol=}\DecValTok{2}\NormalTok{,}\AttributeTok{byrow=}\ConstantTok{TRUE}\NormalTok{)}
\FunctionTok{rownames}\NormalTok{(hamster) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"vijandig{-}agressief"}\NormalTok{, }\StringTok{"vijandig{-}niet{-}agressief"}\NormalTok{)}
\FunctionTok{colnames}\NormalTok{(hamster) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"vriendelijk{-}agressief"}\NormalTok{,}\StringTok{"vriendelijk{-}niet{-}agressief"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{table}

\caption{\label{tbl-catHamster}}

\centering{

\caption{\label{tab:tbl-catHamster}Kruistabel van partnerkeuze bij dwerghamster.}
\centering
\begin{tabular}[t]{llll}
\toprule
...
\(g\)\footnote{Indien de partnerkeuze niet geassocieerd zou zijn met de
  omgeving, verwachten we dat deze kansen (\(\pi_1\) en \(\pi_0\))
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f }\OtherTok{\textless{}{-}}\NormalTok{ hamster[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]}
\NormalTok{g }\OtherTok{\textless{}{-}}\NormalTok{ hamster[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{]}
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(hamster)}
\NormalTok{riskdiff }\OtherTok{\textless{}{-}}\NormalTok{ (f}\SpecialCharTok{{-}}\NormalTok{g)}\SpecialCharTok{/}\NormalTok{n}
\NormalTok{riskdiff}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{se }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(f}\SpecialCharTok{+}\NormalTok{g}\SpecialCharTok{{-}}\NormalTok{(f}\SpecialCharTok{{-}}\NormalTok{g)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\NormalTok{n)}\SpecialCharTok{/}\NormalTok{n}
\NormalTok{se}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bi }\OtherTok{\textless{}{-}}\NormalTok{ riskdiff }\SpecialCharTok{+} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\SpecialCharTok{*}\NormalTok{se}
\NormalTok{bi}
\end{Highlighting}
\end{Shaded}
...
Normale benadering is goed als

\[f \times g/(f+g) \geq 5\]

De toets gebaseerd op bovenstaande toetsingsgrootheid heet de \emph{Mc
Nemar toets}.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{correct }\OtherTok{\textless{}{-}}\NormalTok{ f}\SpecialCharTok{*}\NormalTok{g}\SpecialCharTok{/}\NormalTok{(f}\SpecialCharTok{+}\NormalTok{g)}
\NormalTok{correct}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{z }\OtherTok{\textless{}{-}}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(f}\SpecialCharTok{{-}}\NormalTok{g)}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(f}\SpecialCharTok{+}\NormalTok{g)}
\NormalTok{z}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mcnemar.test}\NormalTok{(hamster)}
\end{Highlighting}
\end{Shaded}
...
p-waarde is om die reden niet accuraat.

Het is steeds meer aangewezen om een exacte toets te gebruiken op basis
van het principe in Sectie \ref{sec-binom}. Dergelijke toetsen maken
gebruik van de exacte Binomiale verdeling van de gegevens om te toetsen
of de kans dat een lukraak discordant paar in de cel rechtsboven van de
tabel gelegen is, 0.5 bedraagt.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{binom.test}\NormalTok{(}\AttributeTok{x =}\NormalTok{ f,}
  \AttributeTok{n =}\NormalTok{ f }\SpecialCharTok{+}\NormalTok{ g,}
...
\subsection{Ongepaarde gegevens}\label{sec-catOnPaired}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brca }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statOmics/sbc/master/data/brca.csv"}\NormalTok{)}
...
\begin{verbatim}
 ...
 Max.nchar:   7   Max.nchar:   7   Max.nchar:   7  
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brcaTab }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(brca}\SpecialCharTok{$}\NormalTok{variant,brca}\SpecialCharTok{$}\NormalTok{cancer)}
\NormalTok{brcaTab}
\end{Highlighting}
\end{Shaded}
...
en staat opnieuw getabuleerd in Tabel \ref{tbl-leu3}.

\begin{table}

\caption{\label{tbl-leu3}}

\centering{

\caption{\label{tab:tbl-leu3}Kruistabel van borstkanker-status versus BRCA1-allel.}
\centering
\begin{tabular}[t]{llll}
\toprule
Genotype & Controles & Cases & Totaal\\
...
In Sectie \ref{sec-retrospect} zagen we reeds dat \emph{het relatief
...
in de studie die niet homozygoot zijn in de mutatie\footnote{heterozygoot
  Pro/Leu of homozygoot Pro/Pro} (Tabel \ref{tbl-leu4}).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brcaTab2 }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(brca}\SpecialCharTok{$}\NormalTok{variant2, brca}\SpecialCharTok{$}\NormalTok{cancer)}
\NormalTok{brcaTab2}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{tbl-leu4}}

\centering{

\caption{\label{tab:tbl-leu4}Kruistabel van borstkanker-status versus Leu/Leu-variant.}
\centering
\begin{tabular}[t]{llll}
\toprule
Genotype & Controles & Cases & Totaal\\
...
\begin{itemize}
\item
  \(E_{11}\) = het verwachte aantal onder \(H_0\) in de (1,1)-cel = 145
  \(\times\) 800/1372 = 84.55 ;
\item
  \(E_{12}\) = het verwachte aantal onder \(H_0\) in de (1,2)-cel = 145
  \(\times\) 572/1372 = 60.45 ;
\item
  \(E_{21}\) = het verwachte aantal onder \(H_0\) in de (2,1)-cel = 1227
  \(\times\) 800/1372 = 715.5 ;
\item
  \(E_{22}\) = het verwachte aantal onder \(H_0\) in de (2,2)-cel = 1227
  \(\times\) 572/1372 = 511.5 ;
\end{itemize}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-chidist-1.pdf}

}

\caption{\label{fig-chidist}Dichtheidsfuncties voor enkele Chi-kwadraat
verdelingen}
...
\(100\%(1-\alpha)\)-percentiel, \(\chi^2_{1,
\alpha}\), van de \(\chi^2_1\)-verdeling overschrijdt. Ze kan niet
verwerpen in het andere geval. De p-waarde voor een 2-zijdige toets is
in dit geval de kans om een grotere waarde voor de toetsingsgrootheid te
observeren dan de geobserveerde waarde \(x^2\) als de nulhypothese waar
is. Dit is de kans dat een \(\chi^2_1\)-verdeelde toevalsveranderlijke
waarden groter dan \(x^2\) aanneemt.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{expected }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\DecValTok{0}\NormalTok{, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{ncol =} \DecValTok{2}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{)}
    \ControlFlowTok{for}\NormalTok{ (j }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{)}
\NormalTok{        expected[i,j] }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(brcaTab2[i,]) }\SpecialCharTok{*} \FunctionTok{sum}\NormalTok{(brcaTab2[,j]) }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(brcaTab2)}
\NormalTok{expected}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x2 }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((}\FunctionTok{abs}\NormalTok{(brcaTab2 }\SpecialCharTok{{-}}\NormalTok{ expected) }\SpecialCharTok{{-}}\NormalTok{ .}\DecValTok{5}\NormalTok{)}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/}\NormalTok{ expected)}
\DecValTok{1}\SpecialCharTok{{-}}\FunctionTok{pchisq}\NormalTok{(x2, }\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(brcaTab2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(brcaTab2, }\AttributeTok{correct =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fisher.test}\NormalTok{(brcaTab2)}
\end{Highlighting}
\end{Shaded}
...
\((r-1) \times
(c-1)\) vrijheidsgraden als de nulhypothese waar is. De
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{chisq.test}\NormalTok{(brcaTab)}
\end{Highlighting}
\end{Shaded}
...
uit Tabel \ref{tbl-leu3}. De toetsingsgrootheid bedraagt nu 2.055 en
...
\ref{sec-chap-linReg}, \ref{sec-chap-anova} en \ref{sec-chap-glm}, laten
logistische regressie modellen toe om binaire gegevens te modelleren
a.d.h.v. continue en/of dummy variabelen.
...
het krijgen van borstkanker (zie Sectie \ref{sec-catOnPaired}).
...
\tightlist
\item
  Merk op dat we functie \texttt{as.factor} gebruiken om de cancer
  variabele om te zetten naar een factor.
\item
  en dat we de functie \texttt{relevel} gebruiken om de controles als
  referentie groep de definiëren: eerste niveau van de factor.
\end{itemize}
...
\NormalTok{brca }\OtherTok{\textless{}{-}}\NormalTok{ brca }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{cancer =}\NormalTok{ cancer }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{as.factor}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{relevel}\NormalTok{(}\StringTok{"control"}\NormalTok{),}
    \AttributeTok{variant =}\NormalTok{ variant }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{as.factor}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{relevel}\NormalTok{(}\StringTok{"pro/pro"}\NormalTok{)}
\NormalTok{  )}

\NormalTok{brcaLogit }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(}
\NormalTok{  cancer }\SpecialCharTok{\textasciitilde{}}\NormalTok{ variant,}
  \AttributeTok{data =}\NormalTok{ brca,}
  \AttributeTok{family =}\NormalTok{ binomial)}

\FunctionTok{summary}\NormalTok{(brcaLogit)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{anova}\NormalTok{(brcaLogit, }\AttributeTok{test =} \StringTok{"Chisq"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(multcomp)}
\NormalTok{posthoc }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(brcaLogit,}
  \AttributeTok{linfct =} \FunctionTok{mcp}\NormalTok{(}\AttributeTok{variant =} \StringTok{"Tukey"}\NormalTok{))}

\NormalTok{posthocTests }\OtherTok{\textless{}{-}} \FunctionTok{summary}\NormalTok{(posthoc)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{posthocBI }\OtherTok{\textless{}{-}} \FunctionTok{confint}\NormalTok{(posthoc)}
\NormalTok{posthocBI}
\end{Highlighting}
\end{Shaded}
...
Linear Hypotheses:
                       Estimate lwr      upr     
leu/leu - pro/pro == 0  0.21197 -0.22763  0.65157
pro/leu - pro/pro == 0  0.13802 -0.13095  0.40699
pro/leu - leu/leu == 0 -0.07395 -0.51371  0.36582
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{OR }\OtherTok{\textless{}{-}} \FunctionTok{exp}\NormalTok{(posthocBI}\SpecialCharTok{$}\NormalTok{confint)}
\NormalTok{OR}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
                   Estimate       lwr      upr
leu/leu - pro/pro 1.2361111 0.7964179 1.918554
pro/leu - pro/pro 1.1480000 0.8772617 1.502293
pro/leu - leu/leu 0.9287191 0.5982694 1.441690
attr(,"conf.level")
[1] 0.95
attr(,"calpha")
[1] 2.32413
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beetles }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statomics/sbc/master/data/beetles.csv"}\NormalTok{)}
\FunctionTok{head}\NormalTok{(beetles)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(beetles}\SpecialCharTok{$}\NormalTok{dose, beetles}\SpecialCharTok{$}\NormalTok{status)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beetleModel}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(}
\NormalTok{  status}\SpecialCharTok{\textasciitilde{}}\NormalTok{dose,}
  \AttributeTok{data =}\NormalTok{ beetles,}
  \AttributeTok{family =}\NormalTok{ binomial)}

\FunctionTok{summary}\NormalTok{(beetleModel)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beetlesTab}\OtherTok{\textless{}{-}}\FunctionTok{table}\NormalTok{(beetles) }\SpecialCharTok{|\textgreater{}} \FunctionTok{data.frame}\NormalTok{()}

\FunctionTok{data.frame}\NormalTok{(}
    \AttributeTok{grid =} \FunctionTok{seq}\NormalTok{(}
      \FunctionTok{min}\NormalTok{(beetles}\SpecialCharTok{$}\NormalTok{dose),}
      \FunctionTok{max}\NormalTok{(beetles}\SpecialCharTok{$}\NormalTok{dose),.}\DecValTok{1}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{piHat =} \FunctionTok{predict}\NormalTok{(beetleModel,}
          \AttributeTok{newdata =} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{dose=}\NormalTok{grid),}
          \AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(grid, piHat))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"dose"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"probability (dead)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dose }\SpecialCharTok{|\textgreater{}}
          \FunctionTok{as.character}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
          \FunctionTok{as.double}\NormalTok{(),}
        \AttributeTok{y =}\NormalTok{ status }\SpecialCharTok{|\textgreater{}}
          \FunctionTok{as.character}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
          \FunctionTok{as.double}\NormalTok{(),}
        \AttributeTok{label =}\NormalTok{ Freq),}
\NormalTok{    beetlesTab }\SpecialCharTok{|\textgreater{}}
      \FunctionTok{filter}\NormalTok{(status}\SpecialCharTok{==}\DecValTok{0}\NormalTok{)}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{geom\_text}\NormalTok{(}
    \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ dose }\SpecialCharTok{|\textgreater{}}
          \FunctionTok{as.character}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
       ...
       \AttributeTok{label=}\NormalTok{Freq),}
\NormalTok{   beetlesTab }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{filter}\NormalTok{(status}\SpecialCharTok{==}\DecValTok{1}\NormalTok{)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{09-CategorischeDataAnalyse_files/figure-pdf/fig-keversFit-1.pdf}

}

\caption{\label{fig-keversFit}Fit van het logistische regressiemodel
voor de kevers data. Het aantal kevers die dood/levend was per dosis is
weergegeven met een cijfer.}

\end{figure}%

\bookmarksetup{startatroot}

\chapter{Algemeen lineair model}\label{sec-chap-glm}
...
\tightlist
\item
  \href{https://www.youtube.com/playlist?list=PLZH1hP8_LbJLuEaRpvAkW7oQLCCjHqUS4}{Kennisclips
...
\tightlist
\item
  \href{https://statomics.github.io/sbc/rmd/10-MultipleRegression.html}{script
  Hoofdstuk 10}
\end{itemize}
...
(Hoofdstuk \ref{sec-chap-linReg}) uit door meerdere predictoren toe te
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prostate }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statomics/sbc/master/data/prostate.csv"}\NormalTok{)}
\NormalTok{prostate}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prostate}\SpecialCharTok{$}\NormalTok{svi }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(prostate}\SpecialCharTok{$}\NormalTok{svi)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(}\SpecialCharTok{{-}}\NormalTok{pgg45)  }\SpecialCharTok{|\textgreater{}}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-lpsaAll-1.pdf}

}

\caption{\label{fig-lpsaAll}Scatterplot matrix voor de observaties in de
prostaat kanker dataset.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmV }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lcavol, prostate)}
\FunctionTok{summary}\NormalTok{(lmV)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmVWS }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa}\SpecialCharTok{\textasciitilde{}}\NormalTok{lcavol }\SpecialCharTok{+}\NormalTok{ lweight }\SpecialCharTok{+}\NormalTok{ svi, prostate)}
\FunctionTok{summary}\NormalTok{(lmVWS)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosAdditiveFit-1.pdf}

}

\caption{\label{fig-prosAdditiveFit}Fit van het additieve model met
termen lcavol, lweight en svi. De figuur geeft duidelijk weer dat de
gemiddelde lpsa toeneemt i.f.v. het log-tumorvolume, het
log-prostaatgewicht en de invasie van de zaadblaasjes. Merk op dat de
fit resulteert in twee parallele vlakken, een regressievlak voor
patiënten zonder (blauw) en met invasie van de zaadblaasjes (oranje).}
...
Net zoals in Hoofdstuk \ref{sec-chap-linReg} is het op basis van de
...
\item
  ...
  bijkomende aannames moeten maken over de verdeling van de gegevens,
  met name
\item
...
Als we ook steunen op de veronderstelling van lineariteit weten we dat
de originele observaties conditioneel op \(X_1,\ldots,X_{p-1}\) eveneens
...
Analoog als in Hoofdstuk \ref{sec-chap-linReg} kunnen we opnieuw toetsen
en betrouwbaarheidsintervallen construeren op basis van de
teststatistieken
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{confint}\NormalTok{(lmVWS)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(lmVWS)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosLinDiag1-1.pdf}

}

\caption{\label{fig-prosLinDiag1}Diagnostische plots voor het nagaan van
de veronderstellingen van het lineair regressiemodel waarbij lpsa
gemodelleerd wordt a.d.h.v. de predictoren lcavol, lweight en svi.}
...
en tussen lpsa en log-prostaatgewicht wel afhangt van de status van de
zaadblaasjes. De gemiddelde toename in lpsa tussen patiënten die één
eenheid in het log-tumorvolume verschillen zou bijvoorbeeld lager kunnen
zijn voor patiënten met een aangetaste zaadblaasjes dan bij patiënten
waarvan de zaadblaasjes niet zijn aangetast. De associatie van het
tumorvolume en de prostaat antigeen concentratie hangt in dit geval af
van de status van de zaadblaasjes.

Om een dergelijke \textit{interactie} of \textit{effectmodificatie}
tussen 2 variabelen \(X_v\) en \(X_s\) enerzijds en tussen \(X_w\) en
\(X_s\) anderzijds statistisch te modelleren kan men producten van de
variabelen in kwestie aan het model toevoegen:

\[
Y_i = \beta_0 + \beta_v x_{iv} + \beta_w x_{iw} +\beta_s x_{is} + \beta_{vs} x_{iv}x_{is} + \beta_{ws} x_{iw}x_{is} +\epsilon_i
\]

Deze termen kwantificeren de \emph{interactie-effecten} van
respectievelijk de predictoren \(x_v\) en \(x_s\); en van \(x_w\) en
\(x_s\) op de gemiddelde uitkomst. In dit model worden de termen
\(\beta_vx_{iv}\), \(\beta_wx_{iw}\) en \(\beta_sx_{is}\) dikwijls de
\emph{hoofdeffecten} van de predictoren \(x_v\), \(x_w\) en \(x_s\)
genoemd.

We schatten dit model nu in R. De interacties worden toegevoegd door een
term toe te voegen in de formule met de naam van twee variabelen die
wordt gescheiden door een \texttt{:}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmVWS\_IntVS\_WS }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa }\SpecialCharTok{\textasciitilde{}}\NormalTok{ lcavol }\SpecialCharTok{+}\NormalTok{ lweight }\SpecialCharTok{+}\NormalTok{ svi }\SpecialCharTok{+}\NormalTok{ svi}\SpecialCharTok{:}\NormalTok{lcavol }\SpecialCharTok{+}\NormalTok{ svi}\SpecialCharTok{:}\NormalTok{lweight,}\AttributeTok{data=}\NormalTok{prostate)}
\FunctionTok{summary}\NormalTok{(lmVWS\_IntVS\_WS)}
\end{Highlighting}
\end{Shaded}
...
aangetast zijn en \(X_s=1\) als er invasie is van de zaadblaasjes.
...
waar het intercept \(\beta_0 + \beta_s\) is, de som van het intercept en
het hoofdeffect voor \(X_s\), en de hellingen voor lcavol en lweight
respectievelijk \(\beta_v+\beta_{vs}\) en \(\beta_w+\beta_{ws}\) zijn,
m.a.w. de som van het hoofdeffect en de overeenkomstige interactieterm.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosIntFit2-1.pdf}

}

\caption{\label{fig-prosIntFit2}Fit van het additieve model met de
termen lcavol, lweight, svi (links) en het model met interacties lcavol,
lweight, svi . lcavol:svi, lweight:svi (rechts). De rechtse figuur toont
duidelijk dat de interactie er nu voor zorgt dat de associaties tussen
de response \textless-\textgreater{} het log-tumorvolume en de response
\textless-\textgreater{} het log-gewicht afhankelijk is van de status
van de zaadblaasjes. De interacties zorgen voor andere hellingen bij
patiënten met (rood) en zonder invasie (blauw) van de zaadblaasjes. Voor
het additieve model (links) zien we enkel een verschuiving van het
regressievlak, maar parallelle hellingen. Het hoofdeffect voor een
factor variabele zorgt m.a.w. voor een ander intercept.}
...
en dat de helling voor lweight van teken veranderd. We merken verder op
dat beide interactie-termen opnieuw niet significant.

\subsection{Interactie tussen twee continue
variabelen}\label{sec-intCont}

Het zou ook kunnen dat de associatie tussen lpsa en lcavol afhangt van
het prostaatgewicht. De gemiddelde toename in lpsa tussen patiënten die
één eenheid van log-tumorvolume verschillen zou bijvoorbeeld lager
kunnen zijn voor patiënten met een hoog prostaatgewicht dan bij
patiënten met een laag prostaatgewicht. Het effect van het tumorvolume
op de prostaat antigeen concentratie hangt in dit geval af van het
prostaatgewicht.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmVWS\_IntVW }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa}\SpecialCharTok{\textasciitilde{}}\NormalTok{lcavol }\SpecialCharTok{+}\NormalTok{ lweight }\SpecialCharTok{+}\NormalTok{ svi }\SpecialCharTok{+}\NormalTok{ lcavol}\SpecialCharTok{:}\NormalTok{lweight ,prostate)}
\FunctionTok{summary}\NormalTok{(lmVWS\_IntVW)}
\end{Highlighting}
\end{Shaded}
...
(\(1.005-0.125 \times x_w\))\% verschillen in prostaat antigeen
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosIntFit1-1.pdf}

}

\caption{\label{fig-prosIntFit1}Fit van het additieve model met de
termen lcavol, lweight, svi (links) en het model met interactie lcavol,
lweight, svi en lcavol:lweight (rechts). Merk op dat we enkel het
regressieoppervlak weergeven voor patiënten zouder invasie van de
zaadblaasjes. Dat voor patiënten met invasie van de zaadblaasjes is
parallel met het getoonde oppervlak, maar ligt iets hoger. De rechtse
figuur toont duidelijk dat de interactie ervoor zorgt dat de associatie
tussen de response en het tumorvolume afhankelijk is van de hoogte van
het prostaatgewicht en vice versa, dat zorgt voor een torsie in het
regressievlak.}
...
is de fractie van de totale variabiliteit in de uitkomsten die verklaard
wordt door het regressiemodel.
...
verdeeld volgens een F-verdeling met \(p-1\) vrijheidsgraden in de
teller en \(n-p\) vrijheidsgraden in de noemer \(F_{p-1;n-p}\).

De F-test test m.a.w. het effect van alle predictoren simultaan. Onder
de nulhypothese is er geen associatie tussen de respons en elk van de
...
onder \(H_0:\beta_j=0\) met \(s=j\) verdeeld als \(F_{1;n-p}\).
...
\FunctionTok{Anova}\NormalTok{(lmVWS, }\AttributeTok{type =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(prostate}\SpecialCharTok{$}\NormalTok{lcavol,prostate}\SpecialCharTok{$}\NormalTok{lweight,prostate}\SpecialCharTok{$}\NormalTok{lcavol}\SpecialCharTok{*}\NormalTok{prostate}\SpecialCharTok{$}\NormalTok{lweight))}
\end{Highlighting}
\end{Shaded}
...
In deze uitdrukking stelt \(R_j^2\) de meervoudige
determinatiecoëfficiënt voor van een lineaire regressie van de \(j\)-de
predictor op alle andere predictoren in het model. De VIF heeft de
eigenschap dat ze gelijk is aan 1 indien de \(j\)-de predictor niet
lineair geassocieerd is met de andere predictoren in het model, en
bijgevolg wanneer de \(j\)-de parameter in het model niet onderhevig is
aan het probleem van multicollineariteit. De VIF is groter dan 1 in alle
andere gevallen. In het bijzonder drukt ze uit met welke factor de
geobserveerde variantie op de schatting voor de \(j\)-de parameter
groter is dan wanneer alle predictoren onafhankelijk zouden zijn. Hoe
groter de VIF, hoe minder stabiel de schattingen bijgevolg zijn. Hoe
kleiner de VIF, hoe dichter de schattingen dus bij de gezochte
populatiewaarden verwacht worden. In de praktijk spreekt men van
ernstige multicollineariteit voor een regressieparameter wanneer haar
VIF de waarde 10 overschrijdt.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-vetScatter-1.pdf}

}

\caption{\label{fig-vetScatter}Scatterplot matrix van de dataset
bodyfat.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmFat }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Body\_fat }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Triceps }\SpecialCharTok{+}\NormalTok{ Thigh }\SpecialCharTok{+}\NormalTok{ Midarm, }\AttributeTok{data =}\NormalTok{ bodyfat)}
\FunctionTok{summary}\NormalTok{(lmFat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{vif}\NormalTok{(lmFat)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lmMidarm }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Midarm }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Triceps }\SpecialCharTok{+}\NormalTok{ Thigh, }\AttributeTok{data =}\NormalTok{ bodyfat)}
\FunctionTok{summary}\NormalTok{(lmMidarm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{vif}\NormalTok{(lmVWS)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
     lcavol     lweight sviinvasion 
   1.447048    1.039188    1.409189 
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{vif}\NormalTok{(lmVWS\_IntVW)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
        lcavol        lweight    sviinvasion lcavol:lweight 
...
\NormalTok{nobs}\OtherTok{\textless{}{-}}\DecValTok{20}
\NormalTok{sdy}\OtherTok{\textless{}{-}}\DecValTok{1}
\NormalTok{x}\OtherTok{\textless{}{-}}\FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\AttributeTok{length=}\NormalTok{nobs)}
\NormalTok{y}\OtherTok{\textless{}{-}}\DecValTok{10}\SpecialCharTok{+}\DecValTok{5}\SpecialCharTok{*}\NormalTok{x}\SpecialCharTok{+}\FunctionTok{rnorm}\NormalTok{(nobs,}\AttributeTok{sd=}\NormalTok{sdy)}
\NormalTok{x1}\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(x,}\FloatTok{0.5}\NormalTok{)}
\NormalTok{y1 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(y,}\DecValTok{10}\SpecialCharTok{+}\DecValTok{5}\SpecialCharTok{*}\FloatTok{1.5}\SpecialCharTok{+}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{1}\NormalTok{,}\AttributeTok{sd=}\NormalTok{sdy))}
\NormalTok{x2 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(x,}\FloatTok{1.5}\NormalTok{)}
\NormalTok{y2 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(y,y1[}\DecValTok{21}\NormalTok{])}
\NormalTok{x3 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(x,}\FloatTok{1.5}\NormalTok{)}
\NormalTok{y3 }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(y,}\DecValTok{11}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(x,y,}\AttributeTok{xlim=}\FunctionTok{range}\NormalTok{(}\FunctionTok{c}\NormalTok{(x1,x2,x3)),}\AttributeTok{ylim=}\FunctionTok{range}\NormalTok{(}\FunctionTok{c}\NormalTok{(y1,y2,y3)))}
\FunctionTok{points}\NormalTok{(}\FunctionTok{c}\NormalTok{(x1[}\DecValTok{21}\NormalTok{],x2[}\DecValTok{21}\NormalTok{],x3[}\DecValTok{21}\NormalTok{]),}\FunctionTok{c}\NormalTok{(y1[}\DecValTok{21}\NormalTok{],y2[}\DecValTok{21}\NormalTok{],y3[}\DecValTok{21}\NormalTok{]),}\AttributeTok{pch=}\FunctionTok{as.character}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{),}\AttributeTok{col=}\DecValTok{2}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\FunctionTok{lm}\NormalTok{(y}\SpecialCharTok{\textasciitilde{}}\NormalTok{x),}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\FunctionTok{lm}\NormalTok{(y1}\SpecialCharTok{\textasciitilde{}}\NormalTok{x1),}\AttributeTok{col=}\DecValTok{2}\NormalTok{,}\AttributeTok{lty=}\DecValTok{2}\NormalTok{,}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\FunctionTok{lm}\NormalTok{(y2}\SpecialCharTok{\textasciitilde{}}\NormalTok{x2),}\AttributeTok{col=}\DecValTok{3}\NormalTok{,}\AttributeTok{lty=}\DecValTok{3}\NormalTok{,}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\FunctionTok{lm}\NormalTok{(y3}\SpecialCharTok{\textasciitilde{}}\NormalTok{x3),}\AttributeTok{col=}\DecValTok{4}\NormalTok{,}\AttributeTok{lty=}\DecValTok{4}\NormalTok{,}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{)}
\FunctionTok{legend}\NormalTok{(}\StringTok{"topleft"}\NormalTok{,}\AttributeTok{col=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{,}\AttributeTok{lty=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{,}\AttributeTok{legend=}\FunctionTok{paste}\NormalTok{(}\StringTok{"lm"}\NormalTok{,}\FunctionTok{c}\NormalTok{(}\StringTok{""}\NormalTok{,}\FunctionTok{as.character}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{))),}\AttributeTok{text.col=}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-influential-1.pdf}

}

\caption{\label{fig-influential}Impact van outliers op de regressie.
Regressie zonder outliers (zwart), regressie met outlier 1 (groen),
regressie met outlier 2 (rood), regressie met outlier 3 (blauw).}
...
tussen \(1/n\) en 1 en zijn gemiddeld \(p/n\) met \(p\) het aantal
ongekende parameters (intercept + \(p-1\) hellingen). Een extreme
...
percentiel van de \(F_{p,n-p}\)-verdeling overschrijdt.
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(lmVWS,}\AttributeTok{which=}\DecValTok{5}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(lmVWS\_IntVW,}\AttributeTok{which=}\DecValTok{5}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\FunctionTok{cooks.distance}\NormalTok{(lmVWS),}\AttributeTok{type=}\StringTok{"h"}\NormalTok{,}\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{),}\AttributeTok{main=}\StringTok{"Additive model"}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h=}\FunctionTok{qf}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\FunctionTok{length}\NormalTok{(lmVWS}\SpecialCharTok{$}\NormalTok{coef),}\FunctionTok{nrow}\NormalTok{(prostate)}\SpecialCharTok{{-}}\FunctionTok{length}\NormalTok{(lmVWS}\SpecialCharTok{$}\NormalTok{coef)),}\AttributeTok{lty=}\DecValTok{2}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\FunctionTok{cooks.distance}\NormalTok{(lmVWS\_IntVW),}\AttributeTok{type=}\StringTok{"h"}\NormalTok{,}\AttributeTok{ylim=}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{), }\AttributeTok{main=}\StringTok{"Model with lcavol:lweight interaction"}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h=}\FunctionTok{qf}\NormalTok{(}\FloatTok{0.5}\NormalTok{,}\FunctionTok{length}\NormalTok{(lmVWS\_IntVW}\SpecialCharTok{$}\NormalTok{coef),}\FunctionTok{nrow}\NormalTok{(prostate)}\SpecialCharTok{{-}}\FunctionTok{length}\NormalTok{(lmVWS\_IntVW}\SpecialCharTok{$}\NormalTok{coef)),}\AttributeTok{lty=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosCooksAdditiveInt-1.pdf}

}

\caption{\label{fig-prosCooksAdditiveInt}Evaluatie van de invloed van
individuele observaties op het additieve model (links) en het model met
de lcavol:lweight interactie (rechts).}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{dfbetasPlots}\NormalTok{(lmVWS)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosDfBetasAdditive-1.pdf}

}

\caption{\label{fig-prosDfBetasAdditive}DFBETAS voor additieve model in
prostaatkanker.}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{dfbetasPlots}\NormalTok{(lmVWS\_IntVW)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosDfBetasInt-1.pdf}

}

\caption{\label{fig-prosDfBetasInt}DFBETAS voor model met lcavol:lweight
interactie.}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{exp}\NormalTok{(prostate[}\DecValTok{32}\NormalTok{,}\StringTok{"lweight"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{boxplot}\NormalTok{(}\FunctionTok{exp}\NormalTok{(prostate}\SpecialCharTok{$}\NormalTok{lweight),}\AttributeTok{ylab=}\StringTok{"Prostaatgewicht (g)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/fig-prosInfl-1.pdf}

}

\caption{\label{fig-prosInfl}Boxplot met outlier voor prostaatgewicht.}

\end{figure}%

Wanneer we het gewicht terugtransformeren naar de originele schaal zien
we dat het prostaatgewicht voor deze patiënt 449.25 g bedraagt. De
...
\section{Contrasten}\label{contrasten}

\begin{itemize}
\tightlist
\item
  Bij meer complexe algemene lineaire modellen wenst men dikwijls
  meerdere hypothesen te toetsen.
\item
  Bovendien vertalen de onderzoekshypotheses zich hierbij niet steeds in
  één parameter, maar in een lineaire combinatie van modelparameters.
\item
  Een lineaire combinatie van modelparameters wordt ook een contrast
  genoemd.
\end{itemize}
...
\begin{itemize}
\item
  Stel dat de onderzoekers de associatie tussen de leeftijd en de
  bloeddruk wensen te bestuderen bij Amerikaanse kinderen. Mogelijks is
  die associatie anders is bij jongens en meisjes.
\item
  ...
  \item
    Is de associatie tussen leeftijd en de bloeddruk verschillend bij
...
We fitten een model op basis van de gemiddelde systolische bloeddruk
(\texttt{BPSysAve}) in functie van de leeftijd, geslacht en een
interactie tussen leeftijd en geslacht voor volwassen blanke subjecten
uit de NHANES studie.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(NHANES)}
\NormalTok{bpData }\OtherTok{\textless{}{-}}\NormalTok{ NHANES }\SpecialCharTok{|\textgreater{}}
\FunctionTok{filter}\NormalTok{(}
\NormalTok{    Age }\SpecialCharTok{\textgreater{}=}\DecValTok{6} \SpecialCharTok{\&} 
\NormalTok{    Age }\SpecialCharTok{\textless{}=} \DecValTok{18} \SpecialCharTok{\&}
    \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(BPSysAve) }\SpecialCharTok{\&} 
    \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(AgeMonths))}

\NormalTok{mBp1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BPSysAve }\SpecialCharTok{\textasciitilde{}}\NormalTok{ AgeMonths}\SpecialCharTok{*}\NormalTok{Gender, bpData)}
\FunctionTok{dim}\NormalTok{(bpData)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow =} \FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{plot}\NormalTok{(mBp1)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-14-1.pdf}}
...
\item
  ...
  \item
    Lichte afwijkeingen van normaliteit: indicatie voor lichtjes scheve
    verdeling met staart naar rechts.
  \item
    Grote dataset (n = 703) we kunnen steunen op de CLT
  \end{itemize}
\end{itemize}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(mBp1)}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Associatie tussen bloeddruk en leeftijd bij de meisjes?
\end{enumerate}
...
\tightlist
\item
  Associatie tussen bloeddruk en leeftijd bij de jongens?
\end{enumerate}
...
\tightlist
\item
  Is de Associatie tussen bloeddruk en leeftijd verschillend bij jongens
  en meisjes?
\end{enumerate}
...
\tightlist
\item
  We kunnen onderzoeksvraag 1 en 3 onmiddelijk toetsen o.b.v. de model
  output.
\item
  Onderzoeksvraag 2 is echter een lineaire combinatie van twee
  parameters.
\item
  Bovendien is er ook het probleem dat we meerdere toetsen nodig hebben
  om de associaties te bestuderen.
\end{itemize}
...
\tightlist
\item
  We toetsen eerste de omnibus hypothese dat er geen associatie is
  tussen leeftijd en de bloeddruk.
\end{enumerate}
...
\tightlist
\item
  Wat we kunnen evalueren door twee modellen te vergelijken. Een model
  met enkel het gender effect en het volledige model met Gender, Age en
  de Gender x Age interactie.
\end{itemize}
...
\tightlist
\item
  Als we deze hypothese kunnen verwerpen voeren we posthoc analyses uit
  voor elk van de 3 contrasten.
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mBp0 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BPSysAve }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Gender, bpData)}
\FunctionTok{anova}\NormalTok{(mBp0, mBp1)}
\end{Highlighting}
\end{Shaded}
...
De posthoc testen kunnen we opnieuw uitvoeren a.d.h.v. het multcomp
pakket.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(multcomp)}
\NormalTok{bpPosthoc }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(mBp1, }\AttributeTok{linfct=}\FunctionTok{c}\NormalTok{(}
  \StringTok{"AgeMonths = 0"}\NormalTok{,}
  \StringTok{"AgeMonths + AgeMonths:Gendermale = 0"}\NormalTok{,}
  \StringTok{"AgeMonths:Gendermale = 0"}\NormalTok{)}
\NormalTok{  )}
\NormalTok{bpPosthoc }\SpecialCharTok{|\textgreater{}} \FunctionTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bpPosthocBI }\OtherTok{\textless{}{-}}\NormalTok{ bpPosthoc }\SpecialCharTok{|\textgreater{}} \FunctionTok{confint}\NormalTok{()}
...
Merk op dat de glht functie ons toelaat om de contrasten te definiëren
door de nulhypotheses expliciet te formuleren in een karaktervector
waarbij gebruik wordt gemaakt van de naam van de pararameters in het
model.

\subsubsection{Conclusie}\label{conclusie-2}

We kunnen besluiten dat er een extreem significante associatie is tussen
leeftijd en de bloeddruk (p \textless\textless{} 0.001). De bloeddruk
bij twee meisjes die in leeftijd verschillen is gemiddeld 0.06 mm Hg
hoger per maand leeftijdsverschil bij het oudere meisje (p
\textless\textless{} 0.001, 95\% BI {[}0.03, 0.09{]}. De bloeddruk bij
jongens die in leeftijd verschillen is gemiddeld 0.15 mm Hg hoger per
maand leeftijdsverschil bij de oudere jongen. (p \textless\textless{}
0.001, 95\% BI {[}0.12, 0.18{]}. Het gemiddelde bloeddrukverschil tussen
personen in leeftijd verschillen is gemiddeld 0.09 mm Hg/maand hoger bij
jongens dan meisjes (p \textless\textless{} 0.001, 95\% BI {[}0.05,
0.14{]}).
...
In deze sectie illustreren we hoe experimenten met een factoriële
proefopzet geanalyseerd kunnen worden met het algemeen lineair model.

We focussen hierbij op een two-way anova design waarbij we een continue
response modelleren in functie van twee categorische predictor
variabelen (factoren).
...
\FunctionTok{data}\NormalTok{(rats)}

\NormalTok{rats }\OtherTok{\textless{}{-}}\NormalTok{ rats }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{time=}\NormalTok{time }\SpecialCharTok{*} \DecValTok{10}\NormalTok{)}

\FunctionTok{library}\NormalTok{(GGally)}
\NormalTok{rats }\SpecialCharTok{|\textgreater{}} 
  \FunctionTok{ggpairs}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-18-1.pdf}}
...
\begin{Highlighting}[]
\NormalTok{rats }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{treat,}\AttributeTok{y=}\NormalTok{time)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_jitter}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison) }\SpecialCharTok{+}
  \FunctionTok{ylab}\NormalTok{(}\StringTok{"time (h)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-19-1.pdf}}

\begin{itemize}
\tightlist
\item
  Er zou een interactie kunnen zijn tussen behandeling en gif, het
  effect van het gif op de overlevingstijd hangt dan af van de
...
We modelleren de data met een hoofdeffect voor gif en behandeling en een
gif \(\times\) behandeling interactie.
...
met \(i = 1, \ldots, n\), \(n=48\), en, \(x_{iII}\), \(x_{iIII}\),
\(x_{iB}\), \(x_{iC}\) en \(x_{iD}\) dummy variabelen voor
respectievelijk gif II, III, behandeling B, C, en D.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rats1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(time}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison}\SpecialCharTok{*}\NormalTok{treat, rats)}
\FunctionTok{summary}\NormalTok{(rats1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(rats1)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-20-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-20-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-20-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-20-4.pdf}}

De errors zijn heteroscedastisch. De residu plot suggereert een relatie
tussen gemiddelde en variantie. De QQ-plot suggereert dat de verdeling
mogelijks bredere staarten heeft dan de normale verdeling.

\subsubsection{Transformaties}\label{transformaties}

\paragraph{Logaritmische
transformatie}\label{logaritmische-transformatie}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rats }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{treat,}\AttributeTok{y=}\FunctionTok{log2}\NormalTok{(time))) }\SpecialCharTok{+} 
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_jitter}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-21-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rats2 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(time }\SpecialCharTok{|\textgreater{}} \FunctionTok{log2}\NormalTok{()}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison}\SpecialCharTok{*}\NormalTok{treat, rats)}
\FunctionTok{plot}\NormalTok{(rats2)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-21-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-21-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-21-4.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-21-5.pdf}}
...
\begin{Highlighting}[]
\NormalTok{rats }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{treat,}\AttributeTok{y=}\DecValTok{1}\SpecialCharTok{/}\NormalTok{time)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape=}\ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_jitter}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison) }\SpecialCharTok{+} 
  \FunctionTok{ylab}\NormalTok{ (}\StringTok{"rate of dying (1/h)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-22-1.pdf}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rats3 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{time}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison}\SpecialCharTok{*}\NormalTok{treat, rats)}
\FunctionTok{plot}\NormalTok{(rats3) }
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-22-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-22-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-22-4.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-22-5.pdf}}

De reciproke transformatie lijkt beter. Transformaties bemoeilijken soms
de interpretatie. Hier kan de reciproke transformatie echter worden
geïnterpreteerd als de ``snelheid van sterven'' (rate of dying).

\subsection{Inferentie}\label{inferentie}

Er zijn meerdere interactie termen in het model. We kunnen deze eerst
samen testen a.d.h.v. van de resultaten uit de anova tabel.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(car)}
\FunctionTok{Anova}\NormalTok{(rats3, }\AttributeTok{type=}\StringTok{"III"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Verwijderen van niet-significante
interactie.}\label{verwijderen-van-niet-significante-interactie.}

De interactie tussen gif en behandeling is niet significant op het 5\%
niveau.

Een veelgebruikte methode is om de niet-significante interactie te
verwijderen uit het model.

We verkrijgen dan een additief model wat toelaat om de effecten van de
twee factoren afzonderlijk te bestuderen.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rats4 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{time}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison }\SpecialCharTok{+}\NormalTok{ treat, rats)}
\FunctionTok{plot}\NormalTok{(rats4)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-24-1.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-24-2.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-24-3.pdf}}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-24-4.pdf}}

We zien wel iets meer afwijkingen in de residu plot.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{Anova}\NormalTok{(rats4, }\AttributeTok{type=}\StringTok{"III"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
De anova tabel toont dat het effect van gif en behandeling beiden
extreem significant zijn (beide \(p<< 0.001\)).

Het additieve model laat toe om de effecten van het type gif en de
behandeling afzonderlijke te bestuderen via een post-hoc analyse.

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(multcomp)}
\NormalTok{comparisons }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(rats4, }\AttributeTok{linfct =} \FunctionTok{mcp}\NormalTok{(}\AttributeTok{poison =} \StringTok{"Tukey"}\NormalTok{, }\AttributeTok{treat=}\StringTok{"Tukey"}\NormalTok{))}
\FunctionTok{summary}\NormalTok{(comparisons)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(comparisons,}\AttributeTok{yaxt=}\StringTok{"none"}\NormalTok{)}
\NormalTok{contrastNames }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"II{-}I"}\NormalTok{,}\StringTok{"III{-}I"}\NormalTok{,}\StringTok{"III{-}II"}\NormalTok{,}\StringTok{"B{-}A"}\NormalTok{,}\StringTok{"C{-}A"}\NormalTok{,}\StringTok{"D{-}A"}\NormalTok{,}\StringTok{"C{-}B"}\NormalTok{,}\StringTok{"D{-}B"}\NormalTok{,}\StringTok{"D{-}C"}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\DecValTok{2}\NormalTok{,}\AttributeTok{at=}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(contrastNames)}\SpecialCharTok{:}\DecValTok{1}\NormalTok{), }\AttributeTok{labels=}\NormalTok{contrastNames,}\AttributeTok{las=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-26-1.pdf}}

\subsubsection{Niet-significante interactie term in het model
weerhouden}\label{niet-significante-interactie-term-in-het-model-weerhouden}

Het aanvaarden van de nulhypothese dat er geen interactie is, is een
zwakke conclusie. Het zou immers kunnen dat de power van het experiment
te klein is om de interactie op te pikken. We kunnen er ook voor kiezen
om de niet significante interactie term in het model te laten.

Als de interactie significant zou zijn geweest, betekent dit dat het
effect van het gif op de snelheid van sterven afhangt van de behandeling
en vice versa. Dan kunnen we het effect van het type gif en de
behandeling op de overlevingstijd niet afzonderlijk bestuderen.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ExploreModelMatrix}\SpecialCharTok{::}\FunctionTok{VisualizeDesign}\NormalTok{(rats,}\SpecialCharTok{\textasciitilde{}}\NormalTok{poison}\SpecialCharTok{*}\NormalTok{treat)}\SpecialCharTok{$}\NormalTok{plot}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-27-1.pdf}}

We zouden dan het effect van het type gif afzonderlijk moeten bestuderen
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{comparisonsInt }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(rats3, }\AttributeTok{linfct =} \FunctionTok{c}\NormalTok{(}
  \StringTok{"poisonII = 0"}\NormalTok{,}
  \StringTok{"poisonIII = 0"}\NormalTok{,}
  \StringTok{"poisonIII {-} poisonII = 0"}\NormalTok{,}
  \StringTok{"poisonII + poisonII:treatB = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatB {-} poisonII{-} poisonII:treatB = 0"}\NormalTok{,  }
  \StringTok{"poisonII + poisonII:treatC = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatC = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatC {-} poisonII{-} poisonII:treatC = 0"}\NormalTok{,  }
  \StringTok{"poisonII + poisonII:treatD = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatD = 0"}\NormalTok{,}
  \StringTok{"poisonIII + poisonIII:treatD {-} poisonII{-} poisonII:treatD = 0"}\NormalTok{,  }
  \StringTok{"treatB = 0"}\NormalTok{,}
  \StringTok{"treatC = 0"}\NormalTok{,}
  \StringTok{"treatD = 0"}\NormalTok{,}
  \StringTok{"treatC {-} treatB = 0"}\NormalTok{,}
  \StringTok{"treatD {-} treatB = 0"}\NormalTok{,}
  \StringTok{"treatD {-} treatC = 0"}\NormalTok{,}
  \StringTok{"treatB + poisonII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatC + poisonII:treatC = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonII:treatD = 0"}\NormalTok{,}
  \StringTok{"treatC + poisonII:treatC {-} treatB {-} poisonII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonII:treatD {-} treatB {-} poisonII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonII:treatD {-} treatC {-} poisonII:treatC = 0"}\NormalTok{,}
  \StringTok{"treatB + poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatC + poisonIII:treatC = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonIII:treatD = 0"}\NormalTok{,}
  \StringTok{"treatC + poisonIII:treatC {-} treatB {-} poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonIII:treatD {-} treatB {-} poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + poisonIII:treatD {-} treatC {-} poisonIII:treatC = 0"}\NormalTok{)}
\NormalTok{)}

\NormalTok{contrastNames}\OtherTok{\textless{}{-}}
  \FunctionTok{c}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\FunctionTok{rep}\NormalTok{(LETTERS[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{],}\AttributeTok{each=}\DecValTok{3}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{combn}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"I"}\NormalTok{,}\StringTok{"II"}\NormalTok{,}\StringTok{"III"}\NormalTok{),}\DecValTok{2}\NormalTok{)[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{1}\NormalTok{,],}\DecValTok{2}\NormalTok{,paste,}\AttributeTok{collapse=}\StringTok{"{-}"}\NormalTok{) ,}\DecValTok{4}\NormalTok{),}\AttributeTok{sep=}\StringTok{": "}\NormalTok{),}
    \FunctionTok{paste}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{"I"}\NormalTok{,}\StringTok{"II"}\NormalTok{,}\StringTok{"III"}\NormalTok{),}\AttributeTok{each=}\DecValTok{6}\NormalTok{),}\FunctionTok{rep}\NormalTok{(}\FunctionTok{apply}\NormalTok{(}\FunctionTok{combn}\NormalTok{(}\FunctionTok{c}\NormalTok{(LETTERS[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{]),}\DecValTok{2}\NormalTok{)[}\DecValTok{2}\SpecialCharTok{:}\DecValTok{1}\NormalTok{,],}\DecValTok{2}\NormalTok{,paste,}\AttributeTok{collapse=}\StringTok{"{-}"}\NormalTok{) ,}\DecValTok{3}\NormalTok{),}\AttributeTok{sep=}\StringTok{": "}\NormalTok{))}

\FunctionTok{plot}\NormalTok{(comparisonsInt,}\AttributeTok{yaxt=}\StringTok{"none"}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\DecValTok{2}\NormalTok{,}\AttributeTok{at=}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(contrastNames)}\SpecialCharTok{:}\DecValTok{1}\NormalTok{), }\AttributeTok{labels=}\NormalTok{contrastNames,}\AttributeTok{las=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-28-1.pdf}}

In onze studie was de interactie echter niet significant. Het effect van
het gif (II-I, III-I en III-II) verandert dus niet significant volgens
de behandeling (A, B, C, en D) en vice versa. Voor onze dataset lijkt
het dus zinvol om
...
\tightlist
\item
  de effectgrootte voor de paarsgewijze vergelijkingen tussen de
  verschillende giffen (II-I, III-I en III-II) te schatten door ze uit
  te middelen over alle behandelingen (A, B, C, en D), en,
\item
  de effectgrootte voor de paarsgewijze vergelijkingen tussen de
  verschillende behandelingen (B-A, C-A, D-A, C-B, D-B en D-C) te
  schatten door ze uit te middelen over alle giffen (I, II, III).
\end{enumerate}

Dat zou ons gelijkaardige schattingen van de effectgroottes moeten geven
als deze voor het additieve model waarbij we de interactie term uit het
model hadden geweerd.
...
We schatten met onderstaande code alle gemiddelde contrasten a.d.h.v.
het model met interactie.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{contrasts }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  \StringTok{"poisonII + 1/4*poisonII:treatB + 1/4*poisonII:treatC + 1/4*poisonII:treatD = 0"}\NormalTok{,}
  \StringTok{"poisonIII + 1/4*poisonIII:treatB + 1/4*poisonIII:treatC + 1/4*poisonIII:treatD= 0"}\NormalTok{,}
  \StringTok{"poisonIII + 1/4*poisonIII:treatB + 1/4*poisonIII:treatC + 1/4*poisonIII:treatD {-} poisonII {-} 1/4*poisonII:treatB {-} 1/4*poisonII:treatC {-} 1/4*poisonII:treatD = 0"}\NormalTok{,}
  \StringTok{"treatB + 1/3*poisonII:treatB + 1/3*poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatC + 1/3*poisonII:treatC + 1/3*poisonIII:treatC = 0"}\NormalTok{,}
  \StringTok{"treatD + 1/3*poisonII:treatD + 1/3*poisonIII:treatD = 0"}\NormalTok{,}
  \StringTok{"treatC + 1/3*poisonII:treatC + 1/3*poisonIII:treatC {-} treatB {-} 1/3*poisonII:treatB {-} 1/3*poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + 1/3*poisonII:treatD + 1/3*poisonIII:treatD  {-} treatB {-} 1/3*poisonII:treatB {-} 1/3*poisonIII:treatB = 0"}\NormalTok{,}
  \StringTok{"treatD + 1/3*poisonII:treatD + 1/3*poisonIII:treatD  {-} treatC {-} 1/3*poisonII:treatC {-} 1/3*poisonIII:treatC = 0"}\NormalTok{) }


\NormalTok{comparisonsInt2 }\OtherTok{\textless{}{-}} \FunctionTok{glht}\NormalTok{(rats3, }\AttributeTok{linfct =}\NormalTok{ contrasts}
\NormalTok{)}
\FunctionTok{plot}\NormalTok{(comparisonsInt2,}\AttributeTok{yaxt=}\StringTok{"none"}\NormalTok{)}
\NormalTok{contrastNames }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"II{-}I"}\NormalTok{,}\StringTok{"III{-}I"}\NormalTok{,}\StringTok{"III{-}II"}\NormalTok{,}\StringTok{"B{-}A"}\NormalTok{,}\StringTok{"C{-}A"}\NormalTok{,}\StringTok{"D{-}A"}\NormalTok{,}\StringTok{"C{-}B"}\NormalTok{,}\StringTok{"D{-}B"}\NormalTok{,}\StringTok{"D{-}C"}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\DecValTok{2}\NormalTok{,}\AttributeTok{at=}\FunctionTok{c}\NormalTok{(}\FunctionTok{length}\NormalTok{(contrastNames)}\SpecialCharTok{:}\DecValTok{1}\NormalTok{), }\AttributeTok{labels=}\NormalTok{contrastNames,}\AttributeTok{las=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{10-GeneralLinearModel_files/figure-pdf/unnamed-chunk-29-1.pdf}}

De geschatte effectgroottes zijn inderdaad exact gelijk als bij het
model zonder interactie omdat het experiment gebalanceerd is.

De standaard errors verschillen wel lichtjes. Dat is het gevolg van de
errors die verschillen tussen beiden modellen alsook het aantal
vrijheidsgraden van de errors (n-p).

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Additive\_coef=}\FunctionTok{summary}\NormalTok{(comparisons)}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{coef,}\AttributeTok{Additive\_se=}\FunctionTok{summary}\NormalTok{(comparisons)}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{sigma,}\AttributeTok{Int\_coef=}\FunctionTok{summary}\NormalTok{(comparisonsInt2)}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{coef,}\AttributeTok{int\_se=}\FunctionTok{summary}\NormalTok{(comparisonsInt2)}\SpecialCharTok{$}\NormalTok{test}\SpecialCharTok{$}\NormalTok{sigma) }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Er is een extreem significant effect van het type gif en de behandeling
op de snelheid van sterven bij ratten (p \textless\textless{} 0.001).

De interactie tussen gif en behandeling is niet significant (p = 0.387).

De snelheid van sterven is gemiddeld 0.2h\(^{-1}\) en 0.15h\(^{-1}\)
hoger voor ratten die blootgesteld worden aan gif III dan aan
respectievelijk gif I en II (beide p \textless\textless{} 0.001, 95\% BI
III-I: {[}0.15, 0.25{]}h\(^{-1}\), 95\% BI III-II: {[}0.1,
0.2{]}h\(^{-1}\)) De gemiddelde snelheid van sterven was niet
significant verschillend tussen ratten die werden blootgesteld aan gif I
en gif II (p=0.074).

De snelheid van sterven is gemiddeld 0.17h\(^{-1}\) en 0.14h\(^{-1}\)
hoger na behandeling A dan na behandeling B en D (p \textless\textless{}
0.001, 95\% BI B-A: {[}-0.22, -0.11{]}h\(^{-1}\), 95\% BI D-A: {[}-0.19,
-0.08{]}h\(^{-1}\)). De snelheid van sterven is gemiddeld 0.11h\(^{-1}\)
en 0.08h\(^{-1}\) hoger na behandeling C dan respectievelijk na
behandeling B en D (C-B: p \textless\textless{} 0.001, 95\% CI {[}0.05,
0.17{]}h\(^{-1}\) , D-C: p = 0.003, 95\% CI {[}-0.14,
-0.02{]}h\(^{-1}\)). De gemiddelde snelheid van sterven is niet
significant verschillend tussen ratten behandeld met behandeling C vs A,
en D vs B (p- waarden respectievelijk p = 0.051 en p = 0.61).

\bookmarksetup{startatroot}

\chapter{Modelselectie}\label{sec-chap-modsel}

\section{Inleiding}\label{inleiding-10}
...
en svi als predictoren worden toegelaten, alsook alle paarsgewijze
interactietermen. We zullen drie verschillende strategieën beschouwen:
voorwaartse modelselectie, achterwaartse modelselectie en stapsgewijze
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data=}\NormalTok{prostate)}
\FunctionTok{add1}\NormalTok{(m1,}\AttributeTok{scope=}\SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
<none>               127.918  28.837                      
lweight  1    16.041 111.876  17.840  13.621 0.0003729 ***
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m2 }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m1,}\SpecialCharTok{\textasciitilde{}}\NormalTok{. }\SpecialCharTok{+}\NormalTok{ lcavol)}
\FunctionTok{add1}\NormalTok{(m2,}\AttributeTok{scope=}\SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
lpsa ~ lcavol
        Df Sum of Sq    RSS     AIC F value   Pr(>F)   
<none>               58.915 -44.366                    
lweight  1    5.9485 52.966 -52.690 10.5569 0.001606 **
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m3 }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m2,}\SpecialCharTok{\textasciitilde{}}\NormalTok{ . }\SpecialCharTok{+}\NormalTok{ lweight)}
\FunctionTok{add1}\NormalTok{(m3,}\AttributeTok{scope=}\SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
lweight:lcavol  1    0.1222 52.844 -50.914   0.215 0.643974   
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m4 }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m3,}\SpecialCharTok{\textasciitilde{}}\NormalTok{ . }\SpecialCharTok{+}\NormalTok{ svi)}
\FunctionTok{add1}\NormalTok{(m4,}\AttributeTok{scope=}\SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
lpsa ~ lcavol + lweight + svi
               Df Sum of Sq    RSS     AIC F value Pr(>F)
<none>                      47.785 -60.676               
lweight:lcavol  1   0.36605 47.419 -59.422  0.7102 0.4016
lweight:svi     1   1.16433 46.621 -61.069  2.2977 0.1330
lcavol:svi      1   0.02434 47.761 -58.726  0.0469 0.8291
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{alphaOut }\OtherTok{\textless{}{-}} \FloatTok{0.05}
\NormalTok{m}\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa}\SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,prostate)}
\NormalTok{dropHlp}\OtherTok{\textless{}{-}}\FunctionTok{drop1}\NormalTok{(m,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\NormalTok{dropHlp}
\end{Highlighting}
\end{Shaded}
...
lweight:svi     1   0.87392 47.352 -57.558  1.6922 0.1966
lcavol:svi      1   0.14091 46.619 -59.071  0.2729 0.6027
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{while}\NormalTok{ (}\FunctionTok{sum}\NormalTok{(dropHlp[,}\DecValTok{6}\NormalTok{]}\SpecialCharTok{\textgreater{}=}\NormalTok{alphaOut,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{))}
\NormalTok{\{}
\NormalTok{dropVarName}\OtherTok{\textless{}{-}}\FunctionTok{rownames}\NormalTok{(dropHlp)[}\FunctionTok{which.max}\NormalTok{(dropHlp[,}\DecValTok{6}\NormalTok{])]}
\NormalTok{m }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m,}\FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"\textasciitilde{}.{-}"}\NormalTok{,dropVarName)))}
\NormalTok{dropHlp}\OtherTok{\textless{}{-}}\FunctionTok{drop1}\NormalTok{(m,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(dropHlp)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
lpsa ~ lweight + lcavol + svi + lweight:svi + lcavol:svi
            Df Sum of Sq    RSS     AIC F value Pr(>F)
<none>                   46.479 -59.365               
lweight:svi  1   1.28188 47.761 -58.726  2.5098 0.1166
lcavol:svi   1   0.14189 46.621 -61.069  0.2778 0.5994
Single term deletions
...
lpsa ~ lweight + lcavol + svi + lweight:svi
            Df Sum of Sq    RSS     AIC F value    Pr(>F)    
<none>                   46.621 -61.069                      
lcavol       1   28.1994 74.820 -17.184 55.6481 4.712e-11 ***
lweight:svi  1    1.1643 47.785 -60.676  2.2977     0.133    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
Single term deletions
...
lpsa ~ lweight + lcavol + svi
        Df Sum of Sq    RSS     AIC F value    Pr(>F)    
<none>               47.785 -60.676                      
lweight  1    5.8924 53.677 -51.397  11.468  0.001039 ** 
lcavol   1   28.0445 75.829 -17.884  54.581 6.304e-11 ***
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{alphaIn }\OtherTok{\textless{}{-}}\NormalTok{ alphaOut }\OtherTok{\textless{}{-}} \FloatTok{0.05}
\NormalTok{m }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(lpsa }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{ ,prostate)}
\NormalTok{notConverged }\OtherTok{\textless{}{-}} \ConstantTok{TRUE}
\ControlFlowTok{while}\NormalTok{ (notConverged)}
\NormalTok{\{}
\NormalTok{addHlp }\OtherTok{\textless{}{-}} \FunctionTok{add1}\NormalTok{(m,}\AttributeTok{scope=} \SpecialCharTok{\textasciitilde{}}\NormalTok{lweight}\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{svi}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{lcavol}\SpecialCharTok{+}\NormalTok{lweight}\SpecialCharTok{:}\NormalTok{svi }\SpecialCharTok{+}\NormalTok{lcavol}\SpecialCharTok{:}\NormalTok{svi,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(addHlp)}
\NormalTok{addVarName}\OtherTok{\textless{}{-}}\FunctionTok{rownames}\NormalTok{(addHlp)[}\FunctionTok{which.min}\NormalTok{(addHlp[,}\DecValTok{6}\NormalTok{])]}
\ControlFlowTok{if}\NormalTok{ ((}\FunctionTok{sum}\NormalTok{(addHlp[,}\DecValTok{6}\NormalTok{] }\SpecialCharTok{\textless{}}\NormalTok{ alphaIn,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{))}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{) m }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m,}\FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"\textasciitilde{}.+"}\NormalTok{,addVarName)))}
\NormalTok{dropHlp}\OtherTok{\textless{}{-}}\FunctionTok{drop1}\NormalTok{(m,}\AttributeTok{test=}\StringTok{"F"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(dropHlp)}
\ControlFlowTok{if}\NormalTok{ ((}\FunctionTok{sum}\NormalTok{(dropHlp[,}\DecValTok{6}\NormalTok{]}\SpecialCharTok{\textgreater{}=}\NormalTok{alphaOut,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{))}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{) m }\OtherTok{\textless{}{-}} \FunctionTok{update}\NormalTok{(m,}\FunctionTok{as.formula}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"\textasciitilde{}.{-}"}\NormalTok{,dropVarName)))}
\ControlFlowTok{if}\NormalTok{ ((}\FunctionTok{sum}\NormalTok{(addHlp[,}\DecValTok{6}\NormalTok{] }\SpecialCharTok{\textless{}}\NormalTok{ alphaIn,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{sum}\NormalTok{(dropHlp[,}\DecValTok{6}\NormalTok{]}\SpecialCharTok{\textgreater{}=}\NormalTok{alphaOut,}\AttributeTok{na.rm=}\ConstantTok{TRUE}\NormalTok{))}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{) notConverged }\OtherTok{\textless{}{-}} \ConstantTok{TRUE} \ControlFlowTok{else}\NormalTok{ notConverged }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
lpsa ~ lcavol
       Df Sum of Sq     RSS     AIC F value    Pr(>F)    
<none>               58.915 -44.366                      
lcavol  1    69.003 127.918  28.837  111.27 < 2.2e-16 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
Single term additions
...
lpsa ~ lcavol + lweight
        Df Sum of Sq     RSS     AIC F value    Pr(>F)    
<none>                52.966 -52.690                      
lcavol   1    58.910 111.876  17.840 104.549 < 2.2e-16 ***
lweight  1     5.949  58.915 -44.366  10.557  0.001606 ** 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
Single term additions
...
\subsection{Inleiding}\label{inleiding-11}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mcx}\OtherTok{\textless{}{-}}\FunctionTok{read.table}\NormalTok{(}\StringTok{"https://raw.githubusercontent.com/statomics/sbc/master/data/mcx.txt"}\NormalTok{,}\AttributeTok{header=}\ConstantTok{TRUE}\NormalTok{)}
\FunctionTok{head}\NormalTok{(mcx)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(mcx)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{11-ModelSelectie_files/figure-pdf/fig-MCXScatter-1.pdf}

}

\caption{\label{fig-MCXScatter}Scatterplot matrix voor de observaties in
de bioactiviteit dataset.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m1 }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BA}\SpecialCharTok{\textasciitilde{}}\DecValTok{1}\NormalTok{,mcx)}
\NormalTok{m1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mfull }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(BA}\SpecialCharTok{\textasciitilde{}}\NormalTok{.,mcx)}
\NormalTok{mfull}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mForward }\OtherTok{\textless{}{-}} \FunctionTok{step}\NormalTok{(m1,}\AttributeTok{scope=}\FunctionTok{formula}\NormalTok{(mfull),}\AttributeTok{direction=}\StringTok{"forward"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mBackward }\OtherTok{\textless{}{-}} \FunctionTok{step}\NormalTok{(mfull,}\AttributeTok{direction=}\StringTok{"backward"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mForStep }\OtherTok{\textless{}{-}} \FunctionTok{step}\NormalTok{(m1,}\AttributeTok{scope=}\FunctionTok{list}\NormalTok{(}\AttributeTok{lower=}\FunctionTok{formula}\NormalTok{(m1),}\AttributeTok{upper=}\FunctionTok{formula}\NormalTok{(mfull)), }\AttributeTok{direction=}\StringTok{"both"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mBackStep }\OtherTok{\textless{}{-}} \FunctionTok{step}\NormalTok{(mfull,}\AttributeTok{scope=}\FunctionTok{list}\NormalTok{(}\AttributeTok{lower=}\FunctionTok{formula}\NormalTok{(m1),}\AttributeTok{upper=}\FunctionTok{formula}\NormalTok{(mfull)), }\AttributeTok{direction=}\StringTok{"both"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
