...
Figuur -@fig-wetMet is een schematische weergave van de Wetenschappelijke Methode.
...
```{r fig-wetMet, fig.cap='De Wetenschappelijke Methode en de rol van Statistiek.', out.width='100%', fig.asp=.8, fig.align='center',echo=FALSE}
par(mar=c(0,0,0,0))
