...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(apRelSum, }\StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(HeightSum }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{mutate\_if}\NormalTok{(is.numeric, round, }\AttributeTok{digits =} \DecValTok{1}\NormalTok{), }\StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Deze sectie behandelen we vanaf academiejaar 2026-2027 in hoofdstuk 5.
...
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(nfip, }\StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{salk }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{group =} \FunctionTok{c}\NormalTok{(}\StringTok{"cases"}\NormalTok{, }\StringTok{"control"}\NormalTok{, }\StringTok{"noConcent"}\NormalTok{),}
    ...
    \FunctionTok{mutate}\NormalTok{(}\AttributeTok{noPolio =}\NormalTok{ total }\SpecialCharTok{{-}}\NormalTok{ polio, }\AttributeTok{incidencePM =} \FunctionTok{round}\NormalTok{(polio}\SpecialCharTok{/}\NormalTok{total }\SpecialCharTok{*}
        \FloatTok{1e+06}\NormalTok{, }\DecValTok{0}\NormalTok{))}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(salk, }\StringTok{"html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tibble}\NormalTok{(}\AttributeTok{X =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{cumprob =} \FunctionTok{c}\NormalTok{(}\FloatTok{0.508}\NormalTok{, }\DecValTok{1}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ X, }\AttributeTok{xend =}\NormalTok{ X, }\AttributeTok{y =} \DecValTok{0}\NormalTok{, }\AttributeTok{yend =}\NormalTok{ cumprob)) }\SpecialCharTok{+}
    \FunctionTok{geom\_segment}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"F(x)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tibble}\NormalTok{(}\AttributeTok{X =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{6}\NormalTok{, }\AttributeTok{cumprob =} \FunctionTok{cumsum}\NormalTok{(}\FunctionTok{rep}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\DecValTok{6}\NormalTok{, }\DecValTok{6}\NormalTok{))) }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ X, }\AttributeTok{xend =}\NormalTok{ X, }\AttributeTok{y =} \FunctionTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{6}\NormalTok{), }\AttributeTok{yend =}\NormalTok{ cumprob)) }\SpecialCharTok{+}
    \FunctionTok{geom\_segment}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"F(x)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{itemize}
\item
  We kunnen de verdeling van de lengte metingen ook benaderen d.m.v. een normale distributie.
\item
...
\NormalTok{        log2, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), }\AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(BMI }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        log2, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), }\AttributeTok{mean =} \FunctionTok{mean}\NormalTok{(BMI, }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
...
\NormalTok{        log2)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..,}
...
\NormalTok{        log2)) }\SpecialCharTok{+} \FunctionTok{geom\_qq}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_qq\_line}\NormalTok{()}
...
\NormalTok{        log2)) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Weight (log2)"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        log2) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    na.exclude }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    cor}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{captoprilTidy }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{summarize\_at}\NormalTok{(}\StringTok{"bp"}\NormalTok{, }\FunctionTok{list}\NormalTok{(}\AttributeTok{mean =} \SpecialCharTok{\textasciitilde{}}\FunctionTok{mean}\NormalTok{(., }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{),}
        \AttributeTok{sd =} \SpecialCharTok{\textasciitilde{}}\FunctionTok{sd}\NormalTok{(., }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{), }\AttributeTok{n =} \ControlFlowTok{function}\NormalTok{(x) x }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{            is.na }\SpecialCharTok{\%\textgreater{}\%}
            \StringTok{\textasciigrave{}}\AttributeTok{!}\StringTok{\textasciigrave{}} \SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{            log2)) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"cholesterol (log2)"}\NormalTok{)}
...
\NormalTok{        as.factor, }\AttributeTok{y =}\NormalTok{ mean)) }\SpecialCharTok{+} \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Direct cholesterol (log2)"}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ n }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        as.factor, }\AttributeTok{y =}\NormalTok{ sd)) }\SpecialCharTok{+} \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"standard deviation"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{xlab}\NormalTok{(}\StringTok{"sample size"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ n }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        as.factor, }\AttributeTok{y =}\NormalTok{ se)) }\SpecialCharTok{+} \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"standard error"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{xlab}\NormalTok{(}\StringTok{"sample size"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        mean) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"10 personen"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        mean) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"50 personen"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        log2), }\AttributeTok{sd =} \FunctionTok{sd}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        log2))) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Alle vrouwen in NHANES studie"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        log2)) }\SpecialCharTok{+} \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Alle vrouwen in NHANES study"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{femSamp10[, }\DecValTok{1}\NormalTok{] }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..,}
...
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        mean, }\AttributeTok{sd =}\NormalTok{ femSamp10[, }\DecValTok{1}\NormalTok{] }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        sd)) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"10 random females"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{xlim}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    range)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{femSamp10 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..,}
...
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        mean, }\AttributeTok{sd =}\NormalTok{ femSamp10 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        sd)) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 10 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{sample =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{stat\_qq}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{stat\_qq\_line}\NormalTok{() }\SpecialCharTok{+}
...
\NormalTok{femSamp5 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..,}
...
\NormalTok{        colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        mean, }\AttributeTok{sd =}\NormalTok{ femSamp5 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        colMeans }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{        sd)) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"Means on 5 females"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    log2) }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*} \FunctionTok{sd}\NormalTok{(samp50 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2)}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\DecValTok{50}\NormalTok{)}
...
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    mean) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 10"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se, }\AttributeTok{ymax =}\NormalTok{ mean }\SpecialCharTok{+} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se)) }\SpecialCharTok{+} \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    mean) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 50"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res }\SpecialCharTok{\%\textgreater{}\%}
    ...
    \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se, }\AttributeTok{ymax =}\NormalTok{ mean }\SpecialCharTok{+} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ se)) }\SpecialCharTok{+} \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    mean) }\SpecialCharTok{+} \FunctionTok{ggtitle}\NormalTok{(}\StringTok{"20 CI for N = 100"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\FunctionTok{range}\NormalTok{(fem}\SpecialCharTok{$}\NormalTok{DirectChol }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{muPerm }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FunctionTok{mean}\NormalTok{(captopril}\SpecialCharTok{$}\NormalTok{deltaSBP),}
...
\NormalTok{tPermPlot }\OtherTok{\textless{}{-}}\NormalTok{ tPerm }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ ..density..,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pSim }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.data.frame }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ .)) }\SpecialCharTok{+} \FunctionTok{geom\_histogram}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{xlim}\NormalTok{(}\DecValTok{0}\NormalTok{,}
...
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    mean }\SpecialCharTok{+} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ (fem }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(DirectChol) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    sd))}
\end{Highlighting}
...
\NormalTok{    log2 }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data =}\NormalTok{ fem)}
...
\DecValTok{2}\SpecialCharTok{\^{}}\NormalTok{(fem10 }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(DirectChol) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    mean }\SpecialCharTok{+} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ (fem10 }\SpecialCharTok{\%\textgreater{}\%}
    \FunctionTok{pull}\NormalTok{(DirectChol) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    log2 }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    sd))}
\end{Highlighting}
...
\NormalTok{    log2 }\SpecialCharTok{\textasciitilde{}} \DecValTok{1}\NormalTok{, }\AttributeTok{data =}\NormalTok{ fem10)}
...
\NormalTok{        as.factor, }\AttributeTok{y =}\NormalTok{ age)) }\SpecialCharTok{+} \FunctionTok{geom\_boxplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{xlab}\NormalTok{(}\StringTok{"node"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    confint }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    plot}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    levels, }\DecValTok{2}\NormalTok{, paste, }\AttributeTok{collapse =} \StringTok{"vs"}\NormalTok{)}
...
\NormalTok{    as.character }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.double, }\AttributeTok{y =}\NormalTok{ status }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.character }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    as.double, }\AttributeTok{label =}\NormalTok{ Freq), beetlesTab }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{    log2 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ poison }\SpecialCharTok{*}\NormalTok{ treat, rats)}
