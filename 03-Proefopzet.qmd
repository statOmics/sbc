# Studiedesign {#sec-chap-design}

```{r setup-common, include=FALSE}
source("_common.R")
```
Alle kennisclips die in dit hoofdstuk zijn verwerkt kan je in deze youtube playlist vinden: [Kennisclips Hoofdstuk3](https://www.youtube.com/playlist?list=PLZH1hP8_LbJL1GjhnpEDlx78OJ6qUzSix)

Link naar webpage/script die wordt gebruik in de kennisclips: [script Hoofdstuk3](https://statomics.github.io/sbc/rmd/03-experimentalDesign.html)


## Inleiding

<iframe width="560" height="315" src="https://www.youtube.com/embed/NqUfxD7yaI0" frameborder="0" style="display: block; margin: auto;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
interventie zal ondergaan, noemt men het *design* van de studie of de
*proefopzet*. Met een goed design kunnen betrouwbare conclusies
...
```{r fig-pop2Samp2PopDesign,echo=TRUE,fig.cap='Verschillende stappen in een studie. In dit hoofdstuk ligt de focus op proefopzet.', out.width='100%', fig.asp=.8, fig.align='center',echo=FALSE}
...
&nbsp;
:::
Een **experiment** is een reeks observaties die gemaakt worden onder
...
^[Met "zuiver" wordt hier bedoeld dat het zuivere interventie-effect uit de gegevens
...
behandelingseffect vertekend^[ Voorlopig verstaan we onder het feit dat een schatting voor het
...
::: {#def-incidentie-en-prevalentie}
## incidentie en prevalentie

&nbsp;
:::
De **incidentie** van een bepaalde ziekte of aandoening (bvb. polio)
...
De **prevalentie** van een bepaalde ziekte wordt gedefinieerd als de
...
De enige manier om te ontdekken of het vaccin effectief is, is om *gelijktijdig* de incidentie van polio in 1954 te vergelijken tussen een
groep gevaccineerde kinderen (doorgaans *cases* genoemd) en een groep
niet-gevaccineerde kinderen (doorgaans *controles* genoemd). Dit is
...
het vaccin effectief is. Hier zijn verschillende redenen voor:
  ...
  1. Ten eerste zou het kunnen dat men door toeval een verschil in
...
ontwikkelen. In Hoofdstuk -@sec-chap-besluit zullen we methoden aanleren om
...
niet toevallig is.
  2. Ten tweede zou het kunnen dat kinderen uit de tweede graad sowieso
...
vaccin-effect, voor de cases dus een hogere incidentie wordt verwacht.
  3. Ten derde is het zo dat vooral ouders uit hoge-inkomens gezinnen
...
factor verward (in het Engels: *confounded*) wordt met het effect van
...
::: {#exm-de-nood-aan-controle}
## De nood aan controle
...
::: {#def-confounding-en-confounder}
## confounding en confounder

&nbsp;
:::
**Confounding** is het probleem dat verschillen ten gevolge van verschillende experimentele interventies niet kunnen losgekoppeld worden van andere factoren, **confounders** genoemd, die verschillen tussen de interventiegroepen. Een confounder manifesteert zich als een variabele die geassocieerd
...
::: {#exm-confounding-in-mariene-veldexperimenten}
## Confounding in mariene veldexperimenten
...
*randomisatieprocedures* toe te passen, waarbij de toewijzing van
mensen aan verschillende interventie-armen volledig lukraak gebeurt. Men
zegt in dat geval dat de studie *gerandomiseerd gecontroleerd* (in
het Engels: *randomized controlled*) is.

::: {#def-gerandomiseerde-studie}
## gerandomiseerde studie

&nbsp;
:::
Een **gerandomiseerd gecontroleerde** studie is een experiment waarbij
...
muntstuk. De *randomisatie* werd uitgevoerd onder kinderen die van
...
dat er *differentiële uitval* was van kinderen in beide
...
controle-groep een *placebo* toegediend. Dat is een inerte, inactieve
behandeling; in dit geval een injectie van zout opgelost in water. Tijdens
de studie waren de kinderen *blind* voor de behandelingscode (d.i. ze
...
behandeling werd toegediend, wordt deze studie *dubbel blind*
genoemd. Dubbel blinde studies vereisen dat de verschillende interventies er
hetzelfde uitzien.

```{r tbl-nfipStudy, tidy=FALSE,echo=FALSE}
nfip=data.frame(Aantal=c(225000,725000,125000),Incidentie=c(25,54,44))
rownames(nfip)=c("Vaccin","Controle","Geen toestemming")
knitr::kable(nfip, tableType, caption = 'De NFIP studie: aantal kinderen en incidentie (uitgedrukt per
...
Tabellen -@tbl-nfipStudy en -@tbl-dbrcStudy geven de resultaten weer die geobserveerd
werden in de NFIP studie en het *dubbel blinde gerandomiseerd
gecontroleerde* (in het Engels: *double blind randomized controlled*)
experiment. Op basis van Tabel -@tbl-dbrcStudy stellen we vast dat de incidentie
...
per 100000 per jaar als gevolg van het vaccin (zie Tabel -@tbl-nfipStudy). De oorzaak is dat
de controlegroep in deze studie kinderen bevat die minder vatbaar zijn voor
polio dan de vaccin-groep.


```{r tbl-dbrcStudy, tidy=FALSE,echo=FALSE}
dbrc=data.frame(Aantal=c(200000,200000,350000),Incidentie=c(28,71,46))
rownames(dbrc)=c("Vaccin","Controle","Geen toestemming")
knitr::kable(dbrc, tableType, caption = 'De gerandomiseerd gecontroleerde studie: aantal kinderen en incidentie (uitgedrukt per
100000 kinderen per jaar).',
  booktabs = TRUE
)
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ousb0raO_eI" frameborder="0" style="display: block; margin: auto;" allow="autoplay; encrypted-media" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/oyPoNjqhD6E" frameborder="0" style="display: block; margin: auto;" allow="autoplay; encrypted-media" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/nQrgkOBuRNQ" frameborder="0" style="display: block; margin: auto;" allow="autoplay; encrypted-media" allowfullscreen></iframe>

<iframe width="560" height="315" src="https://www.youtube.com/embed/Lz5iKMeipLk" frameborder="0" style="display: block; margin: auto;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
onderscheid met *systematische allocatie*.

::: {#def-systematische-allocatie}
## systematische allocatie

&nbsp;
:::
**Systematische allocatie** of **louter toevallige allocatie**
*(in het Engels: haphazard allocation)* is een toewijzingsmethode die
...
Bij *eenvoudige randomisatie* worden subjecten lukraak toegewezen
...
*gebalanceerde* of *beperkte randomisatie* (in het Engels:
*balanced* of *restricted randomisation*) worden gebruikt.
...
::: {#exm-confounding-in-mariene-veldexperimenten-vervolg}
## Confounding in mariene veldexperimenten, vervolg
...
in Sectie -@sec-observational, alsook in het extra deel rond het algemeen lineair regressiemodel voor de studenten Biotechnologie en Biochemie, of in vervolgcursussen Statistiek voor de studenten Biologie.
...
In een *parallel design* ontvangt 1 groep de testinterventie en de
andere groep *gelijktijdig* de controle interventie. Dit is het
eenvoudigste en meest gebruikte design voor gerandomiseerd gecontroleerde
studies.

::: {#exm-kiezelwieren-en-zware-metalen}
## Kiezelwieren en zware metalen
...
variabelen (pH, opgeloste zuurstof, ...), de zinkconcentratie en variabelen die de
kiezelwieren beschrijven (mate van voorkomen, diversiteit, ...).
...
In een *cross-over studie* ondergaan alle experimentele subjecten sequentieel alle
...
proefsubjecten (d.i. planten) nodig zijn dan in een parallel design om even precies^[Wat we concreet bedoelen met het feit dat er minder proefsubjecten nodig zijn
...
::: {#exm-effect-van-koper-op-neerstrijken-van-larven}
## Effect van koper op neerstrijken van larven
...
*carry-over effect*. In dat geval wordt het moeilijk (of zelfs
...
*interactie* is tussen de interventie en de periode waarin ze
...
*Factoriële designs* zijn experimentele designs met als doel het effect van
...
::: {#def-interactie-of-effect-modificatie}
## interactie of effect-modificatie

&nbsp;
:::
Een **interactie** tussen 2 interventies drukt uit dat een combinatie
...
::: {#exm-grootte-van-salamanderlarven}
## Grootte van salamanderlarven
...
::: {#exm-groei-van-esdoorn-versus-beuk}
## Groei van esdoorn versus beuk
...
lukrake allocatie aan 1 van beide interventiegroepen, een *quasi-experimenteel design*. Het grote nadeel van dit design is dat
verschillen tussen beide groepen niet gegarandeerd kunnen toegeschreven
worden aan verschillen in behandelingswijze.

::: {#exm-gezondheidscampagne-in-wales}
## Gezondheidscampagne in Wales
...
## Observationele studies {#sec-observational}
...
dat men vaststelt dat de populatie P. jordani *sneller groeit* in gebieden met
...
effect van P. glutinosus op de groei van P. jordani *gecontroleerd* (in het Engels:
*adjusted* of *controlled*) werd voor de voedselrijkdom van het studiegebied.

::: {#exm-simpson-s-paradox}
## Simpson's paradox
...
resultaten voor de 6 grootste richtingen staan in Tabel -@tbl-sexbias
...
tussen geslacht en de slaagkans. Immers, zoals blijkt uit Tabel -@tbl-sexbias hebben jongens meer de neiging om studierichtingen te kiezen
...
De vergelijking van de slaagkansen per studierichting in Tabel -@tbl-sexbias
...
bekijkt. Dit noemt men *Simpson's paradox*.

```{r tbl-sexbias, tidy=FALSE,echo=FALSE}
sexbias=data.frame(aJ=c(825,560,325,417,191,373),gPJ=c(62,63,37,33,28,6),aM=c(108,25,593,375,393,341),gPM=c(82,68,34,35,24,7))
colnames(sexbias) = c("Jongens(aantal)","Jongens(geslaagd %)","Meisjes(aantal)","Meisjes (geslaagd %)")
rownames(sexbias)= c("A","B","C","D","E","F")
knitr::kable(sexbias, tableType, caption = "Resultaten van de toelatingsexamens volgens geslacht en studierichting.",  booktabs = TRUE
)
```

**Einde voorbeeld**

::: {#exm-confounders-in-de-nhanes-studie}
## Confounders in de NHANES studie
...
::: {#exm-observationele-versus-gerandomiseerde-studies}
## Observationele versus gerandomiseerde studies
...
## Prospectieve studies {#sec-design-prosp}

In *prospectieve studies* wenst men een associatie tussen een
...
Prospectieve studies zijn vaak *longitudinaal*. Dat betekent dat ze
...
worden (prospectieve) *cohort studies* genoemd. Meer algemeen zijn
...
::: {#exm-vruchtbaarheid-van-schelpdieren}
## Vruchtbaarheid van schelpdieren
...
## Retrospectieve studies {#sec-design-retro}

In *retrospectieve studies* wenst men een associatie tussen een
...
ook *case-controle studies* of *case-referent studies* genoemd
omdat de groep subjecten met de aandoening doorgaans *cases* worden genoemd,
en de groep subjecten zonder de aandoening *controles*. *Pas echter op:* het is niet omdat men subjecten met (zonder) de aandoening *cases*
(*controles*) noemt in een bepaalde studie, dat het om een case-controle
studie gaat! Zo is ook de Salk vaccin studie geen case-controle studie
hoewel gevaccineerde (niet-gevaccineerde) kinderen *cases* (*controles*)
werden genoemd.
...
In dit voorbeeld beschouwen we zo'n case-controle studie die 800 borstkankercases en 572 controles omvatte. Informatie omtrent het BRCA1-polymorfisme werd bekomen via DNA-analyse en staat getabuleerd in Tabel -@tbl-leu.
...
```{r tbl-leu, tidy=FALSE,echo=FALSE}
brca=data.frame(Genotype=c("Pro/Pro","Pro/Leu","Leu/Leu","Totaal"),Controles=c(266,250,56,572),Cases=c(342,369,89,800),totaal=c(608,619,145,1372))
...
Er zijn 2 mogelijke variaties van case-controle studies. In *niet-gematchte case-controle studies* is de controlegroep een goedgekozen
...
*gematchte case-controle studies* zoekt men voor elke case 1 of
...
vertekenen, in welk geval men van *recall bias* spreekt. Dergelijke
...
In *niet-gecontroleerde studies* is er geen gelijktijdige controlegroep aanwezig en
...
### Pre-test/Post-test studies {#sec-prepost}

Een *pre-test/post-test studie* is een studie waarbij een bepaalde
...
*Cross-sectionele surveys* onderzoeken een groep subjecten op een
